...
public class MpmcArrayQueue<E> extends MpmcArrayQueueConsumerField<E> {
    ...
    @Override // java.util.Queue, p035rx.internal.util.unsafe.MessagePassingQueue
    ...
    @Override // java.util.AbstractCollection, java.util.Collection, p035rx.internal.util.unsafe.MessagePassingQueue
    public int size() {
        long jLvConsumerIndex = lvConsumerIndex();
        while (true) {
            long jLvProducerIndex = lvProducerIndex();
