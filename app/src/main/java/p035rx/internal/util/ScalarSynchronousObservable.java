...
public final class ScalarSynchronousObservable<T> extends Observable<T> {
    ...
    public Observable<T> scalarScheduleOn(final Scheduler scheduler) {
        ...
        return create((Observable.OnSubscribe) new ScalarAsyncOnSubscribe(this.f3525t, func1));
    }
    ...
    public <R> Observable<R> scalarFlatMap(final Func1<? super T, ? extends Observable<? extends R>> func1) {
        return create((Observable.OnSubscribe) new Observable.OnSubscribe<R>() { // from class: rx.internal.util.ScalarSynchronousObservable.3
            ...
            public void call(Subscriber<? super R> subscriber) {
                Observable observable = (Observable) func1.call(ScalarSynchronousObservable.this.f3525t);
                if (observable instanceof ScalarSynchronousObservable) {
                    subscriber.setProducer(ScalarSynchronousObservable.createProducer(subscriber, ((ScalarSynchronousObservable) observable).f3525t));
                } else {
