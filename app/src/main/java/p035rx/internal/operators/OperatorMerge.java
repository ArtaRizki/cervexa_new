...
import p035rx.internal.util.atomic.SpscExactAtomicArrayQueue;
import p035rx.internal.util.atomic.SpscUnboundedAtomicArrayQueue;
import p035rx.internal.util.unsafe.Pow2;
...
public final class OperatorMerge<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    static final class MergeSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        final NotificationLite<T> f3496nl = NotificationLite.instance();
        ...
        protected void queueScalar(InnerSubscriber<T> innerSubscriber, T t) throws Throwable {
            ...
            try {
                spscInstance.onNext(this.f3496nl.next(t));
                emit();
        ...
        */
        protected void emitScalar(rx.internal.operators.OperatorMerge.InnerSubscriber<T> r5, T r6, long r7) throws java.lang.Throwable {
            ...
            L8:
                ...
                if (r2 != 0) goto L19
                p035rx.exceptions.Exceptions.throwIfFatal(r6)     // Catch: java.lang.Throwable -> L46
        ...
        protected void queueScalar(T t) throws Throwable {
            ...
            if (!spscUnboundedAtomicArrayQueue.offer(this.f3496nl.next(t))) {
                unsubscribe();
