...
public final class OnSubscribeFromIterable<T> implements Observable.OnSubscribe<T> {
    ...
    final Iterable<? extends T> f3486is;

    public OnSubscribeFromIterable(Iterable<? extends T> iterable) {
        if (iterable == null) {
            throw new NullPointerException("iterable must not be null");
        }
        this.f3486is = iterable;
    }

    @Override // p035rx.functions.Action1
    public void call(Subscriber<? super T> subscriber) {
        try {
            Iterator<? extends T> it = this.f3486is.iterator();
    ...
    static final class IterableProducer<T> extends AtomicLong implements Producer {
        ...
        private final Iterator<? extends T> f3487it;

        /* JADX INFO: renamed from: o */
        private final Subscriber<? super T> f3488o;

        IterableProducer(Subscriber<? super T> subscriber, Iterator<? extends T> it) {
            this.f3488o = subscriber;
            this.f3487it = it;
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:28:0x0046, code lost:
            ...
            r9 = p035rx.internal.operators.BackpressureUtils.produced(r8, r4);
         */
        /*
        ...
        */
        void slowpath(long r9) {
            /*
                r8 = this;
                rx.Subscriber<? super T> r0 = r8.f3488o
                java.util.Iterator<? extends T> r1 = r8.f3487it
                r2 = 0
            L6:
                r4 = r2
            L7:
            ...
            L34:
                r9 = move-exception
                p035rx.exceptions.Exceptions.throwOrReport(r9, r0)
                return
            L39:
                r9 = move-exception
                p035rx.exceptions.Exceptions.throwOrReport(r9, r0)
            ...
            L3e:
                ...
                int r6 = (r4 > r9 ? 1 : (r4 == r9 ? 0 : -1))
                if (r6 != 0) goto L7
                long r9 = p035rx.internal.operators.BackpressureUtils.produced(r8, r4)
        ...
        void fastpath() {
            Subscriber<? super T> subscriber = this.f3488o;
            Iterator<? extends T> it = this.f3487it;
