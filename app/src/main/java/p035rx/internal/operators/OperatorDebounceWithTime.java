...
public final class OperatorDebounceWithTime<T> implements Observable.Operator<T, T> {
    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        ...
        return new C27491(subscriber, serialSubscription, workerCreateWorker, serializedSubscriber);
    }

    /* JADX INFO: renamed from: rx.internal.operators.OperatorDebounceWithTime$1 */
    class C27491 extends Subscriber<T> {
        ...
        C27491(Subscriber subscriber, SerialSubscription serialSubscription, Scheduler.Worker worker, SerializedSubscriber serializedSubscriber) {
            super(subscriber);
        ...
        public void onNext(T t) {
            ...
            this.val$ssub.set(this.val$worker.schedule(new Action0() { // from class: rx.internal.operators.OperatorDebounceWithTime.1.1
                ...
                public void call() {
                    C27491.this.state.emit(next, C27491.this.val$s, C27491.this.self);
                }
