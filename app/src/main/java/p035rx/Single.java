...
import p035rx.internal.operators.SingleDoAfterTerminate;
import p035rx.internal.operators.SingleOnSubscribeDelaySubscriptionOther;
import p035rx.internal.operators.SingleOnSubscribeUsing;
import p035rx.internal.operators.SingleOperatorOnErrorResumeNext;
import p035rx.internal.operators.SingleOperatorZip;
import p035rx.internal.producers.SingleDelayedProducer;
import p035rx.internal.util.ScalarSynchronousSingle;
...
import p035rx.plugins.RxJavaSingleExecutionHook;
import p035rx.schedulers.Schedulers;
import p035rx.singles.BlockingSingle;
...
public class Single<T> {
    ...
    public static <T1, T2, R> Single<R> zip(Single<? extends T1> single, Single<? extends T2> single2, final Func2<? super T1, ? super T2, ? extends R> func2) {
        return SingleOperatorZip.zip(new Single[]{single, single2}, new FuncN<R>() { // from class: rx.Single.6
            @Override // p035rx.functions.FuncN
