...
public class SerializedObserver<T> implements Observer<T> {
    ...
    private final NotificationLite<T> f3540nl = NotificationLite.instance();
    ...
    */
    public void onNext(T r10) {
        ...
        L1b:
            rx.internal.operators.NotificationLite<T> r1 = r9.f3540nl     // Catch: java.lang.Throwable -> L7c
        ...
        L46:
            ...
            goto L6d
        L4d:
            rx.internal.operators.NotificationLite<T> r7 = r9.f3540nl     // Catch: java.lang.Throwable -> L5d
        ...
        L5d:
            r1 = move-exception
            r9.terminated = r0
            p035rx.exceptions.Exceptions.throwIfFatal(r1)
            rx.Observer<? super T> r0 = r9.actual
            java.lang.Throwable r10 = p035rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r10)
            r0.onError(r10)
            return
        L6d:
            int r2 = r2 + 1
        ...
        L73:
            ...
            r9.terminated = r0
            rx.Observer<? super T> r0 = r9.actual
            p035rx.exceptions.Exceptions.throwOrReport(r1, r0, r10)
            return
        L7c:
            r10 = move-exception
            monitor-exit(r9)     // Catch: java.lang.Throwable -> L7c
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p035rx.observers.SerializedObserver.onNext(java.lang.Object):void");
    }
    ...
    public void onError(Throwable th) {
        ...
        synchronized (this) {
            ...
            if (this.emitting) {
                ...
                fastList.add(this.f3540nl.error(th));
                return;
            }
            this.emitting = true;
    ...
    public void onCompleted() {
        ...
        synchronized (this) {
            ...
            if (this.emitting) {
                ...
                fastList.add(this.f3540nl.completed());
                return;
            }
            this.emitting = true;
