...
final class SubjectSubscriptionManager<T> extends AtomicReference<State<T>> implements Observable.OnSubscribe<T> {
    ...
    public final NotificationLite<T> f3546nl;
    ...
    public SubjectSubscriptionManager() {
        ...
        this.f3546nl = NotificationLite.instance();
    }
    ...
    protected static final class SubjectObserver<T> implements Observer<T> {
        ...
        */
        protected void emitLoop(java.util.List<java.lang.Object> r5, java.lang.Object r6, p035rx.internal.operators.NotificationLite<T> r7) throws java.lang.Throwable {
            /*
                r4 = this;
                r0 = 1
                r1 = 1
