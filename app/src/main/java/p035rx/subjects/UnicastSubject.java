...
import p035rx.internal.operators.BackpressureUtils;
import p035rx.internal.operators.NotificationLite;
import p035rx.internal.util.atomic.SpscLinkedAtomicQueue;
import p035rx.internal.util.atomic.SpscUnboundedAtomicArrayQueue;
import p035rx.internal.util.unsafe.SpscLinkedQueue;
import p035rx.internal.util.unsafe.SpscUnboundedArrayQueue;
...
public final class UnicastSubject<T> extends Subject<T, T> {
    ...
    static final class State<T> extends AtomicLong implements Producer, Observer<T>, Observable.OnSubscribe<T>, Subscription {
        ...
        final NotificationLite<T> f3547nl = NotificationLite.instance();
        ...
        public void onNext(T t) {
            ...
            if (!this.caughtUp) {
                ...
                synchronized (this) {
                    if (!this.caughtUp) {
                        this.queue.offer(this.f3547nl.next(t));
                        z = true;
                    }
                }
                if (z) {
        ...
        */
        void replay() {
            ...
            Lf:
                ...
                rx.Subscriber r2 = (p035rx.Subscriber) r2
                r3 = 0
                if (r2 == 0) goto L7b
                boolean r4 = r14.done
            ...
            L50:
                ...
                goto L70
            L53:
                rx.internal.operators.NotificationLite<T> r11 = r14.f3547nl
            ...
            L61:
                ...
                java.lang.Throwable r0 = p035rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r11)
                r2.onError(r0)
                return
            L70:
                if (r6 != 0) goto L7c
