...
import p035rx.internal.operators.CompletableOnSubscribeConcat;
import p035rx.internal.operators.CompletableOnSubscribeConcatArray;
import p035rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p035rx.internal.operators.CompletableOnSubscribeMerge;
import p035rx.internal.operators.CompletableOnSubscribeMergeArray;
import p035rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p035rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p035rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p035rx.internal.operators.CompletableOnSubscribeTimeout;
import p035rx.internal.util.SubscriptionList;
import p035rx.internal.util.UtilityFunctions;
import p035rx.observers.SafeCompletableSubscriber;
import p035rx.observers.SafeSubscriber;
import p035rx.plugins.RxJavaCompletableExecutionHook;
import p035rx.plugins.RxJavaErrorHandler;
import p035rx.plugins.RxJavaPlugins;
import p035rx.schedulers.Schedulers;
import p035rx.subscriptions.BooleanSubscription;
...
public class Completable {
    ...
    public final Completable compose(CompletableTransformer completableTransformer) {
        return (Completable) m2320to(completableTransformer);
    }
    ...
    protected final Completable doOnLifecycle(Action1<? super Subscription> action1, Action1<? super Throwable> action12, Action0 action0, Action0 action02, Action0 action03) {
        ...
        return create(new C262017(action0, action02, action12, action1, action03));
    }

    /* JADX INFO: renamed from: rx.Completable$17 */
    class C262017 implements CompletableOnSubscribe {
        ...
        C262017(Action0 action0, Action0 action02, Action1 action1, Action1 action12, Action0 action03) {
        ...
        public void call(final CompletableSubscriber completableSubscriber) {
            Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.17.1
                ...
                public void onCompleted() {
                    try {
                        C262017.this.val$onComplete.call();
                        completableSubscriber.onCompleted();
                        try {
                            C262017.this.val$onAfterComplete.call();
                        } catch (Throwable th) {
                            Completable.ERROR_HANDLER.handleError(th);
                        }
                    } catch (Throwable th2) {
                ...
                public void onError(Throwable th) {
                    try {
                        C262017.this.val$onError.call(th);
                    } catch (Throwable th2) {
                        th = new CompositeException(Arrays.asList(th, th2));
                    }
                    completableSubscriber.onError(th);
    ...
    public final <U> U m2320to(Func1<? super Completable, U> func1) {
    ...
    /* JADX INFO: renamed from: rx.Completable$33 */
    class C263833 implements CompletableOnSubscribe {
        final /* synthetic */ Scheduler val$scheduler;

        C263833(Scheduler scheduler) {
            ...
            Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.33.1
                ...
                public void onSubscribe(final Subscription subscription) {
                    completableSubscriber.onSubscribe(Subscriptions.create(new Action0() { // from class: rx.Completable.33.1.1
                        @Override // p035rx.functions.Action0
                        public void call() {
                            final Scheduler.Worker workerCreateWorker = C263833.this.val$scheduler.createWorker();
    ...
    public final Completable unsubscribeOn(Scheduler scheduler) {
        requireNonNull(scheduler);
        return create(new C263833(scheduler));
    }
}
