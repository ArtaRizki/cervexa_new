...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m2330w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    */
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m2330w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i != 0) {
                        ...
                        if (i == 100) {
                            DebugLog.m2324e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                        ...
                        if (i == 200) {
                            if (message.arg1 == 3) {
                                DebugLog.m2326i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            }
                            ijkMediaPlayer.notifyOnInfo(message.arg1, message.arg2);
                            return;
                        } else {
                            if (i != 10001) {
                                DebugLog.m2324e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                                return;
                            }
            ...
            DebugLog.m2330w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
