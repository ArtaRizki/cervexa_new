...
public final class PausingDispatcherKt {
    ...
    @DebugMetadata(m2298c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m2299f = "PausingDispatcher.kt", m2300i = {0, 0, 0, 0}, m2301l = {IConstant.OP_EXIT_EDIT_MODE}, m2302m = "invokeSuspend", m2303n = {"$this$withContext", "job", "dispatcher", "controller"}, m2304s = {"L$0", "L$1", "L$2", "L$3"})
    static final class C04272<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C04272(Lifecycle lifecycle, Lifecycle.State state, Function2 function2, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C04272 c04272 = new C04272(this.$this_whenStateAtLeast, this.$minState, this.$block, completion);
            c04272.f70p$ = (CoroutineScope) obj;
            return c04272;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Object obj) {
            return ((C04272) create(coroutineScope, (Continuation) obj)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C04272(lifecycle, state, function2, null), continuation);
    }
}
