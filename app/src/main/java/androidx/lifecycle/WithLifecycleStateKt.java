...
public final class WithLifecycleStateKt {
    public static final <R> Object withStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked(lifecycle, state, zIsDispatchNeeded, immediate, new C04352(function0), continuation);
    }
    ...
    private static final Object withStateAtLeast$$forInline(Lifecycle lifecycle, Lifecycle.State state, Function0 function0, Continuation continuation) {
        ...
        boolean zIsDispatchNeeded = immediate.isDispatchNeeded(continuation2.get$context());
        if (!zIsDispatchNeeded) {
            if (lifecycle.getCurrentState() == Lifecycle.State.DESTROYED) {
                throw new LifecycleDestroyedException();
            }
        ...
        C04352 c04352 = new C04352(function0);
        InlineMarker.mark(0);
        Object objSuspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked(lifecycle, state, zIsDispatchNeeded, immediate, c04352, continuation);
        InlineMarker.mark(1);
    ...
    /* JADX INFO: compiled from: WithLifecycleState.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000\u0004\n\u0002\b\u0004\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, m2290d2 = {"<anonymous>", "R", "invoke", "()Ljava/lang/Object;"}, m2291k = 3, m2292mv = {1, 4, 0})
    public static final class C04352<R> extends Lambda implements Function0<R> {
        final /* synthetic */ Function0 $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C04352(Function0 function0) {
            super(0);
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.upTo(state)) {
                    ...
                    try {
                        ...
                        objM2353constructorimpl = Result.m2353constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                ...
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    cancellableContinuation2.resumeWith(Result.m2353constructorimpl(ResultKt.createFailure(lifecycleDestroyedException)));
                }
            }
        };
        if (z) {
            coroutineDispatcher.mo3708dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$2
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$3
            ...
            public final void invoke2(Throwable th) {
                if (coroutineDispatcher.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    coroutineDispatcher.mo3708dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$3.1
                        @Override // java.lang.Runnable
                        public final void run() {
