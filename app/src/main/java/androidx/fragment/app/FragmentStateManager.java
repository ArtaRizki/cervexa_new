...
class FragmentStateManager {
    ...
    int computeExpectedState() {
        ...
        int i = C03842.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i != 1) {
            if (i == 2) {
        ...
        return (!this.mFragment.mDeferStart || this.mFragment.mState >= 5) ? iMin : Math.min(iMin, 4);
    }
    ...
    void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0336R.id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
