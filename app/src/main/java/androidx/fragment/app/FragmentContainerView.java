...
public final class FragmentContainerView extends FrameLayout {
    ...
    FragmentContainerView(Context context, AttributeSet attributeSet, FragmentManager fragmentManager) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0336R.styleable.FragmentContainerView);
        classAttribute = classAttribute == null ? typedArrayObtainStyledAttributes.getString(C0336R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = typedArrayObtainStyledAttributes.getString(C0336R.styleable.FragmentContainerView_android_tag);
