...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean z) {
        ...
        if (fragment.mContainer != null && fragment.mContainer.getTag(C0336R.id.visible_removing_fragment_view_tag) != null) {
            fragment.mContainer.setTag(C0336R.id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0336R.animator.fragment_open_enter : C0336R.animator.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C0336R.animator.fragment_fade_enter : C0336R.animator.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C0336R.animator.fragment_close_enter : C0336R.animator.fragment_close_exit;
    }
