...
public abstract class FragmentTransaction {
    ...
    static final class C0386Op {
        ...
        C0386Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0386Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    void addOp(C0386Op c0386Op) {
        this.mOps.add(c0386Op);
        c0386Op.mEnterAnim = this.mEnterAnim;
        c0386Op.mExitAnim = this.mExitAnim;
        c0386Op.mPopEnterAnim = this.mPopEnterAnim;
        c0386Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0386Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0386Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0386Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0386Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0386Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0386Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0386Op(10, fragment, state));
        return this;
    }
