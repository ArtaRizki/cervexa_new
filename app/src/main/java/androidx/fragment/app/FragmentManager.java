...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0336R.id.fragment_container_view_tag);
    ...
    */
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (z3 || this.mCurState < 1) {
            ...
            for (int i8 = i; i8 < i2; i8++) {
                Iterator<FragmentTransaction.C0386Op> it = arrayList.get(i8).mOps.iterator();
                while (it.hasNext()) {
        ...
        if (USE_STATE_MANAGER) {
            ...
            for (int i9 = i; i9 < i2; i9++) {
                ...
                if (zBooleanValue) {
                    ...
                    Iterator<FragmentTransaction.C0386Op> it2 = backStackRecord2.mOps.iterator();
                    while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0386Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
                Fragment fragment = it.next().mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ViewGroup fragmentContainer = getFragmentContainer(fragment);
        if (fragmentContainer == null || fragment.mView == null) {
            return;
        }
        if (fragmentContainer.getTag(C0336R.id.visible_removing_fragment_view_tag) == null) {
            fragmentContainer.setTag(C0336R.id.visible_removing_fragment_view_tag, fragment);
        }
        ((Fragment) fragmentContainer.getTag(C0336R.id.visible_removing_fragment_view_tag)).setNextAnim(fragment.getNextAnim());
    }
