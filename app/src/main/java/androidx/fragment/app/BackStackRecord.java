...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0386Op c0386Op = this.mOps.get(i);
            switch (c0386Op.mCmd) {
                case 0:
                    str2 = "NULL";
                    break;
            ...
            printWriter.print(" ");
            printWriter.println(c0386Op.mFragment);
            if (z) {
                if (c0386Op.mEnterAnim != 0 || c0386Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0386Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0386Op.mExitAnim));
                }
                if (c0386Op.mPopEnterAnim != 0 || c0386Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0386Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0386Op.mPopExitAnim));
                }
            }
        }
    }
    ...
    void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0386Op c0386Op = this.mOps.get(i2);
                if (c0386Op.mFragment != null) {
                    c0386Op.mFragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(TAG, "Bump nesting of " + c0386Op.mFragment + " to " + c0386Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    boolean interactsWith(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            FragmentTransaction.C0386Op c0386Op = this.mOps.get(i2);
            int i3 = c0386Op.mFragment != null ? c0386Op.mFragment.mContainerId : 0;
            if (i3 != 0 && i3 == i) {
                return true;
            }
        }
    ...
    boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            FragmentTransaction.C0386Op c0386Op = this.mOps.get(i4);
            int i5 = c0386Op.mFragment != null ? c0386Op.mFragment.mContainerId : 0;
            if (i5 != 0 && i5 != i3) {
                for (int i6 = i; i6 < i2; i6++) {
                    BackStackRecord backStackRecord = arrayList.get(i6);
                    int size2 = backStackRecord.mOps.size();
                    for (int i7 = 0; i7 < size2; i7++) {
                        FragmentTransaction.C0386Op c0386Op2 = backStackRecord.mOps.get(i7);
                        if ((c0386Op2.mFragment != null ? c0386Op2.mFragment.mContainerId : 0) == i5) {
                            return true;
                        }
                    }
                }
    ...
    void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0386Op c0386Op = this.mOps.get(i);
            Fragment fragment = c0386Op.mFragment;
            if (fragment != null) {
            ...
            switch (c0386Op.mCmd) {
                case 1:
                    fragment.setNextAnim(c0386Op.mEnterAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0386Op.mCmd);
                case 3:
                    fragment.setNextAnim(c0386Op.mExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0386Op.mCurrentMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c0386Op.mCmd != 1 && fragment != null && !FragmentManager.USE_STATE_MANAGER) {
    ...
    void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0386Op c0386Op = this.mOps.get(size);
            Fragment fragment = c0386Op.mFragment;
            if (fragment != null) {
            ...
            switch (c0386Op.mCmd) {
                case 1:
                    fragment.setNextAnim(c0386Op.mPopExitAnim);
                ...
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0386Op.mCmd);
                case 3:
                    fragment.setNextAnim(c0386Op.mPopEnterAnim);
                    this.mManager.addFragment(fragment);
                    break;
                case 4:
                    fragment.setNextAnim(c0386Op.mPopEnterAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0386Op.mOldMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c0386Op.mCmd != 3 && fragment != null && !FragmentManager.USE_STATE_MANAGER) {
                this.mManager.moveFragmentToExpectedState(fragment);
            }
        }
    ...
    */
    androidx.fragment.app.Fragment expandOps(java.util.ArrayList<androidx.fragment.app.Fragment> r17, androidx.fragment.app.Fragment r18) {
        ...
        L7:
            ...
            androidx.fragment.app.FragmentTransaction$Op r5 = (androidx.fragment.app.FragmentTransaction.C0386Op) r5
            int r6 = r5.mCmd
            r7 = 0
            r8 = 1
            if (r6 == r8) goto Lb4
    ...
    */
    androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        ...
        L8:
            ...
            androidx.fragment.app.FragmentTransaction$Op r2 = (androidx.fragment.app.FragmentTransaction.C0386Op) r2
            int r3 = r2.mCmd
            if (r3 == r1) goto L2d
            r4 = 3
            if (r3 == r4) goto L27
    ...
    void setOnStartPostponedListener(Fragment.OnStartEnterTransitionListener onStartEnterTransitionListener) {
        for (int i = 0; i < this.mOps.size(); i++) {
            FragmentTransaction.C0386Op c0386Op = this.mOps.get(i);
            if (isFragmentPostponed(c0386Op)) {
                c0386Op.mFragment.setOnStartEnterTransitionListener(onStartEnterTransitionListener);
            }
        }
    }

    private static boolean isFragmentPostponed(FragmentTransaction.C0386Op c0386Op) {
        Fragment fragment = c0386Op.mFragment;
