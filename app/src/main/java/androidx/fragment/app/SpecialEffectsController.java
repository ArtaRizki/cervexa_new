...
import androidx.fragment.C0336R;
...
abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0336R.id.special_effects_controller_view_tag);
        ...
        viewGroup.setTag(C0336R.id.special_effects_controller_view_tag, specialEffectsControllerCreateController);
    ...
    static class Operation {
        ...
        enum State {
            ...
            void applyState(View view) {
                int i = C04093.f65xe493b431[ordinal()];
                if (i == 1) {
        ...
        final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C04093.f64xb9e640f0[lifecycleImpact.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C04093 {
        ...
        static {
            ...
            try {
                f64xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f64xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f65xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f65xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f65xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
