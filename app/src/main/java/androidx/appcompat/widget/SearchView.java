...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSearchPlate = findViewById(C0051R.id.search_plate);
        this.mSubmitArea = findViewById(C0051R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0051R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0051R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0051R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0051R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0051R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = tintTypedArrayObtainStyledAttributes.getDrawable(C0051R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0051R.string.abc_searchview_description_search));
