...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mLayoutParams.windowAnimations = C0051R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        if (this.mTmpDisplayFrame.left < 0 && this.mTmpDisplayFrame.top < 0) {
            ...
            int identifier = resources.getIdentifier("status_bar_height", "dimen", IConstant.ANDROID_DIR);
