...
public class KeyPosition extends KeyPositionBase {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0182R.styleable.KeyPosition));
    }
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0182R.styleable.KeyPosition_motionTarget, 1);
            mAttrMap.append(C0182R.styleable.KeyPosition_framePosition, 2);
            mAttrMap.append(C0182R.styleable.KeyPosition_transitionEasing, 3);
            mAttrMap.append(C0182R.styleable.KeyPosition_curveFit, 4);
            mAttrMap.append(C0182R.styleable.KeyPosition_drawPath, 5);
            mAttrMap.append(C0182R.styleable.KeyPosition_percentX, 6);
            mAttrMap.append(C0182R.styleable.KeyPosition_percentY, 7);
            mAttrMap.append(C0182R.styleable.KeyPosition_keyPositionType, 9);
            mAttrMap.append(C0182R.styleable.KeyPosition_sizePercent, 8);
            mAttrMap.append(C0182R.styleable.KeyPosition_percentWidth, 11);
            mAttrMap.append(C0182R.styleable.KeyPosition_percentHeight, 12);
            mAttrMap.append(C0182R.styleable.KeyPosition_pathMotionArc, 10);
        }
