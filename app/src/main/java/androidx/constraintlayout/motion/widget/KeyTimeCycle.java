...
public class KeyTimeCycle extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0182R.styleable.KeyTimeCycle));
    }
    ...
    */
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0182R.styleable.KeyTimeCycle_android_alpha, 1);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_elevation, 2);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_rotation, 4);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_rotationX, 5);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_rotationY, 6);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_scaleX, 7);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_transitionPathRotate, 8);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_transitionEasing, 9);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_motionTarget, 10);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_framePosition, 12);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_curveFit, 13);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_scaleY, 14);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_translationX, 15);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_translationY, 16);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_android_translationZ, 17);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_motionProgress, 18);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_wavePeriod, 20);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_waveOffset, 21);
            mAttrMap.append(C0182R.styleable.KeyTimeCycle_waveShape, 19);
        }
