...
public class KeyCycle extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0182R.styleable.KeyCycle));
    }
    ...
    */
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0182R.styleable.KeyCycle_motionTarget, 1);
            mAttrMap.append(C0182R.styleable.KeyCycle_framePosition, 2);
            mAttrMap.append(C0182R.styleable.KeyCycle_transitionEasing, 3);
            mAttrMap.append(C0182R.styleable.KeyCycle_curveFit, 4);
            mAttrMap.append(C0182R.styleable.KeyCycle_waveShape, 5);
            mAttrMap.append(C0182R.styleable.KeyCycle_wavePeriod, 6);
            mAttrMap.append(C0182R.styleable.KeyCycle_waveOffset, 7);
            mAttrMap.append(C0182R.styleable.KeyCycle_waveVariesBy, 8);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_alpha, 9);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_elevation, 10);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_rotation, 11);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_rotationX, 12);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_rotationY, 13);
            mAttrMap.append(C0182R.styleable.KeyCycle_transitionPathRotate, 14);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_scaleX, 15);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_scaleY, 16);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_translationX, 17);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_translationY, 18);
            mAttrMap.append(C0182R.styleable.KeyCycle_android_translationZ, 19);
            mAttrMap.append(C0182R.styleable.KeyCycle_motionProgress, 20);
        }
