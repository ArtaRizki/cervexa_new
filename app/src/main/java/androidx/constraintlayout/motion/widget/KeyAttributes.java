...
public class KeyAttributes extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0182R.styleable.KeyAttribute));
    }
    ...
    */
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0182R.styleable.KeyAttribute_android_alpha, 1);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_elevation, 2);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_rotation, 4);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_rotationX, 5);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_rotationY, 6);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_transformPivotX, 19);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_transformPivotY, 20);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_scaleX, 7);
            mAttrMap.append(C0182R.styleable.KeyAttribute_transitionPathRotate, 8);
            mAttrMap.append(C0182R.styleable.KeyAttribute_transitionEasing, 9);
            mAttrMap.append(C0182R.styleable.KeyAttribute_motionTarget, 10);
            mAttrMap.append(C0182R.styleable.KeyAttribute_framePosition, 12);
            mAttrMap.append(C0182R.styleable.KeyAttribute_curveFit, 13);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_scaleY, 14);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_translationX, 15);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_translationY, 16);
            mAttrMap.append(C0182R.styleable.KeyAttribute_android_translationZ, 17);
            mAttrMap.append(C0182R.styleable.KeyAttribute_motionProgress, 18);
        }
