...
public class KeyTrigger extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0182R.styleable.KeyTrigger), context);
    }
    ...
    */
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0182R.styleable.KeyTrigger_framePosition, 8);
            mAttrMap.append(C0182R.styleable.KeyTrigger_onCross, 4);
            mAttrMap.append(C0182R.styleable.KeyTrigger_onNegativeCross, 1);
            mAttrMap.append(C0182R.styleable.KeyTrigger_onPositiveCross, 2);
            mAttrMap.append(C0182R.styleable.KeyTrigger_motionTarget, 7);
            mAttrMap.append(C0182R.styleable.KeyTrigger_triggerId, 6);
            mAttrMap.append(C0182R.styleable.KeyTrigger_triggerSlack, 5);
            mAttrMap.append(C0182R.styleable.KeyTrigger_motion_triggerOnCollision, 9);
            mAttrMap.append(C0182R.styleable.KeyTrigger_motion_postLayoutCollision, 10);
            mAttrMap.append(C0182R.styleable.KeyTrigger_triggerReceiver, 11);
        }
