...
public abstract class WidgetRun implements Dependency {
    ...
    protected final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C01751.f45x4c44d048[constraintAnchor.mTarget.mType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01751 {
        ...
        static {
            ...
            try {
                f45x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f45x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f45x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f45x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 5;
    ...
    protected final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C01751.f45x4c44d048[constraintAnchor.mTarget.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {
