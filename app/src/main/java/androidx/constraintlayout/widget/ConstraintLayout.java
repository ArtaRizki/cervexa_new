...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            int i7 = C01811.f48xdde91696[dimensionBehaviour.ordinal()];
            if (i7 == 1) {
            ...
            int i8 = C01811.f48xdde91696[dimensionBehaviour2.ordinal()];
            if (i8 == 1) {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0182R.styleable.ConstraintLayout_Layout, i, i2);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i3 = 0; i3 < indexCount; i3++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i3);
                if (index == C0182R.styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.mMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMinWidth);
                } else if (index == C0182R.styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.mMinHeight = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMinHeight);
                } else if (index == C0182R.styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.mMaxWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxWidth);
                } else if (index == C0182R.styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.mMaxHeight = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxHeight);
                } else if (index == C0182R.styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.mOptimizationLevel = typedArrayObtainStyledAttributes.getInt(index, this.mOptimizationLevel);
                } else if (index == C0182R.styleable.ConstraintLayout_Layout_layoutDescription) {
                ...
                } else if (index == C0182R.styleable.ConstraintLayout_Layout_constraintSet) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private static class Table {
            ...
            static {
                ...
                map = sparseIntArray;
                sparseIntArray.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintCircle, 2);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                map.append(C0182R.styleable.ConstraintLayout_Layout_android_orientation, 1);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
                map.append(C0182R.styleable.ConstraintLayout_Layout_layout_constraintTag, 51);
            }
        }
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.widget = new ConstraintWidget();
            this.helped = false;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0182R.styleable.ConstraintLayout_Layout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
