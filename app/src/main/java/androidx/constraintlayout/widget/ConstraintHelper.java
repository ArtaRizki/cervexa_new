...
public abstract class ConstraintHelper extends View {
    ...
    protected void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0182R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = typedArrayObtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C0182R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String str) {
        ...
        if (iFindId == 0) {
            try {
                iFindId = C0182R.id.class.getField(str).getInt(null);
