...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C05071 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C05071.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C05071.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C05071.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        C05071.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    }
                    next = C05071.this.mQueue.next();
                }
            }
        };

        C05071(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C05071(mainThreadCallback);
    }

    /* JADX INFO: renamed from: androidx.recyclerview.widget.MessageThreadUtil$2 */
    class C05082 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C05082.this.mQueue.next();
                    if (next != null) {
                        int i = next.what;
                        if (i == 1) {
                            C05082.this.mQueue.removeMessages(1);
                            C05082.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            C05082.this.mQueue.removeMessages(2);
                            C05082.this.mQueue.removeMessages(3);
                            C05082.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            C05082.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            C05082.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
                        C05082.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C05082(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C05082(backgroundCallback);
    }
