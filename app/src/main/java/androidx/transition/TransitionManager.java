...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo2338clone = transition.mo2338clone();
        transitionMo2338clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo2338clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo2338clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo2338clone);
    }
    ...
    public static void m15go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* JADX INFO: renamed from: go */
    public static void m16go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo2338clone = transition.mo2338clone();
        sceneChangeSetup(viewGroup, transitionMo2338clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo2338clone);
    }
