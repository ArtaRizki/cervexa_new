...
class ViewUtilsBase {
    ...
    public void setTransitionAlpha(View view, float f) {
        Float f2 = (Float) view.getTag(C0566R.id.save_non_transition_alpha);
        if (f2 != null) {
    ...
    public float getTransitionAlpha(View view) {
        Float f = (Float) view.getTag(C0566R.id.save_non_transition_alpha);
        if (f != null) {
    ...
    public void saveNonTransitionAlpha(View view) {
        if (view.getTag(C0566R.id.save_non_transition_alpha) == null) {
            view.setTag(C0566R.id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }

    public void clearNonTransitionAlpha(View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0566R.id.save_non_transition_alpha, null);
        }
    }
