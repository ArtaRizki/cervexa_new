...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup viewGroup, int i, Context context) {
        SparseArray sparseArray = (SparseArray) viewGroup.getTag(C0566R.id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            viewGroup.setTag(C0566R.id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    static void setCurrentScene(ViewGroup viewGroup, Scene scene) {
        viewGroup.setTag(C0566R.id.transition_current_scene, scene);
    }

    public static Scene getCurrentScene(ViewGroup viewGroup) {
        return (Scene) viewGroup.getTag(C0566R.id.transition_current_scene);
    }
