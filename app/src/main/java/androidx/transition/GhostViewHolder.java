...
class GhostViewHolder extends FrameLayout {
    ...
    GhostViewHolder(ViewGroup viewGroup) {
        ...
        viewGroup.setTag(C0566R.id.ghost_view_holder, this);
    ...
    public void onViewRemoved(View view) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == view) || getChildCount() == 0) {
            this.mParent.setTag(C0566R.id.ghost_view_holder, null);
    ...
    static GhostViewHolder getHolder(ViewGroup viewGroup) {
        return (GhostViewHolder) viewGroup.getTag(C0566R.id.ghost_view_holder);
    }
