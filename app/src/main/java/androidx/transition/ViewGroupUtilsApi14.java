...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(ViewGroup viewGroup, boolean z) {
        ...
        if (z) {
            ...
            if (layoutTransition2 != null) {
                ...
                if (layoutTransition2 != sEmptyLayoutTransition) {
                    viewGroup.setTag(C0566R.id.transition_layout_save, layoutTransition2);
                }
            }
        ...
        LayoutTransition layoutTransition3 = (LayoutTransition) viewGroup.getTag(C0566R.id.transition_layout_save);
        if (layoutTransition3 != null) {
            viewGroup.setTag(C0566R.id.transition_layout_save, null);
