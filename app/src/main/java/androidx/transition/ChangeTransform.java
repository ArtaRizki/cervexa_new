...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (this.mReparent) {
            ...
            transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0566R.id.transition_transform));
            transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0566R.id.parent_matrix));
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, final boolean z) {
        ...
        AnimatorListenerAdapter animatorListenerAdapter = new AnimatorListenerAdapter() { // from class: androidx.transition.ChangeTransform.3
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (z && ChangeTransform.this.mUseOverlay) {
                        ...
                        view.setTag(C0566R.id.transition_transform, null);
                        view.setTag(C0566R.id.parent_matrix, null);
                    }
                }
            ...
            private void setCurrentMatrix(Matrix matrix4) {
                ...
                view.setTag(C0566R.id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
    ...
    */
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0566R.id.parent_matrix, matrix);
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTag(C0566R.id.transition_transform, null);
            this.mView.setTag(C0566R.id.parent_matrix, null);
        }
