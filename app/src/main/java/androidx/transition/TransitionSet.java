...
public class TransitionSet extends Transition {
    ...
    public Transition mo2338clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo2338clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo2338clone());
        }
