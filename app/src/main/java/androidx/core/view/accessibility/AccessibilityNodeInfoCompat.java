...
public class AccessibilityNodeInfoCompat {
            ...
            if (cls != null) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (cls2 == null ? IConstant.DEFAULT_PATH : cls2.getName()), e);
                    }
                } catch (Exception e2) {
                    e = e2;
                }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        ...
        getExtras().putInt(SPANS_ACTION_ID_KEY, C0186R.id.accessibility_action_clickable_span);
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(C0186R.id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C0186R.id.tag_accessibility_clickable_spans);
    }
