...
public final class NotificationManagerCompat {
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f52id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f52id + ", tag:" + this.tag + "]";
        }
    }
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f51id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f51id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
}
