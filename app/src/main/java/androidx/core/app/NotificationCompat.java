...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0186R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0186R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0186R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0186R.id.notification_main_column);
            remoteViews.addView(C0186R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0186R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0186R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0186R.id.title, 8);
            remoteViews.setViewVisibility(C0186R.id.text2, 8);
            remoteViews.setViewVisibility(C0186R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0186R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0186R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            boolean z2 = true;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0186R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0186R.id.actions);
            ...
            if (!z || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0186R.id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0186R.id.actions, i2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0186R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0186R.layout.notification_action_tombstone;
            } else {
                i = C0186R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            remoteViews.setImageViewBitmap(C0186R.id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0186R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0186R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0186R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0186R.id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m2335clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m2336clone() {
            WearableExtender wearableExtender = new WearableExtender();
