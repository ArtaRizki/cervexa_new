        ...
        try {
            ...
            if (cursorQuery != null && cursorQuery.getCount() > 0) {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(uriWithAppendedId, i2, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : NNTPReply.SERVICE_DISCONTINUED, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i));
                }
