...
public final class DurationKt {
    ...
    private static final double m3658timesmvk6XK0(int i, double d) {
        return Duration.m3638timesUwyO8pc(d, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m3657timeskIfJnKk(double d, double d2) {
        return Duration.m3637timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m3611constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
