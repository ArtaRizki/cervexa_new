...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m2353constructorimpl(function0.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m2353constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m2353constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m2353constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> function1) {
        Throwable thM2356exceptionOrNullimpl = Result.m2356exceptionOrNullimpl(obj);
        return thM2356exceptionOrNullimpl == null ? obj : function1.invoke(thM2356exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m2359isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        Throwable thM2356exceptionOrNullimpl = Result.m2356exceptionOrNullimpl(obj);
        if (thM2356exceptionOrNullimpl == null) {
            return function1.invoke(obj);
        }
        return function12.invoke(thM2356exceptionOrNullimpl);
    }

    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> function1) {
        if (!Result.m2360isSuccessimpl(obj)) {
            return Result.m2353constructorimpl(obj);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m2353constructorimpl(function1.invoke(obj));
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m2353constructorimpl(function1.invoke(thM2356exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable thM2356exceptionOrNullimpl = Result.m2356exceptionOrNullimpl(obj);
        if (thM2356exceptionOrNullimpl != null) {
            function1.invoke(thM2356exceptionOrNullimpl);
        }
        return obj;
    }
