...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double m2308ln(double d) {
        return Math.log(d);
    }
    ...
    /* JADX INFO: renamed from: ln */
    private static final float m2309ln(float f) {
