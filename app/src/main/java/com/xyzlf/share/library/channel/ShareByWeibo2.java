    ...
    public void localSyncTask(final Bitmap bitmap) {
        new AbstractAsyncTask<String>() { // from class: com.xyzlf.share.library.channel.ShareByWeibo2.2
            ...
            public String doLoadData() throws Exception {
                String strSaveBitmapToSDCard;
                if (bitmap != null) {
                    strSaveBitmapToSDCard = ShareUtil.saveBitmapToSDCard(ShareByWeibo2.this.context, bitmap);
                } else {
                    Context context = ShareByWeibo2.this.context;
                    ShareByWeibo2 shareByWeibo2 = ShareByWeibo2.this;
                    strSaveBitmapToSDCard = ShareUtil.saveBitmapToSDCard(context, shareByWeibo2.getDefaultBitmap(shareByWeibo2.context));
                }
                ShareByWeibo2.this.weiboShare(strSaveBitmapToSDCard);
                return null;
            }
        }.execute(new Void[0]);
    }
