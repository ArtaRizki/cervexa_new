...
import com.tencent.p023mm.opensdk.modelmsg.WXImageObject;
import com.tencent.p023mm.opensdk.modelmsg.WXMediaMessage;
import com.tencent.p023mm.opensdk.modelmsg.WXTextObject;
    ...
    private class WeixinShareReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.hasExtra(ShareConstant.EXTRA_WEIXIN_RESULT)) {
                if ((intent.getIntExtra(ShareConstant.EXTRA_WEIXIN_RESULT, -2) == 0 ? (byte) -1 : (byte) 0) == -1) {
        ...
        if (true) {
            if (true) {
                ...
                try {
                    ...
                    bitmapCreateScaledBitmap.compress(Bitmap.CompressFormat.JPEG, 85, byteArrayOutputStream);
