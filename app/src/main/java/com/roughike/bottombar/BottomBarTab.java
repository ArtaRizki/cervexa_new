...
public class BottomBarTab extends LinearLayout {
    ...
    /* JADX INFO: renamed from: com.roughike.bottombar.BottomBarTab$5 */
    static /* synthetic */ class C18245 {
    ...
    void updateWidth(float f, boolean z) {
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(getWidth(), f);
        valueAnimatorOfFloat.setDuration(150L);
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.roughike.bottombar.BottomBarTab.2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        ...
        valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.roughike.bottombar.BottomBarTab.3
    ...
    private void setTopPaddingAnimated(int i, int i2) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.roughike.bottombar.BottomBarTab.4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    private void animateTitle(float f, float f2) {
        ...
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompatScaleY = ViewCompat.animate(this.titleView).setDuration(150L).scaleX(f).scaleY(f);
        viewPropertyAnimatorCompatScaleY.alpha(f2);
        viewPropertyAnimatorCompatScaleY.start();
    }
