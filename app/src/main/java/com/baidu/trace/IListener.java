...
public interface IListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IListener {
        ...
        public static IListener asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IListener)) ? new Proxy(iBinder) : (IListener) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 5:
                    parcel.enforceInterface(DESCRIPTOR);
                    Map mapGatherAttribute = gatherAttribute(parcel.readLong());
                    parcel2.writeNoException();
                    parcel2.writeMap(mapGatherAttribute);
                    return true;
                case 6:
                    parcel.enforceInterface(DESCRIPTOR);
