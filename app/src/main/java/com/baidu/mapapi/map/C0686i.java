...
/* JADX INFO: renamed from: com.baidu.mapapi.map.i */
/* JADX INFO: loaded from: classes.dex */
class C0686i implements InterfaceC0753l {

    /* JADX INFO: renamed from: a */
    final /* synthetic */ MapView f672a;

    C0686i(MapView mapView) {
        this.f672a = mapView;
    }
    ...
    public void mo409a() {
        String str;
        if (this.f672a.f414c == null || this.f672a.f414c.m716a() == null) {
            return;
        }
        float f = this.f672a.f414c.m716a().m620D().f845a;
        if (this.f672a.f428r != f) {
            int iIntValue = ((Integer) MapView.f413n.get((int) f)).intValue();
            int i = ((int) (((double) iIntValue) / this.f672a.f414c.m716a().m620D().f857m)) / 2;
            this.f672a.f424m.setPadding(i, 0, i, 0);
            ...
            this.f672a.f422k.setText(str);
            this.f672a.f423l.setText(str);
            this.f672a.f428r = f;
        }
        this.f672a.m328b();
