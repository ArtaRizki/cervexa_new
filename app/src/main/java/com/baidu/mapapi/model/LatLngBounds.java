...
public final class LatLngBounds implements Parcelable {
    public static final Parcelable.Creator<LatLngBounds> CREATOR = new C0704b();
    ...
    public static final class Builder {
        ...
        private double f705b;

        /* JADX INFO: renamed from: c */
        private double f706c;

        /* JADX INFO: renamed from: d */
        private double f707d;

        /* JADX INFO: renamed from: e */
        private boolean f708e = true;

        public LatLngBounds build() {
            return new LatLngBounds(new LatLng(this.f705b, this.f707d), new LatLng(this.f704a, this.f706c));
        }
