...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo2342clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo2342clone();
        ...
        for (Node node : this.mNodes) {
            Node nodeM2343clone = node.m2343clone();
            map.put(node, nodeM2343clone);
            animatorSet.mNodes.add(nodeM2343clone);
            animatorSet.mNodeMap.put(nodeM2343clone.animation, nodeM2343clone);
            ArrayList arrayList = null;
            nodeM2343clone.dependencies = null;
            nodeM2343clone.tmpDependencies = null;
            nodeM2343clone.nodeDependents = null;
            nodeM2343clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM2343clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m2343clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo2342clone();
                return node;
