...
public class ValueAnimator extends Animator {
    ...
    public ValueAnimator mo2342clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo2342clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo2346clone = propertyValuesHolderArr[i2].mo2346clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo2346clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo2346clone.getPropertyName(), propertyValuesHolderMo2346clone);
            }
        }
        return valueAnimator;
    }
