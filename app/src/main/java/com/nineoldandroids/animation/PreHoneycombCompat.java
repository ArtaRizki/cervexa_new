...
final class PreHoneycombCompat {
    ...
    static Property<View, Float> f2241X = new FloatProperty<View>("x") { // from class: com.nineoldandroids.animation.PreHoneycombCompat.13
        @Override // com.nineoldandroids.util.FloatProperty
        public void setValue(View view, float f) {
    ...
    static Property<View, Float> f2242Y = new FloatProperty<View>("y") { // from class: com.nineoldandroids.animation.PreHoneycombCompat.14
        @Override // com.nineoldandroids.util.FloatProperty
        public void setValue(View view, float f) {
