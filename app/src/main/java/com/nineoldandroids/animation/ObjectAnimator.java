...
public final class ObjectAnimator extends ValueAnimator {
    ...
    static {
        ...
        PROXY_PROPERTIES.put("x", PreHoneycombCompat.f2241X);
        PROXY_PROPERTIES.put("y", PreHoneycombCompat.f2242Y);
    }
    ...
    public ObjectAnimator mo2342clone() {
        return (ObjectAnimator) super.mo2342clone();
    }
