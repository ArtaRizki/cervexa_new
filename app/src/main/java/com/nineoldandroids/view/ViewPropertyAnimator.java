...
public abstract class ViewPropertyAnimator {
    ...
    public abstract ViewPropertyAnimator mo1393x(float f);

    public abstract ViewPropertyAnimator xBy(float f);

    /* JADX INFO: renamed from: y */
    public abstract ViewPropertyAnimator mo1394y(float f);

    public abstract ViewPropertyAnimator yBy(float f);

    public static ViewPropertyAnimator animate(View view) {
        ViewPropertyAnimator viewPropertyAnimatorPreHC = ANIMATORS.get(view);
        if (viewPropertyAnimatorPreHC == null) {
            ...
            ANIMATORS.put(view, viewPropertyAnimatorPreHC);
        }
