...
import com.jieli.lib.p015dv.control.json.bean.RequestCmd;
...
import com.jieli.lib.p015dv.control.utils.Operation;
...
public class DeviceClient implements IClient {
    ...
    public DeviceClient(Context context, int i) {
        ...
        if (i == 0) {
            this.f2078b = ClientImpl.getInstance(context);
        } else {
            if (i == 1) {
                this.f2078b = UDPClientImpl.getInstance(context);
                return;
            }
    ...
    @Override // com.jieli.lib.p015dv.control.IClient
    public int getState() {
        return this.f2078b.getState();
    }

    @Override // com.jieli.lib.p015dv.control.IClient
    public void send(CmdInfo cmdInfo, SendResponse sendResponse) {
        this.f2078b.send(cmdInfo, (SendResponse) ProxyUtils.getUIProxy(sendResponse));
    }
    ...
    public void registerConnectStateListener(OnConnectStateListener onConnectStateListener) {
        this.f2078b.registerConnectStateListener(onConnectStateListener);
    }

    @Override // com.jieli.lib.p015dv.control.IClient
    public void unregisterConnectStateListener(OnConnectStateListener onConnectStateListener) {
        this.f2078b.unregisterConnectStateListener(onConnectStateListener);
    }

    @Override // com.jieli.lib.p015dv.control.IClient
    public void registerNotifyListener(OnNotifyListener onNotifyListener) {
        this.f2078b.registerNotifyListener(onNotifyListener);
    }

    @Override // com.jieli.lib.p015dv.control.IClient
    public void unregisterNotifyListener(OnNotifyListener onNotifyListener) {
        this.f2078b.unregisterNotifyListener(onNotifyListener);
    }
