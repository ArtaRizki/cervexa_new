...
public class MovWrapper extends AbsRecording {
    ...
    @Override // com.jieli.lib.p015dv.control.player.AbsRecording, com.jieli.lib.p015dv.control.player.IStreamClient, com.jieli.lib.p015dv.control.base.AbstractClient
    public boolean close() {
        boolean zNativeClose = nativeClose(this.nativeCustomData);
        if (zNativeClose) {
