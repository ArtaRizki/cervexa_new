...
import com.jieli.lib.p015dv.control.exception.NativeException;
...
public class AviWrapper extends AbsRecording {
    ...
    public AviWrapper() {
        ...
        try {
            ...
            Dlog.m1383e(this.tag, "Initialize native FieldID and MethodID failed.");
    ...
    @Override // com.jieli.lib.p015dv.control.player.AbsRecording
    ...
    @Override // com.jieli.lib.p015dv.control.player.AbsRecording, com.jieli.lib.p015dv.control.player.IStreamClient
