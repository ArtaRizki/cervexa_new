...
import com.jieli.lib.p015dv.control.gps.GpsParser;
...
public final class PlaybackStream extends Stream {
    ...
    @Override // com.jieli.lib.p015dv.control.player.IStreamClient
    ...
    @Override // com.jieli.lib.p015dv.control.player.IStreamClient, com.jieli.lib.p015dv.control.base.AbstractClient
    ...
    public void onError(final int i, final String str) {
        ...
        if (hashSet != null) {
            for (final OnPlaybackListener onPlaybackListener : hashSet) {
                ClientContext.post(new Runnable() { // from class: com.jieli.lib.dv.control.player.PlaybackStream.2
                    @Override // java.lang.Runnable
                    public void run() {
                        IPlayerListener iPlayerListener = onPlaybackListener;
    ...
    @Override // com.jieli.lib.p015dv.control.player.Stream
        ...
        if (this.mOnDownloadListener != null) {
            ...
            ClientContext.post(new Runnable() { // from class: com.jieli.lib.dv.control.player.PlaybackStream.5
                ...
                public void run() {
                    ...
                    float fRound = PlaybackStream.round(PlaybackStream.this.mProgress / PlaybackStream.this.mDownloadDuration);
                    Dlog.m1384i(PlaybackStream.tag, "==duration " + PlaybackStream.this.mDownloadDuration + ", progress " + fRound + ", mProgress=" + PlaybackStream.this.mProgress);
                    if (PlaybackStream.this.mProgress <= 0 || PlaybackStream.this.mProgress != ((int) PlaybackStream.this.mDownloadDuration)) {
                        if (PlaybackStream.this.mProgress <= PlaybackStream.this.mDownloadDuration) {
                            PlaybackStream.this.mOnDownloadListener.onProgress(fRound);
                        }
                    } else {
                        PlaybackStream.this.mOnDownloadListener.onProgress(fRound);
