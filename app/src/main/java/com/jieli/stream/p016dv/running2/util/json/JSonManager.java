package com.jieli.stream.p016dv.running2.util.json;
...
public class JSonManager {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0041, code lost:
        ...
        r6 = r5.getJSONArray(com.jieli.stream.p016dv.running2.util.json.JSonManager.TXT_FILE_LIST);
     */
    ...
    */
    public synchronized void parseJSon(com.jieli.stream.p016dv.running2.util.json.listener.OnCompletedListener<java.lang.Boolean> r17) throws org.json.JSONException {
        /*
    ...
    public static FileInfo parseFileInfo(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                String strOptString = jSONObject.optString(TXT_PATH);
                if (!TextUtils.isEmpty(strOptString)) {
                    lowerCase = strOptString.substring(strOptString.lastIndexOf(".") + 1).toLowerCase();
                    ...
                    switch (lowerCase) {
                        ...
                        case "avi":
                            ...
                            break;
                        default:
                            Dlog.m1383e(tag, "error:" + lowerCase);
                            return null;
                    }
                    ...
                    fileInfo.setName(strOptString.substring(strOptString.lastIndexOf("/") + 1));
                    ...
                    if (fileInfo.isVideo()) {
                        ...
                        if (date != null) {
                            ...
                            Dlog.m1383e(tag, "Parse start time string fail!");
                        }
                        ...
                        if (date != null) {
                            ...
                            Dlog.m1383e(tag, "Parse end time string fail!");
                        }
                    }
                    return fileInfo;
                }
