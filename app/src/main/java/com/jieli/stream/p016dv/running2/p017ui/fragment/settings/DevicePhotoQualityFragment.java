...
public class DevicePhotoQualityFragment extends BaseFragment {
    ...
    private final OnNotifyListener onNotifyListener = new OnNotifyListener() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DevicePhotoQualityFragment.2
        ...
        public void onNotify(NotifyInfo notifyInfo) {
            if (notifyInfo.getErrorType() != 0) {
                ...
                ToastUtil.showToastShort(DevicePhotoQualityFragment.this.getString(C1438R.string.setting_failed));
                return;
            }
            ...
            ToastUtil.showToastShort(DevicePhotoQualityFragment.this.getString(C1438R.string.setting_successed));
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(C1438R.layout.fragment_device_setting_photo_qulity, viewGroup, false);
        this.radioGroup = (RadioGroup) viewInflate.findViewById(C1438R.id.photo_qulity_radio_group);
        this.photoQulityTextView = (TextView) viewInflate.findViewById(C1438R.id.photo_qulity_value);
        this.timeTextView = (TextView) viewInflate.findViewById(C1438R.id.recording_time);
        final String[] stringArray = getResources().getStringArray(C1438R.array.photo_qulity);
        ...
        this.photoQulityTextView.setText(String.format(getString(C1438R.string.photo_qulity_value), stringArray[photoQualityIndex], Integer.valueOf((photoQualityIndex + 1) * 240)));
        this.timeTextView.setText(String.format(getString(C1438R.string.recorded_time), "12:12:12"));
        this.radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DevicePhotoQualityFragment.1
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                DevicePhotoQualityFragment.this.photoQulityTextView.setText(String.format(DevicePhotoQualityFragment.this.getString(C1438R.string.photo_qulity_value), stringArray[iIndexOfChild], Integer.valueOf((iIndexOfChild + 1) * 240)));
