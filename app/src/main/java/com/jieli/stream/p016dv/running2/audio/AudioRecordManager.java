package com.jieli.stream.p016dv.running2.audio;
...
public class AudioRecordManager {
    ...
    public void readData() {
        ...
        while (this.isRecord) {
            int i2 = this.audioRecord.read(bArr, 0, this.bufferSizeInBytes);
            if (-3 != i2) {
                long j = 0;
                ...
                int iLog10 = (int) (Math.log10(j / ((double) i2)) * 10.0d);
                this.voiceLevel = iLog10;
                RecorderListener recorderListener = this.listener;
                if (recorderListener != null) {
                    recorderListener.onRecord(bArr, iLog10);
                }
            }
        }
    }
