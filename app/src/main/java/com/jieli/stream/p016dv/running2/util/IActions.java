...
public interface IActions {
    ...
    public static final String ACTION_CONNECTION_TIMEOUT = "com.jieli.dv.running2_connection_timeout";
    ...
    public static final String ACTION_TF_STATUS = "com.jieli.dv.running2_tf_status";
