...
public class CommonUtil {
    ...
    private static DecimalFormat f2236df = new DecimalFormat("######0.00");
    ...
    public static String formatSecond(int i) {
        ...
        Integer numValueOf2 = Integer.valueOf((i / 60) - (numValueOf.intValue() * 60));
        return String.format("%1$,02d:%2$,02d:%3$,02d", numValueOf, numValueOf2, Integer.valueOf((i - (numValueOf2.intValue() * 60)) - ((numValueOf.intValue() * 60) * 60)));
    }

    public static final String formatDouble(double d) {
        return f2236df.format(d);
    }
    ...
    public static double getAngle(LatLng latLng, LatLng latLng2) {
        ...
        return (((Math.atan(slope) / 3.141592653589793d) * 180.0d) + ((double) ((latLng2.latitude - latLng.latitude) * slope < 0.0d ? 180.0f : 0.0f))) - 90.0d;
    }
}
