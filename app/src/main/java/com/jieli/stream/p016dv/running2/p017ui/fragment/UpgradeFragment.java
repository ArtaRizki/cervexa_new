...
public class UpgradeFragment extends BaseFragment {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        if (i == 4104) {
            Dbug.m1391w(this.TAG, "-resultCode- " + i2);
        }
    }
    ...
    private class UpgradeSDK extends Thread {
        ...
        /* JADX WARN: Removed duplicated region for block: B:27:0x00be A[PHI: r1
  0x00be: PHI (r1v26 int) = (r1v19 int), (r1v18 int) binds: [B:25:0x00bb, B:23:0x00b4] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private class UpgradeAPK extends Thread {
        ...
        public void run() throws Throwable {
            ...
            List<String> listDownLoadUpdateFile = FTPClientUtil.getInstance().downLoadUpdateFile(UpgradeFragment.this.upgradePath, UpgradeFragment.this.upgradeType, 2, handler);
            if (listDownLoadUpdateFile == null || listDownLoadUpdateFile.size() <= 1) {
                ...
                if (handler != null) {
                    handler.sendMessageDelayed(handler.obtainMessage(4098, listDownLoadUpdateFile), 200L);
                }
            }
        }
    }
    ...
    private class UploadFileThread extends Thread {
        ...
        public void run() throws Throwable {
            ...
            boolean zUploadFile = FTPClientUtil.getInstance().uploadFile(this.remoteFile, this.localFilePath, handler);
            Dbug.m1388e(UpgradeFragment.this.TAG, "-UploadFileThread- uploadFile ret = " + zUploadFile);
            if (!zUploadFile) {
                SystemClock.sleep(3000L);
                zUploadFile = FTPClientUtil.getInstance().uploadFile(this.remoteFile, this.localFilePath, handler);
            }
            if (zUploadFile) {
                UpgradeFragment upgradeFragment = UpgradeFragment.this;
                ...
                ClientManager.getClient().tryToResetDev(new SendResponse() { // from class: com.jieli.stream.dv.running2.ui.fragment.UpgradeFragment.UploadFileThread.1
                    ...
                    public void onResponse(Integer num) {
                        if (num.intValue() != 1) {
                            Dbug.m1388e(UpgradeFragment.this.TAG, "-UploadFileThread- send reset cmd failed!");
                            return;
                        }
                        UpgradeFragment.this.mApplication.switchWifi();
