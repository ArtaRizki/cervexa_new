package com.jieli.stream.p016dv.running2.p017ui;
...
import com.jieli.stream.p016dv.running2.util.HandlerUtil;
...
public class MainApplication extends Application {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        Dbug.m1391w(getClass().getSimpleName(), "onConfigurationChanged orientation : " + configuration.orientation);
