            ...
            if (view != null) {
                ...
                if (view == SelectWifiDialog.this.mRightBtn) {
                    ...
                    if (TextUtils.isEmpty(strTrim) || strTrim.length() >= 8) {
                        if (SelectWifiDialog.this.listener != null) {
                            SelectWifiDialog.this.listener.onSelectWifi(SelectWifiDialog.this.mSSID, strTrim);
                        }
                        SelectWifiDialog.this.dismiss();
                        return;
                    }
    ...
    private void initSpinner() {
        ...
        if (wifiScanResult != null) {
            ...
            if (arrayList.size() > 0) {
                ...
                wifiListAdapter.setDropDownViewResource(R.layout.simple_spinner_dropdown_item);
