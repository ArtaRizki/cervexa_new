...
public class DeviceAdvancedSettingFragment extends BaseFragment {
    ...
    private final OnNotifyListener onNotifyListener = new OnNotifyListener() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceAdvancedSettingFragment.8
        ...
        */
        public void onNotify(com.jieli.lib.p015dv.control.json.bean.NotifyInfo r15) {
            /*
    ...
    /* JADX INFO: renamed from: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceAdvancedSettingFragment$2 */
    class ViewOnClickListenerC16642 implements View.OnClickListener {
        ViewOnClickListenerC16642() {
        }
