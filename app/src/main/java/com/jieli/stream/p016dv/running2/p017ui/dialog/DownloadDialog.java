...
import com.jieli.lib.p015dv.control.player.OnDownloadListener;
...
public class DownloadDialog extends BaseDialogFragment implements View.OnClickListener {
    ...
    private final OnNotifyListener mOnNotifyListener = new OnNotifyListener() { // from class: com.jieli.stream.dv.running2.ui.dialog.DownloadDialog.2
        ...
        public void onNotify(NotifyInfo notifyInfo) {
            if (notifyInfo.getErrorType() != 0) {
                Dbug.m1388e(DownloadDialog.this.tag, Code.getCodeDescription(notifyInfo.getErrorType()));
                return;
            }
            ...
            Dbug.m1389i(DownloadDialog.this.tag, "create playback..................");
    ...
    private final OnDownloadListener onDownloadListener = new OnDownloadListener() { // from class: com.jieli.stream.dv.running2.ui.dialog.DownloadDialog.3
        @Override // com.jieli.lib.p015dv.control.player.OnDownloadListener
        public void onStart() {
            Dbug.m1391w(DownloadDialog.this.tag, "start download");
            ...
            DownloadDialog.this.mRecordVideo.prepare(new OnRecordStateListener() { // from class: com.jieli.stream.dv.running2.ui.dialog.DownloadDialog.3.1
                ...
                @Override // com.jieli.stream.p016dv.running2.data.OnRecordStateListener
                public void onStop() {
                    Dbug.m1389i(DownloadDialog.this.tag, "Record onStop");
                }

                @Override // com.jieli.stream.p016dv.running2.data.OnRecordStateListener
                public void onError(String str) {
                    Dbug.m1388e(DownloadDialog.this.tag, "Record error:" + str);
                    if (DownloadDialog.this.mRecordVideo != null) {
                        ...
                        if (!TextUtils.isEmpty(currentFilePath)) {
                            ...
                            if (file.exists() && !file.delete()) {
                                Dbug.m1391w(DownloadDialog.this.tag, "Delete failed:" + file.getAbsolutePath());
                            }
                        }
                    }
        ...
        public void onReceived(int i, byte[] bArr) {
            ...
            Dbug.m1388e(DownloadDialog.this.tag, "Write failed");
        }

        @Override // com.jieli.lib.p015dv.control.player.OnDownloadListener
        public void onProgress(float f) {
            Dbug.m1391w(DownloadDialog.this.tag, "Progress " + f);
            DownloadDialog.this.updateNumberPb((int) (f * 100.0f));
        }

        @Override // com.jieli.lib.p015dv.control.player.OnDownloadListener
        public void onStop() {
            Dbug.m1391w(DownloadDialog.this.tag, "onStop " + DownloadDialog.this.progress);
            DownloadDialog.this.mFrameCount = 0;
        ...
        public void onError(int i, String str) {
            Dbug.m1388e(DownloadDialog.this.tag, "Error: code " + i + ", msg=" + str);
            DownloadDialog.this.mFrameCount = 0;
            DownloadDialog.this.closeMovWrapper();
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if (arguments != null) {
            ...
            if (fileInfo == null || TextUtils.isEmpty(fileInfo.getPath())) {
                Dbug.m1388e(this.tag, "File info error");
                return;
            }
            ...
            Dbug.m1388e(this.tag, "path " + fileInfo.getPath() + ", offset " + fileInfo.getOffset());
            ...
            ClientManager.getClient().tryToStartPlayback(fileInfo.getPath(), fileInfo.getOffset(), new SendResponse() { // from class: com.jieli.stream.dv.running2.ui.dialog.DownloadDialog.1
                ...
                public void onResponse(Integer num) {
                    if (num.intValue() != 1) {
                        Dbug.m1388e(DownloadDialog.this.tag, "Send failed");
                    }
                }
            });
        }
    ...
    public void stopDownload() {
        ...
        Dbug.m1391w(this.tag, "stop download");
        closeMovWrapper();
        dismissDialog();
    }
