...
import com.jieli.lib.p015dv.control.projection.StreamingPush;
...
public class CameraPresenter implements ICamera, Camera.PreviewCallback {
    ...
    @Override // com.jieli.stream.p016dv.running2.camera.ICamera
    ...
    public void startPreview(SurfaceTexture surfaceTexture) {
        ...
        if (camera != null) {
            ...
            Dbug.m1389i(tag, "startPreview: w=" + i + ", h=" + i2);
    ...
    public void onPreviewFrame(byte[] bArr, Camera camera) {
        if (this.mCamera == null || camera == null) {
            Dbug.m1388e(tag, "onPreviewFrame: camera null");
            return;
        }
        ...
        if (parameters == null) {
            Dbug.m1388e(tag, "onPreviewFrame: parameters null");
            return;
        }
        ...
        Dbug.m1388e(tag, "compressToJpeg failed");
    }
}
