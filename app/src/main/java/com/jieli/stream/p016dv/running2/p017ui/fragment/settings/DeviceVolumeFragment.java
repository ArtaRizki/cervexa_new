...
public class DeviceVolumeFragment extends BaseFragment {
    ...
    private final OnNotifyListener onNotifyListener = new OnNotifyListener() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceVolumeFragment.5
        ...
        public void onNotify(NotifyInfo notifyInfo) {
            if (notifyInfo.getErrorType() != 0) {
                ...
                ToastUtil.showToastShort(DeviceVolumeFragment.this.getString(com.weioa.KmedHealthIndonesia.R.string.save_fail));
            } else {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(com.weioa.KmedHealthIndonesia.R.layout.fragment_device_setting_volume, viewGroup, false);
        this.seekBar = (SeekBar) viewInflate.findViewById(com.weioa.KmedHealthIndonesia.R.id.volume_seek_bar);
        this.volumeDownImageButton = (ImageButton) viewInflate.findViewById(com.weioa.KmedHealthIndonesia.R.id.volume_down_img_btn);
        this.volumePlusImageButton = (ImageButton) viewInflate.findViewById(com.weioa.KmedHealthIndonesia.R.id.volume_plus_img_btn);
        this.volumeTextView = (TextView) viewInflate.findViewById(com.weioa.KmedHealthIndonesia.R.id.device_volume_value_tv);
        this.seekBar.setProgress(PreferencesHelper.getSharedPreferences(getContext()).getInt(IConstant.KEY_VOLUME, 0));
        this.volumeTextView.setText(String.format(getResources().getString(com.weioa.KmedHealthIndonesia.R.string.device_volume_value), Integer.valueOf(this.seekBar.getProgress())));
        ...
        this.seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceVolumeFragment.4
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                DeviceVolumeFragment.this.volumeTextView.setText(String.format(DeviceVolumeFragment.this.getResources().getString(com.weioa.KmedHealthIndonesia.R.string.device_volume_value), Integer.valueOf(seekBar.getProgress())));
            }
        });
        return viewInflate;
    }
