...
public class DeviceNameFragment extends BaseFragment {
    ...
    private final OnNotifyListener onNotifyListener = new OnNotifyListener() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceNameFragment.7
        ...
        public void onNotify(NotifyInfo notifyInfo) {
            if (notifyInfo.getErrorType() != 0) {
                Dbug.m1388e(DeviceNameFragment.this.tag, Code.getCodeDescription(notifyInfo.getErrorType()));
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ClientManager.getClient().tryToRequestApInfo(new SendResponse() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceNameFragment.1
            ...
            public void onResponse(Integer num) {
                if (num.intValue() != 1) {
                    Dbug.m1388e(DeviceNameFragment.this.tag, "send failed");
                }
            }
        });
        try {
        ...
        this.nameEditText.addTextChangedListener(new TextWatcher() { // from class: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceNameFragment.2
            ...
            public void afterTextChanged(Editable editable) {
                ...
                if (!editable.toString().contains(" ") && !editable.toString().contains("\n")) {
                    ...
                    try {
                        length = DeviceNameFragment.this.nameEditText.getText().toString().getBytes("utf-8").length + DeviceNameFragment.this.prefixLen;
                    } catch (UnsupportedEncodingException e2) {
                        e2.printStackTrace();
                        length = 0;
                    }
                    if (length > 31) {
                        int i = 31 - DeviceNameFragment.this.prefixLen;
                ...
                String strReplaceAll = editable.toString().replaceAll(" ", "").replaceAll("\n", "");
                DeviceNameFragment.this.nameEditText.setText(strReplaceAll);
                DeviceNameFragment.this.nameEditText.setSelection(strReplaceAll.length());
            }
        });
    ...
    private class CustomNameFilter implements InputFilter {
        ...
        public CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
            ...
            if (spanned.length() != 0) {
                ...
                CharSequence charSequenceSub = DeviceNameFragment.this.sub(charSequence, i7 - curLength2);
                Dbug.m1389i(DeviceNameFragment.this.tag, "end sub=" + ((Object) charSequenceSub));
                return "";
            }
            ...
            CharSequence charSequenceSub2 = DeviceNameFragment.this.sub(charSequence, i8);
            Dbug.m1389i(DeviceNameFragment.this.tag, "sub=" + ((Object) charSequenceSub2));
            return charSequenceSub2;
        }
    }
    ...
    /* JADX INFO: renamed from: com.jieli.stream.dv.running2.ui.fragment.settings.DeviceNameFragment$4 */
    class C16764 implements SendResponse {
    ...
    public void changeName(boolean z) {
        ClientManager.getClient().tryToSetApAccount(WIFI_PREFIX + this.nameEditText.getText().toString().trim(), this.mCurrentPwd, z, new C16764(z));
    }
