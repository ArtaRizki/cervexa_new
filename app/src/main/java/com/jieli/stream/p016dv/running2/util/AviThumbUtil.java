...
public class AviThumbUtil {
    ...
    /* JADX WARN: Removed duplicated region for block: B:96:0x026f A[Catch: IOException -> 0x0273, TRY_ENTER, TRY_LEAVE, TryCatch #3 {IOException -> 0x0273, blocks: (B:83:0x024e, B:96:0x026f), top: B:108:0x003f }] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:99:0x0274 -> B:107:0x0285). Please report as a decompilation issue!!! */
    /*
    ...
    */
    public static void getRecordVideoThumb(java.lang.String r34, com.jieli.stream.p016dv.running2.interfaces.OnAviThumbListener r35) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jieli.stream.p016dv.running2.util.AviThumbUtil.getRecordVideoThumb(java.lang.String, com.jieli.stream.dv.running2.interfaces.OnAviThumbListener):void");
    }
    ...
    public static long getLong(byte[] bArr, boolean z) {
        ...
        if (z) {
            for (int length = bArr.length - 1; length >= 0; length--) {
                j = (j << 8) | ((long) (bArr[length] & UByte.MAX_VALUE));
            }
        } else {
            for (byte b : bArr) {
