...
public class HeartbeatTask extends Thread {
    ...
    public void run() {
        ...
        this.mTimeoutCount = 0;
        Dlog.m1386w(this.tag, "HeartbeatTask: start");
        while (true) {
            ...
            ClientManager.getClient().tryToKeepAlive(new SendResponse() { // from class: com.jieli.stream.dv.running2.task.HeartbeatTask.1
                ...
                public void onResponse(Integer num) {
                    if (num.intValue() != 1) {
                        Dbug.m1388e(HeartbeatTask.this.tag, "Send failed!!!");
                    }
                }
            });
            ...
            if (i > this.mTimeout) {
                ...
                Dlog.m1383e(this.tag, "HeartbeatTask: over time");
            }
        }
        Dlog.m1384i(this.tag, "HeartbeatTask ending..." + this.mTimeoutCount);
    }
}
