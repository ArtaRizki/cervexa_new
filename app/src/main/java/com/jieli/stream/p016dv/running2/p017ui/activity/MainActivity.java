...
import com.jieli.stream.p016dv.running2.p017ui.fragment.DeviceListFragment;
import com.jieli.stream.p016dv.running2.p017ui.fragment.SettingFragment;
import com.jieli.stream.p016dv.running2.p017ui.fragment.StaDeviceListFragment;
import com.jieli.stream.p016dv.running2.p017ui.fragment.VideoFragment;
import com.jieli.stream.p016dv.running2.p017ui.fragment.browse.BrowseFileFragment;
...
import com.jieli.stream.p016dv.running2.util.ThumbnailManager;
...
public class MainActivity extends BaseActivity implements OnWifiCallBack {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) { // from class: com.jieli.stream.dv.running2.ui.activity.MainActivity.1
        ...
        public void handleMessage(Message message) {
            ...
            Dbug.m1389i(MainActivity.this.tag, "reconnecting reConnectNum=" + MainActivity.this.reConnectNum);
    ...
    private final OnConnectStateListener deviceConnectStateListener = new OnConnectStateListener() { // from class: com.jieli.stream.dv.running2.ui.activity.MainActivity.3
        ...
        public void onStateChanged(Integer num) {
            Dbug.m1389i(MainActivity.this.tag, "--onStateChanged-- " + Constants.getConnectDescription(num.intValue()));
            int iIntValue = num.intValue();
            if (iIntValue != -1) {
                if (iIntValue == 0) {
                    Dbug.m1389i(MainActivity.this.tag, "Third, connect device success...");
                    MainActivity.this.mHandler.removeMessages(0);
                    ...
                    ClientManager.getClient().tryToAccessDevice(String.valueOf(MainActivity.this.mApplication.getAppVersion()), new SendResponse() { // from class: com.jieli.stream.dv.running2.ui.activity.MainActivity.3.1
                        ...
                        public void onResponse(Integer num2) {
                            if (num2.intValue() != 1) {
                                Dbug.m1388e(MainActivity.this.tag, "Send failed!!!");
                            }
                        }
                    });
                    return;
                ...
                if (iIntValue != 1) {
                    if (iIntValue == 3 || iIntValue == 4) {
                        Dbug.m1391w(MainActivity.this.tag, "error disconnected:WifiState=" + MainActivity.this.mWifiHelper.getWifiState());
                        MainActivity.this.mHandler.removeMessages(0);
    ...
    private IWifiDirectListener mIWifiDirectListener = new IWifiDirectListener() { // from class: com.jieli.stream.dv.running2.ui.activity.MainActivity.4
                ...
                if (wifiP2pDevice != null) {
                    MainActivity.this.mWifiP2pHelper.connectP2pDevice(wifiP2pDevice, new WifiP2pManager.ActionListener() { // from class: com.jieli.stream.dv.running2.ui.activity.MainActivity.4.1
                        ...
                        public void onSuccess() {
                            Dbug.m1389i(MainActivity.this.tag, "-onCallP2pPeersChanged- connectP2pDevice ok.");
                        }
        ...
        public void onCallP2pConnectionChanged(WifiP2pInfo wifiP2pInfo) {
            ...
            if (wifiP2pInfo != null) {
                Dbug.m1389i(MainActivity.this.tag, "-onCallP2pConnectionChanged- : " + wifiP2pInfo);
    ...
    public void connectDevice(String str) {
        ...
        Dbug.m1388e(this.tag, "connectDevice: unknown case");
    }
    ...
    public void onError(int i) {
        Dbug.m1388e(this.tag, "onError >>> errCode = " + i);
        switch (i) {
            ...
            case IConstant.ERROR_NETWORK_NOT_OPEN /* 61172 */:
                Dbug.m1388e(this.tag, "Wi-Fi is disable !!");
                break;
