...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        float f8 = fMax3 / 2.0f;
        TypedArray typedArrayObtainStyledAttributes = attributeSet == null ? null : getContext().obtainStyledAttributes(attributeSet, C1438R.styleable.SwitchButton);
        if (typedArrayObtainStyledAttributes != null) {
            Drawable drawable3 = typedArrayObtainStyledAttributes.getDrawable(C1438R.styleable.SwitchButton_kswThumbDrawable);
            ColorStateList colorStateList3 = typedArrayObtainStyledAttributes.getColorStateList(C1438R.styleable.SwitchButton_kswThumbColor);
            float dimension2 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbMargin, dimension);
            float dimension3 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbMarginLeft, dimension2);
            float dimension4 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbMarginRight, dimension2);
            float dimension5 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbMarginTop, dimension2);
            float dimension6 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbMarginBottom, dimension2);
            float dimension7 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbWidth, fMax3);
            float dimension8 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbHeight, fMax3);
            float dimension9 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswThumbRadius, Math.min(dimension7, dimension8) / 2.0f);
            float dimension10 = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswBackRadius, dimension9 + dimension);
            Drawable drawable4 = typedArrayObtainStyledAttributes.getDrawable(C1438R.styleable.SwitchButton_kswBackDrawable);
            ColorStateList colorStateList4 = typedArrayObtainStyledAttributes.getColorStateList(C1438R.styleable.SwitchButton_kswBackColor);
            float f9 = typedArrayObtainStyledAttributes.getFloat(C1438R.styleable.SwitchButton_kswBackMeasureRatio, 1.8f);
            f = dimension10;
            int integer = typedArrayObtainStyledAttributes.getInteger(C1438R.styleable.SwitchButton_kswAnimationDuration, 250);
            boolean z2 = typedArrayObtainStyledAttributes.getBoolean(C1438R.styleable.SwitchButton_kswFadeBack, true);
            int color = typedArrayObtainStyledAttributes.getColor(C1438R.styleable.SwitchButton_kswTintColor, Integer.MIN_VALUE);
            String string = typedArrayObtainStyledAttributes.getString(C1438R.styleable.SwitchButton_kswTextOn);
            String string2 = typedArrayObtainStyledAttributes.getString(C1438R.styleable.SwitchButton_kswTextOff);
            dimension = typedArrayObtainStyledAttributes.getDimension(C1438R.styleable.SwitchButton_kswTextMarginH, dimension);
