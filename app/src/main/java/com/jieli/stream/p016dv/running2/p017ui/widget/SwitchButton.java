...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        float dimension = f7 * 2.0f;
        float fMax3 = f7 * 30.0f;
        float f8 = fMax3 / 2.0f;
        TypedArray typedArrayObtainStyledAttributes = attributeSet == null ? null : getContext().obtainStyledAttributes(attributeSet, com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton);
        if (typedArrayObtainStyledAttributes != null) {
            Drawable drawable3 = typedArrayObtainStyledAttributes.getDrawable(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbDrawable);
            ColorStateList colorStateList3 = typedArrayObtainStyledAttributes.getColorStateList(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbColor);
            float dimension2 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbMargin, dimension);
            float dimension3 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbMarginLeft, dimension2);
            float dimension4 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbMarginRight, dimension2);
            float dimension5 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbMarginTop, dimension2);
            float dimension6 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbMarginBottom, dimension2);
            float dimension7 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbWidth, fMax3);
            float dimension8 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbHeight, fMax3);
            float dimension9 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswThumbRadius, Math.min(dimension7, dimension8) / 2.0f);
            float dimension10 = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswBackRadius, dimension9 + dimension);
            Drawable drawable4 = typedArrayObtainStyledAttributes.getDrawable(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswBackDrawable);
            ColorStateList colorStateList4 = typedArrayObtainStyledAttributes.getColorStateList(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswBackColor);
            float f9 = typedArrayObtainStyledAttributes.getFloat(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswBackMeasureRatio, 1.8f);
            f = dimension10;
            int integer = typedArrayObtainStyledAttributes.getInteger(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswAnimationDuration, 250);
            boolean z2 = typedArrayObtainStyledAttributes.getBoolean(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswFadeBack, true);
            int color = typedArrayObtainStyledAttributes.getColor(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswTintColor, Integer.MIN_VALUE);
            String string = typedArrayObtainStyledAttributes.getString(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswTextOn);
            String string2 = typedArrayObtainStyledAttributes.getString(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswTextOff);
            dimension = typedArrayObtainStyledAttributes.getDimension(com.weioa.KmedHealthIndonesia.R.styleable.SwitchButton_kswTextMarginH, dimension);
        ...
        if (this.mIsThumbUseDrawable) {
            fMax3 = Math.max(fMax3, this.mThumbDrawable.getMinimumWidth());
            fMax = Math.max(fMax, this.mThumbDrawable.getMinimumHeight());
        }
        this.mThumbSizeF.set(fMax3, fMax);
        ...
        this.mThumbMargin.set(f3, f4, f5, f6);
        if (this.mThumbMargin.width() >= 0.0f) {
            fMax2 = Math.max(fMax2, 1.0f);
        }
        this.mBackMeasureRatio = fMax2;
    ...
    private int measureWidth(int i) {
        ...
        int iCeil = ceil(this.mThumbSizeF.x * this.mBackMeasureRatio);
        ...
        int iMax = Math.max(iCeil, ceil(iCeil + this.mThumbMargin.left + this.mThumbMargin.right));
    ...
    private void setup() {
        ...
        float fMin = Math.min(0.0f, ((Math.max(this.mThumbSizeF.x * this.mBackMeasureRatio, this.mThumbSizeF.x + this.mTextWidth) - this.mThumbRectF.width()) - this.mTextWidth) / 2.0f);
        float fMin2 = Math.min(0.0f, (((this.mThumbRectF.height() + this.mThumbMargin.top) + this.mThumbMargin.bottom) - this.mTextHeight) / 2.0f);
        this.mBackRectF.set(f + fMin, (this.mThumbRectF.top - this.mThumbMargin.top) + fMin2, (((f + this.mThumbMargin.left) + Math.max(this.mThumbSizeF.x * this.mBackMeasureRatio, this.mThumbSizeF.x + this.mTextWidth)) + this.mThumbMargin.right) - fMin, (this.mThumbRectF.bottom + this.mThumbMargin.bottom) - fMin2);
        ...
        if (this.mOnLayout != null) {
            float fWidth = ((this.mBackRectF.left + (((this.mBackRectF.width() - this.mThumbRectF.width()) - this.mOnLayout.getWidth()) / 2.0f)) - this.mThumbMargin.left) + (this.mTextMarginH * (this.mThumbMargin.left > 0.0f ? 1 : -1));
            float fHeight = this.mBackRectF.top + ((this.mBackRectF.height() - this.mOnLayout.getHeight()) / 2.0f);
            this.mTextOnRectF.set(fWidth, fHeight, this.mOnLayout.getWidth() + fWidth, this.mOnLayout.getHeight() + fHeight);
        }
        if (this.mOffLayout != null) {
            float fWidth2 = (((this.mBackRectF.right - (((this.mBackRectF.width() - this.mThumbRectF.width()) - this.mOffLayout.getWidth()) / 2.0f)) + this.mThumbMargin.right) - this.mOffLayout.getWidth()) - (this.mTextMarginH * (this.mThumbMargin.right <= 0.0f ? -1 : 1));
            float fHeight2 = this.mBackRectF.top + ((this.mBackRectF.height() - this.mOffLayout.getHeight()) / 2.0f);
