...
import com.jieli.lib.p015dv.control.gps.OnGpsListener;
import com.jieli.lib.p015dv.control.json.bean.NotifyInfo;
import com.jieli.lib.p015dv.control.model.GpsInfo;
import com.jieli.lib.p015dv.control.model.MediaInfo;
import com.jieli.lib.p015dv.control.player.OnBufferingListener;
import com.jieli.lib.p015dv.control.player.OnPlaybackListener;
import com.jieli.lib.p015dv.control.player.OnProgressListener;
import com.jieli.lib.p015dv.control.player.PlaybackStream;
...
public class PlaybackDialogActivity extends BaseActivity implements View.OnClickListener, OnGpsListener {
    ...
    private final OnBufferingListener onBufferingListener = new OnBufferingListener() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.4
        @Override // com.jieli.lib.p015dv.control.player.OnBufferingListener
    ...
    private OnNotifyListener mOnNotifyListener = new OnNotifyListener() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.5
        ...
        public void onNotify(NotifyInfo notifyInfo) {
            if (notifyInfo.getErrorType() != 0) {
                Dbug.m1388e(PlaybackDialogActivity.this.tag, Code.getCodeDescription(notifyInfo.getErrorType()));
                return;
            }
            String topic = notifyInfo.getTopic();
            byte b = -1;
            int iHashCode = topic.hashCode();
            if (iHashCode != 218061259) {
                if (iHashCode == 1021829664 && topic.equals(Topic.PLAYBACK)) {
                    b = 0;
                }
            ...
            if (b != 0) {
                ...
                if (notifyInfo.getParams() == null) {
                    Dbug.m1388e(PlaybackDialogActivity.this.tag, "PLAYBACK_FAST_FORWARD: data params is null");
                    return;
                }
            ...
            Dbug.m1389i(PlaybackDialogActivity.this.tag, "playback data " + notifyInfo);
    ...
    private Runnable handlerRecord = new Runnable() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.8
        ...
        public void run() {
            Dbug.m1389i(PlaybackDialogActivity.this.tag, "handlerRecord isRecordPrepared ->" + PlaybackDialogActivity.this.isRecordPrepared);
    ...
    private final OnProgressListener onProgressListener = new OnProgressListener() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.9
        @Override // com.jieli.lib.p015dv.control.player.OnProgressListener
        public void onStart() {
            MediaInfo currentMediaInfo = PlaybackDialogActivity.this.mStreamPlayer.getCurrentMediaInfo();
            Dbug.m1391w(PlaybackDialogActivity.this.tag, "onStart: mediaInfo=" + currentMediaInfo);
        ...
        public void onFinish() {
            Dbug.m1391w(PlaybackDialogActivity.this.tag, "===onFinish");
            if (PlaybackDialogActivity.this.mapUtil != null) {
    ...
    private final OnPlaybackListener mPlayerListener = new OnPlaybackListener() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.10
        @Override // com.jieli.lib.p015dv.control.player.OnPlaybackListener
        ...
        public void onVideo(int i, int i2, byte[] bArr, long j, long j2) {
            ...
            Dbug.m1388e(PlaybackDialogActivity.this.tag, "Write video failed");
        }
        ...
        public void onAudio(int i, int i2, byte[] bArr, long j, long j2) {
            ...
            Dbug.m1388e(PlaybackDialogActivity.this.tag, "Write audio failed");
        }

        @Override // com.jieli.lib.p015dv.control.player.IPlayerListener
        public void onStateChanged(int i) {
            if (i == 1) {
                Dbug.m1389i(PlaybackDialogActivity.this.tag, "prepare-------");
            ...
            if (i == 4) {
                ...
                if (i != 5) {
                    ...
                    Dbug.m1389i(PlaybackDialogActivity.this.tag, "file end-------");
                    return;
                }
                Dbug.m1389i(PlaybackDialogActivity.this.tag, "finish-------");
    ...
    private IMediaController iMediaController = new IMediaController() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.11
        ...
        public void showOnce(View view) {
            Dbug.m1389i(PlaybackDialogActivity.this.tag, "show once");
        }
    };
        ...
        if (extras != null) {
            ClientManager.getClient().tryToStartPlayback(extras.getString(IConstant.VIDEO_PATH), extras.getInt(IConstant.VIDEO_OFFSET, 0), new SendResponse() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.2
                ...
                public void onResponse(Integer num) {
                    if (num.intValue() != 1) {
                        Dbug.m1388e(PlaybackDialogActivity.this.tag, "Send failed");
                    }
                }
            });
    ...
    private void enableDebugMode() {
        ...
        Dbug.m1388e(this.tag, "enableDebugMode isDebugOpen " + this.isDebugOpen);
        if (this.isDebugOpen) {
            if (this.mHudView != null) {
                Dbug.m1388e(this.tag, "11 ");
                if (this.mHudView.getVisibility() != 0) {
                    Dbug.m1388e(this.tag, "22 ");
    ...
    protected void onDestroy() {
        super.onDestroy();
        Dbug.m1388e(this.tag, "=======on destroy=======");
    ...
    public void startLocalRecording() {
        ...
        this.mRecordVideo.prepare(new OnRecordStateListener() { // from class: com.jieli.stream.dv.running2.ui.activity.PlaybackDialogActivity.6
            ...
            @Override // com.jieli.stream.p016dv.running2.data.OnRecordStateListener
            public void onStop() {
                Dbug.m1389i(PlaybackDialogActivity.this.tag, "Record onStop");
            ...
            public void onError(String str) {
                Dbug.m1388e(PlaybackDialogActivity.this.tag, "Record error:" + str);
    ...
    @Override // com.jieli.lib.p015dv.control.gps.OnGpsListener
