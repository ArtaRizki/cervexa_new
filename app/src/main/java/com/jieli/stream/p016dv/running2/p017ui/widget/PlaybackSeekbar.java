...
public class PlaybackSeekbar extends View {
    ...
    private void init() {
        ...
        paint.setColor(getResources().getColor(C1438R.color.half_transparent));
        ...
        paint3.setColor(getResources().getColor(C1438R.color.bg_playback_seek_thumb));
        ...
        paint5.setColor(getResources().getColor(C1438R.color.bg_playback_seek_bar));
        ...
        paint6.setColor(getResources().getColor(C1438R.color.bg_playback_seek_bar));
        ...
        paint7.setColor(getResources().getColor(C1438R.color.bg_playback_seek_bar));
        ...
        paint8.setColor(getResources().getColor(C1438R.color.text_white));
        ...
        this.leftTip = getResources().getString(C1438R.string.playback_seekbar_tip_left);
        this.rightTip = getResources().getString(C1438R.string.playback_seekbar_tip_right);
        ...
        paint9.setColor(getResources().getColor(C1438R.color.bg_playback_tip));
