...
public class PlaybackSeekbar extends View {
    ...
    public void setModeNotCallback(int i) {
        ...
        Dbug.m1389i(this.tag, modeToString(i));
        invalidate();
    }
    ...
    private void init() {
        ...
        Dbug.m1389i(this.tag, "density->" + this.density);
        ...
        paint.setColor(getResources().getColor(com.weioa.KmedHealthIndonesia.R.color.half_transparent));
        ...
        paint3.setColor(getResources().getColor(com.weioa.KmedHealthIndonesia.R.color.bg_playback_seek_thumb));
        ...
        paint5.setColor(getResources().getColor(com.weioa.KmedHealthIndonesia.R.color.bg_playback_seek_bar));
        ...
        paint6.setColor(getResources().getColor(com.weioa.KmedHealthIndonesia.R.color.bg_playback_seek_bar));
        ...
        paint7.setColor(getResources().getColor(com.weioa.KmedHealthIndonesia.R.color.bg_playback_seek_bar));
        ...
        paint8.setColor(getResources().getColor(com.weioa.KmedHealthIndonesia.R.color.text_white));
        ...
        this.leftTip = getResources().getString(com.weioa.KmedHealthIndonesia.R.string.playback_seekbar_tip_left);
        this.rightTip = getResources().getString(com.weioa.KmedHealthIndonesia.R.string.playback_seekbar_tip_right);
        String str = this.leftTip;
        this.tipText = str;
        float fMeasureText = this.textTipPaint.measureText(str);
        float fMeasureText2 = this.textTipPaint.measureText(this.rightTip);
        if (fMeasureText <= fMeasureText2) {
            fMeasureText = fMeasureText2;
        }
        this.tipWidth = fMeasureText;
        this.tipWidth = fMeasureText + 20.0f;
        ...
        paint9.setColor(getResources().getColor(com.weioa.KmedHealthIndonesia.R.color.bg_playback_tip));
        ...
        int iDp2px = AppUtils.dp2px(getContext(), 10);
        this.paddingRight = iDp2px;
        this.paddingLeft = iDp2px;
    }
    ...
    private void handleBrowseCoverTouchEvent(MotionEvent motionEvent) {
        ...
        int iRound = Math.round(((f2 - f) / (f2 - this.paddingLeft)) * this.browseMaxPostion);
        if (iRound < 0 || this.browseMaxPostion < 0) {
            return;
        }
        if (iRound != this.currentSelected || motionEvent.getAction() == 1) {
            int i2 = this.browseMaxPostion;
            if (iRound > i2) {
                iRound = i2;
            }
            this.currentSelected = iRound;
            OnStatechangeListener onStatechangeListener2 = this.mOnStatechangeListener;
            if (onStatechangeListener2 != null) {
                onStatechangeListener2.onBrowseCoverChange(iRound);
            } else {
                Dbug.m1387d(this.tag, "mOnStatechangeListener is null");
            }
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mHeight = iMeasureHeight;
        this.halfHeight = (int) (iMeasureHeight / 1.8f);
