...
public final class ITFWriter extends UPCEANWriter {
    ...
    public byte[] encode(String str) {
        ...
        int iAppendPattern = appendPattern(bArr, 0, new int[]{1, 1, 1, 1}, 1);
        for (int i = 0; i < length; i += 2) {
            ...
            iAppendPattern += appendPattern(bArr, iAppendPattern, iArr, 1);
        }
        appendPattern(bArr, iAppendPattern, new int[]{3, 1, 1}, 1);
        return bArr;
    }
}
