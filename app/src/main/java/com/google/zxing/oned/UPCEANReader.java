...
public abstract class UPCEANReader extends OneDReader {
    ...
    static int[] findStartGuardPattern(BitArray bitArray) throws NotFoundException {
        ...
        int i = 0;
        while (!zIsRange) {
            iArrFindGuardPattern = findGuardPattern(bitArray, i, false, START_END_PATTERN);
    ...
    public Result decodeRow(int i, BitArray bitArray, int[] iArr, Hashtable hashtable) throws NotFoundException, ChecksumException, FormatException {
        ...
        int iDecodeMiddle = decodeMiddle(bitArray, iArr, stringBuffer);
        if (resultPointCallback != null) {
        ...
        if ((BarcodeFormat.EAN_13.equals(barcodeFormat) || BarcodeFormat.UPC_A.equals(barcodeFormat)) && (strLookupCountryIdentifier = this.eanManSupport.lookupCountryIdentifier(string)) != null) {
