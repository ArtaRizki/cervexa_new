...
final class FieldParser {
    ...
    static String parseFieldsInGeneralPurpose(String str) throws NotFoundException {
        ...
        while (true) {
            ...
            if (i < objArr.length) {
                if (objArr[i][0].equals(strSubstring)) {
                    ...
                    if (i2 >= objArr3.length) {
                        ...
                        while (true) {
                            ...
                            if (i3 < objArr4.length) {
                                if (objArr4[i3][0].equals(strSubstring2)) {
                                ...
                                while (true) {
                                    ...
                                    if (objArr6[i4][0].equals(strSubstring3)) {
                        ...
                        if (objArr3[i2][0].equals(strSubstring2)) {
    ...
    private static String processFixedAI(int i, int i2, String str) throws NotFoundException {
        ...
        stringBuffer.append(parseFieldsInGeneralPurpose(strSubstring3));
