...
public final class EAN8Writer extends UPCEANWriter {
    ...
    public byte[] encode(String str) {
        ...
        while (i <= 3) {
            int i2 = i + 1;
            iAppendPattern += appendPattern(bArr, iAppendPattern, UPCEANReader.L_PATTERNS[Integer.parseInt(str.substring(i, i2))], 0);
            i = i2;
        }
        ...
        while (i3 <= 7) {
            int i4 = i3 + 1;
            iAppendPattern2 += appendPattern(bArr, iAppendPattern2, UPCEANReader.L_PATTERNS[Integer.parseInt(str.substring(i3, i4))], 1);
            i3 = i4;
        }
