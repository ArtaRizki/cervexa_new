...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{IjkMediaCodecInfo.RANK_SECURE, 379}, "FR");
            add(new int[]{380}, "BG");
            add(new int[]{383}, "SI");
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{NNTPReply.SERVICE_DISCONTINUED, NNTPReply.POSTING_NOT_ALLOWED}, "DE");
            ...
            add(new int[]{480}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{NNTPReply.AUTHENTICATION_REJECTED}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
            ...
            add(new int[]{529}, "CY");
            add(new int[]{531}, "MK");
            add(new int[]{FTPReply.FAILED_SECURITY_CHECK}, "MT");
            add(new int[]{539}, "IE");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{UVCCamera.DEFAULT_PREVIEW_WIDTH, 649}, "FI");
    ...
    String lookupCountryIdentifier(String str) {
        ...
        for (int i3 = 0; i3 < size && i2 >= (i = (iArr = (int[]) this.ranges.elementAt(i3))[0]); i3++) {
            if (iArr.length != 1) {
                i = iArr[1];
            }
            if (i2 <= i) {
                return (String) this.countryIdentifiers.elementAt(i3);
            }
        }
        return null;
    }
