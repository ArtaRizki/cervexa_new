...
public final class PDF417Reader implements Reader {
    ...
    private static BitMatrix extractPureBits(BitMatrix bitMatrix) throws NotFoundException {
        ...
        int iFindPatternStart = findPatternStart(topLeftOnBit[0], i, bitMatrix);
        int iFindPatternEnd = ((findPatternEnd(topLeftOnBit[0], i, bitMatrix) - iFindPatternStart) + 1) / iModuleSize;
        int i3 = ((i2 - i) + 1) / iModuleSize;
        if (iFindPatternEnd == 0 || i3 == 0) {
            throw NotFoundException.getNotFoundInstance();
        }
        int i4 = iModuleSize >> 1;
        int i5 = i + i4;
        int i6 = iFindPatternStart + i4;
        BitMatrix bitMatrix2 = new BitMatrix(iFindPatternEnd, i3);
        for (int i7 = 0; i7 < i3; i7++) {
            int i8 = (i7 * iModuleSize) + i5;
            for (int i9 = 0; i9 < iFindPatternEnd; i9++) {
                if (bitMatrix.get((i9 * iModuleSize) + i6, i8)) {
