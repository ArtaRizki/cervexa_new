...
final class AlignmentPatternFinder {
    ...
    private AlignmentPattern handlePossibleCenter(int[] iArr, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (((AlignmentPattern) this.possibleCenters.elementAt(i4)).aboutEquals(f, fCrossCheckVertical, fCenterFromEnd)) {
                return new AlignmentPattern(fCenterFromEnd, fCrossCheckVertical, f);
            }
        }
        AlignmentPattern alignmentPattern = new AlignmentPattern(fCenterFromEnd, fCrossCheckVertical, f);
