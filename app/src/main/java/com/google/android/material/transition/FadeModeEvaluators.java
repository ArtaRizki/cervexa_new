...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f2023IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f2023IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f2023IN;
        }
        if (i == 2) {
            return CROSS;
        }
