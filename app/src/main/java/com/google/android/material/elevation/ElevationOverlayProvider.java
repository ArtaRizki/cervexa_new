...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C1123R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C1123R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C1123R.attr.colorSurface, 0);
