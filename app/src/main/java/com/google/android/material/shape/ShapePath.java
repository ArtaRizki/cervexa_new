...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f2020x = f;
        pathLineOperation.f2021y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f2021y - this.startY, this.operation.f2020x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f2021y - this.startY) / (this.operation.f2020x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f2020x, this.f2021y);
