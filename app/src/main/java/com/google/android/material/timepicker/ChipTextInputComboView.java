...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.chip = (Chip) layoutInflaterFrom.inflate(C1123R.layout.material_time_chip, (ViewGroup) this, false);
        TextInputLayout textInputLayout = (TextInputLayout) layoutInflaterFrom.inflate(C1123R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C1123R.id.material_label);
    }
