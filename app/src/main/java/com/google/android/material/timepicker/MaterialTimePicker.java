...
public final class MaterialTimePicker extends DialogFragment {
    ...
    private static final Pair<Integer, Integer> CLOCK_BUTTON_DATA = new Pair<>(Integer.valueOf(C1123R.drawable.ic_clock_black_24dp), Integer.valueOf(C1123R.string.material_timepicker_clock_mode_description));
    private static final Pair<Integer, Integer> KEYBOARD_BUTTON_DATA = new Pair<>(Integer.valueOf(C1123R.drawable.ic_keyboard_black_24dp), Integer.valueOf(C1123R.string.material_timepicker_text_input_mode_description));
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        TypedValue typedValueResolve = MaterialAttributes.resolve(requireContext(), C1123R.attr.materialTimePickerTheme);
        Dialog dialog = new Dialog(requireContext(), typedValueResolve == null ? 0 : typedValueResolve.data);
        Context context = dialog.getContext();
        int iResolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1123R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, 0, C1123R.style.Widget_MaterialComponents_TimePicker);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C1123R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C1123R.id.material_timepicker_view);
        ...
        this.textInputView = (LinearLayout) viewGroup2.findViewById(C1123R.id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C1123R.id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C1123R.id.header_title);
        ...
        ((Button) viewGroup2.findViewById(C1123R.id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.2
        ...
        ((Button) viewGroup2.findViewById(C1123R.id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private static Pair<Integer, Integer> dataForMode(int i) {
        if (i == 0) {
