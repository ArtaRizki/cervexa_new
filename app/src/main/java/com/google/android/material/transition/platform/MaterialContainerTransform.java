...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        } else if (transitionValues.view.getTag(C1123R.id.mtrl_motion_snapshot_view) instanceof View) {
            View view2 = (View) transitionValues.view.getTag(C1123R.id.mtrl_motion_snapshot_view);
            transitionValues.view.setTag(C1123R.id.mtrl_motion_snapshot_view, null);
    ...
    private static ShapeAppearanceModel getShapeAppearance(View view, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view.getTag(C1123R.id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C1123R.id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(new int[]{C1123R.attr.transitionShapeAppearance});
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float f5 = (int) (fCalculateElevationDyMultiplier * f4);
            this.currentElevationDy = f5;
            this.shadowPaint.setShadowLayer(f4, (int) (fCalculateElevationDxMultiplier * f4), f5, SHADOW_COLOR);
