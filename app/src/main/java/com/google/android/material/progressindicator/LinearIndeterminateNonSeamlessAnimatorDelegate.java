...
final class LinearIndeterminateNonSeamlessAnimatorDelegate extends IndeterminateAnimatorDelegate<AnimatorSet> {
    ...
    private void maybeInitializeAnimators() {
        if (this.animatorSet == null) {
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, LINE_1_HEAD_FRACTION, 0.0f, 1.0f);
            objectAnimatorOfFloat.setDuration(750L);
            objectAnimatorOfFloat.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1123R.animator.linear_indeterminate_line1_head_interpolator));
            ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this, LINE_1_TAIL_FRACTION, 0.0f, 1.0f);
            objectAnimatorOfFloat2.setStartDelay(333L);
            objectAnimatorOfFloat2.setDuration(850L);
            objectAnimatorOfFloat2.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1123R.animator.linear_indeterminate_line1_tail_interpolator));
            ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(this, LINE_2_HEAD_FRACTION, 0.0f, 1.0f);
            objectAnimatorOfFloat3.setStartDelay(1000L);
            objectAnimatorOfFloat3.setDuration(567L);
            objectAnimatorOfFloat3.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1123R.animator.linear_indeterminate_line2_head_interpolator));
            ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(this, LINE_2_TAIL_FRACTION, 0.0f, 1.0f);
            objectAnimatorOfFloat4.setStartDelay(1267L);
            objectAnimatorOfFloat4.setDuration(533L);
            objectAnimatorOfFloat4.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1123R.animator.linear_indeterminate_line2_tail_interpolator));
