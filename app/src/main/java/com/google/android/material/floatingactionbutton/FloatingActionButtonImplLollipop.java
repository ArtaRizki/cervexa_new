...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C1123R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C1123R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C1123R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C1123R.color.design_fab_stroke_end_outer_color));
