...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f2027IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.platform.FadeModeEvaluators.1
    ...
    static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f2027IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f2027IN;
        }
        if (i == 2) {
            return CROSS;
        }
