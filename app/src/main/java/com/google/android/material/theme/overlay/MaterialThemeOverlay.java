...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {R.attr.theme, C1123R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C1123R.attr.materialThemeOverlay};
