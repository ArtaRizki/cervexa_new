...
class DaysOfWeekAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            textView = (TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C1123R.layout.mtrl_calendar_day_of_week, viewGroup, false);
        }
        ...
        textView.setContentDescription(String.format(viewGroup.getContext().getString(C1123R.string.mtrl_picker_day_of_week_column_header), this.calendar.getDisplayName(7, 2, Locale.getDefault())));
        return textView;
    }
