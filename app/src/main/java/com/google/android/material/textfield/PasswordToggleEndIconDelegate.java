...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C1123R.drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1123R.string.password_toggle_content_description));
