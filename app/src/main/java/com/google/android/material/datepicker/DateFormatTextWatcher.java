...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(final String str, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C1123R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher.1
            ...
            public void run() {
                ...
                textInputLayout2.setError(context.getString(C1123R.string.mtrl_picker_invalid_format) + "\n" + String.format(context.getString(C1123R.string.mtrl_picker_invalid_format_use), str) + "\n" + String.format(context.getString(C1123R.string.mtrl_picker_invalid_format_example), dateFormat2.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
