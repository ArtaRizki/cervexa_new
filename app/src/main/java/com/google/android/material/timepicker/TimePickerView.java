...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C1123R.id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C1123R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C1123R.id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C1123R.id.material_clock_period_toggle);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView.2
            ...
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i2, boolean z) {
                int i3 = i2 == C1123R.id.material_clock_period_pm_button ? 1 : 0;
        ...
        this.minuteView = (Chip) findViewById(C1123R.id.material_minute_tv);
        this.hourView = (Chip) findViewById(C1123R.id.material_hour_tv);
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C1123R.id.selection_type, 12);
        this.hourView.setTag(C1123R.id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C1123R.id.material_clock_period_pm_button : C1123R.id.material_clock_period_am_button);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C1123R.id.material_clock_display, ViewCompat.getLayoutDirection(this) == 0 ? 2 : 1);
