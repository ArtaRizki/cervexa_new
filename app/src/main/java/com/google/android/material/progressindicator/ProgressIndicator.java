...
public final class ProgressIndicator extends ProgressBar {
    ...
    protected static final int DEF_STYLE_RES = C1123R.style.Widget_MaterialComponents_ProgressIndicator_Linear_Determinate;
    ...
    public ProgressIndicator(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1123R.attr.progressIndicatorStyle);
    }
    ...
    private void loadExtraAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.showDelay = typedArrayObtainStyledAttributes.getInt(C1123R.styleable.ProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(typedArrayObtainStyledAttributes.getInt(C1123R.styleable.ProgressIndicator_minHideDelay, -1), 1000);
