...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    private static final int DEF_STYLE_RES = C1123R.style.Widget_MaterialComponents_ShapeableImageView;
    ...
    public ShapeableImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.strokeColor = MaterialResources.getColorStateList(context2, context2.obtainStyledAttributes(attributeSet, C1123R.styleable.ShapeableImageView, i, DEF_STYLE_RES), C1123R.styleable.ShapeableImageView_strokeColor);
        this.strokeWidth = r0.getDimensionPixelSize(C1123R.styleable.ShapeableImageView_strokeWidth, 0);
