...
class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1123R.styleable.ClockHandView, i, 0);
        this.circleRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1123R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1123R.styleable.ClockHandView_selectorSize, 0);
        this.selectorStrokeWidth = getResources().getDimensionPixelSize(C1123R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = r5.getDimensionPixelSize(C1123R.dimen.material_clock_hand_center_dot_radius);
        int color = MaterialColors.getColor(this, C1123R.attr.colorPrimary);
