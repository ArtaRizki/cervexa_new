...
public final class IndeterminateDrawable extends DrawableWithAnimatedVisibilityChange {
    ...
    public IndeterminateDrawable(Context context, ProgressIndicatorSpec progressIndicatorSpec) {
        ...
        Pair<DrawingDelegate, IndeterminateAnimatorDelegate<AnimatorSet>> pairInitializeDelegates = initializeDelegates(progressIndicatorSpec.indicatorType, progressIndicatorSpec.linearSeamless);
        this.drawingDelegate = (DrawingDelegate) pairInitializeDelegates.first;
        setAnimatorDelegate((IndeterminateAnimatorDelegate) pairInitializeDelegates.second);
    }
