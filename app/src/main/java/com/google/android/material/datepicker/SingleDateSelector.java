...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, final OnSelectionChangedListener<Long> onSelectionChangedListener) {
        View viewInflate = layoutInflater.inflate(C1123R.layout.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C1123R.id.mtrl_picker_text_input_date);
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C1123R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C1123R.string.mtrl_picker_date_header_unselected);
        }
        return resources.getString(C1123R.string.mtrl_picker_date_header_selected, DateStrings.getYearMonthDay(l.longValue()));
    }

    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultTitleResId() {
        return C1123R.string.mtrl_picker_date_header_title;
    }
