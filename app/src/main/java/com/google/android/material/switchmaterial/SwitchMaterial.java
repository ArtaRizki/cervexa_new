...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C1123R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1123R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1123R.styleable.SwitchMaterial, i, DEF_STYLE_RES, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C1123R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C1123R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C1123R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C1123R.dimen.mtrl_switch_thumb_elevation);
