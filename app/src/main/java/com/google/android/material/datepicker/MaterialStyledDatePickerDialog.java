...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    private static final int DEF_STYLE_RES = C1123R.style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    ...
    public MaterialStyledDatePickerDialog(Context context, int i, DatePickerDialog.OnDateSetListener onDateSetListener, int i2, int i3, int i4) {
        ...
        int iResolveOrThrow = MaterialAttributes.resolveOrThrow(getContext(), C1123R.attr.colorSurface, getClass().getCanonicalName());
