...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1123R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C1123R.attr.snackbarButtonStyle, C1123R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(viewGroupFindSuitableParent.getContext()).inflate(hasSnackbarContentStyleAttrs(viewGroupFindSuitableParent.getContext()) ? C1123R.layout.mtrl_layout_snackbar_include : C1123R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
