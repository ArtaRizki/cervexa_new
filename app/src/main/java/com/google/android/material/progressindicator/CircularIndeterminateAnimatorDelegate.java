...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<AnimatorSet> {
    ...
    protected void registerDrawable(IndeterminateDrawable indeterminateDrawable) {
        ...
        ObjectAnimator objectAnimatorOfObject = ObjectAnimator.ofObject(this, (Property<CircularIndeterminateAnimatorDelegate, V>) DISPLAYED_INDICATOR_COLOR, (TypeEvaluator) new ArgbEvaluatorCompat(), (Object[]) new Integer[]{Integer.valueOf(indeterminateDrawable.combinedIndicatorColorArray[this.indicatorColorIndex]), Integer.valueOf(indeterminateDrawable.combinedIndicatorColorArray[getNextIndicatorColorIndex()])});
        this.colorFadingAnimator = objectAnimatorOfObject;
        objectAnimatorOfObject.setDuration(333L);
    ...
    private void maybeInitializeAnimators() {
        if (this.animatorSet == null) {
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, INDICATOR_IN_CYCLE_OFFSET, 0.0f, INDICATOR_OFFSET_PER_COLOR_DEGREES);
            objectAnimatorOfFloat.setDuration(1333L);
            objectAnimatorOfFloat.setInterpolator(null);
            ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this, INDICATOR_HEAD_CHANGE_FRACTION, 0.0f, 1.0f);
            objectAnimatorOfFloat2.setDuration(666L);
            objectAnimatorOfFloat2.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            objectAnimatorOfFloat2.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate.1
            ...
            ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(this, INDICATOR_TAIL_CHANGE_FRACTION, 0.0f, 1.0f);
            this.indicatorCollapsingAnimator = objectAnimatorOfFloat3;
            objectAnimatorOfFloat3.setDuration(666L);
            this.indicatorCollapsingAnimator.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            AnimatorSet animatorSet = new AnimatorSet();
            this.animatorSet = animatorSet;
            animatorSet.playSequentially(objectAnimatorOfFloat2, this.indicatorCollapsingAnimator);
            this.animatorSet.playTogether(objectAnimatorOfFloat);
