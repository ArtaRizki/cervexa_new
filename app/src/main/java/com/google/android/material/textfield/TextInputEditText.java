...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1123R.attr.editTextStyle);
    }

    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, 0), attributeSet, i);
        this.parentRect = new Rect();
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1123R.styleable.TextInputEditText, i, C1123R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(typedArrayObtainStyledAttributes.getBoolean(C1123R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
    ...
    public boolean requestRectangleOnScreen(Rect rect) {
        ...
        if (textInputLayout != null && this.textInputLayoutFocusedRectEnabled) {
            this.parentRect.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(C1123R.dimen.mtrl_edittext_rectangle_top_offset), textInputLayout.getWidth(), textInputLayout.getHeight());
    ...
    private String getAccessibilityNodeInfoText(TextInputLayout textInputLayout) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            setLabelFor(C1123R.id.textinput_helper_text);
        }
        String str = "";
