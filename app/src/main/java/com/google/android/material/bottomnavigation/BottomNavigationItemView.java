...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1123R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C1123R.drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C1123R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1123R.id.icon);
        this.labelGroup = (ViewGroup) findViewById(C1123R.id.labelGroup);
        this.smallLabel = (TextView) findViewById(C1123R.id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1123R.id.largeLabel);
        this.labelGroup.setTag(C1123R.id.mtrl_view_tag_bottom_padding, Integer.valueOf(this.labelGroup.getPaddingBottom()));
        ...
        if (i != -1) {
            if (i == 0) {
                if (z) {
                    ...
                    updateViewPaddingBottom(viewGroup, ((Integer) viewGroup.getTag(C1123R.id.mtrl_view_tag_bottom_padding)).intValue());
                ...
                updateViewPaddingBottom(viewGroup2, ((Integer) viewGroup2.getTag(C1123R.id.mtrl_view_tag_bottom_padding)).intValue());
                if (z) {
            ...
            if (z) {
                ...
                updateViewPaddingBottom(viewGroup3, ((Integer) viewGroup3.getTag(C1123R.id.mtrl_view_tag_bottom_padding)).intValue());
                this.largeLabel.setVisibility(0);
            } else {
                setViewLayoutParams(this.icon, this.defaultMargin, 17);
                updateViewPaddingBottom(this.labelGroup, 0);
            ...
            updateViewPaddingBottom(viewGroup4, ((Integer) viewGroup4.getTag(C1123R.id.mtrl_view_tag_bottom_padding)).intValue());
            if (z) {
                setViewLayoutParams(this.icon, (int) (this.defaultMargin + this.shiftAmount), 49);
                setViewScaleValues(this.largeLabel, 1.0f, 1.0f, 0);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfoCompatWrap.setRoleDescription(getResources().getString(C1123R.string.item_view_role_description));
    }
