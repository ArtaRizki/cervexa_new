...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int iResolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1123R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C1123R.attr.materialCalendarStyle, C1123R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(this.fullscreen ? C1123R.layout.mtrl_picker_fullscreen : C1123R.layout.mtrl_picker_dialog, viewGroup);
        Context context = viewInflate.getContext();
        if (this.fullscreen) {
            viewInflate.findViewById(C1123R.id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View viewFindViewById = viewInflate.findViewById(C1123R.id.mtrl_calendar_main_pane);
            View viewFindViewById2 = viewInflate.findViewById(C1123R.id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) viewInflate.findViewById(C1123R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) viewInflate.findViewById(C1123R.id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) viewInflate.findViewById(C1123R.id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) viewInflate.findViewById(C1123R.id.confirm_button);
        ...
        Button button = (Button) viewInflate.findViewById(C1123R.id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1123R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C1123R.string.mtrl_picker_announce_current_selection), headerText));
    ...
    public void startPickerFragment() {
        ...
        fragmentTransactionBeginTransaction.replace(C1123R.id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            string = checkableImageButton.getContext().getString(C1123R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            string = checkableImageButton.getContext().getString(C1123R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, AppCompatResources.getDrawable(context, C1123R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C1123R.drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    static boolean isFullscreen(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1123R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{R.attr.windowFullscreen});
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        return resources.getDimensionPixelSize(C1123R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C1123R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C1123R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelSize(C1123R.dimen.mtrl_calendar_days_of_week_height) + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C1123R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C1123R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C1123R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1123R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C1123R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1123R.dimen.mtrl_calendar_month_horizontal_padding));
    }
