...
public class JoystickView extends View implements Runnable {
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        double dMin = Math.min(i, i2) / 2;
        this.buttonRadius = (int) (0.25d * dMin);
        this.joystickRadius = (int) (dMin * 0.75d);
        if (this.m_bLeft) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        double dSqrt = Math.sqrt(((((double) i) - d) * (((double) i) - d)) + ((((double) y) - d2) * (((double) y) - d2)));
        int i2 = this.joystickRadius;
        if (dSqrt > i2) {
            double d3 = this.xPosition;
            double d4 = this.centerX;
            this.xPosition = (int) ((((d3 - d4) * ((double) i2)) / dSqrt) + d4);
            double d5 = this.yPosition;
            double d6 = this.centerY;
            this.yPosition = (int) ((((d5 - d6) * ((double) i2)) / dSqrt) + d6);
        }
        invalidate();
    ...
    public int getAngle() {
        ...
        if (d > d2) {
            ...
            if (d3 < d4) {
                int iAtan = (int) ((Math.atan((((double) i2) - d4) / (((double) i) - d2)) * 57.2957795d) + 90.0d);
                this.lastAngle = iAtan;
                return iAtan;
            }
            if (i2 > d4) {
                int iAtan2 = ((int) (Math.atan((((double) i2) - d4) / (((double) i) - d2)) * 57.2957795d)) + 90;
        ...
        double d6 = this.centerY;
        if (d5 < d6) {
            int iAtan3 = (int) ((Math.atan((((double) i3) - d6) / (((double) i) - d2)) * 57.2957795d) - 90.0d);
            this.lastAngle = iAtan3;
            return iAtan3;
        }
        if (i3 > d6) {
            int iAtan4 = ((int) (Math.atan((((double) i3) - d6) / (((double) i) - d2)) * 57.2957795d)) - 90;
    ...
    public int getPower() {
        ...
        int i = this.xPosition;
        double d = this.centerX;
        double d2 = (((double) i) - d) * (((double) i) - d);
        int i2 = this.yPosition;
        double d3 = this.centerY;
        return (int) ((Math.sqrt(d2 + ((((double) i2) - d3) * (((double) i2) - d3))) * 100.0d) / ((double) this.joystickRadius));
    }

    private int getLeftPower() {
        return Math.round((float) (((double) (Math.abs((this.yPosition - this.buttonRadius) - (this.joystickRadius * 2)) * 100)) / ((double) (this.joystickRadius * 2))));
    }
