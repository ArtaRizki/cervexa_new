...
public abstract class CustomRecycleViewAdapter<T> extends RecyclerView.Adapter<CustomRecycleViewAdapter.ViewHolder<T>> {
    ...
    public ViewHolder<T> onCreateViewHolder(ViewGroup viewGroup, int i) {
        View viewOnCreateItemView = onCreateItemView(getLayoutInflater(viewGroup.getContext()), viewGroup, i);
        viewOnCreateItemView.setOnClickListener(this.mOnClickListener);
        viewOnCreateItemView.setOnLongClickListener(this.mOnLongClickListener);
        return onCreateViewHolder(viewOnCreateItemView);
    }
