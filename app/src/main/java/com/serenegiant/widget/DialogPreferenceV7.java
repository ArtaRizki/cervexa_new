...
public class DialogPreferenceV7 extends Preference implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public DialogPreferenceV7(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        String string = typedArrayObtainStyledAttributes.getString(R.styleable.DialogPreference_dialogTitle);
        this.mDialogTitle = string;
        if (string == null) {
            this.mDialogTitle = getTitle();
        }
        this.mDialogMessage = typedArrayObtainStyledAttributes.getString(R.styleable.DialogPreference_dialogMessage);
        this.mDialogIcon = typedArrayObtainStyledAttributes.getDrawable(R.styleable.DialogPreference_dialogIcon);
        this.mPositiveButtonText = typedArrayObtainStyledAttributes.getString(R.styleable.DialogPreference_positiveButtonText);
        this.mNegativeButtonText = typedArrayObtainStyledAttributes.getString(R.styleable.DialogPreference_negativeButtonText);
        this.mDialogLayoutResId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.DialogPreference_dialogLayout, this.mDialogLayoutResId);
