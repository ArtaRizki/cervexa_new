...
class EGLBase14 extends EGLBase {
    ...
    public final EGLSurface createWindowSurface(Object obj) {
        try {
            EGLSurface eGLSurfaceEglCreateWindowSurface = EGL14.eglCreateWindowSurface(this.mEglDisplay, this.mEglConfig.eglConfig, obj, new int[]{12344}, 0);
    ...
    public final EGLSurface createOffscreenSurface(int i, int i2) {
        ...
        try {
            eGLSurfaceEglCreatePbufferSurface = EGL14.eglCreatePbufferSurface(this.mEglDisplay, this.mEglConfig.eglConfig, iArr, 0);
