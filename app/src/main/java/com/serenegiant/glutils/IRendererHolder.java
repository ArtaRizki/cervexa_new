...
public interface IRendererHolder extends IRendererCommon {
    ...
    void captureStill(String str) throws IllegalStateException, FileNotFoundException;

    void captureStill(String str, int i) throws IllegalStateException, FileNotFoundException;

    @Deprecated
    void captureStillAsync(String str) throws IllegalStateException, FileNotFoundException;

    @Deprecated
    void captureStillAsync(String str, int i) throws IllegalStateException, FileNotFoundException;
