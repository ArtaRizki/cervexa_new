...
class EGLBase10 extends EGLBase {
    ...
    public EglSurface createFromSurface(Object obj) {
        EglSurface eglSurface = new EglSurface(EGLBase10.this, obj);
    ...
    public EglSurface createOffscreen(int i, int i2) {
        EglSurface eglSurface = new EglSurface(EGLBase10.this, i, i2);
        eglSurface.makeCurrent();
        return eglSurface;
    }
    ...
    private final void init(int i, Context context, boolean z, int i2, boolean z2) {
        ...
        if (i >= 3 && (config = getConfig(3, z, i2, z2)) != null) {
            EGLContext eGLContextCreateContext = createContext(context, config, 3);
            if (this.mEgl.eglGetError() == 12288) {
                this.mEglConfig = new Config(config);
                this.mContext = new Context(eGLContextCreateContext);
                this.mGlVersion = 3;
            }
        }
        if (i >= 2 && ((context2 = this.mContext) == null || context2.eglContext == EGL10.EGL_NO_CONTEXT)) {
            ...
            try {
                EGLContext eGLContextCreateContext2 = createContext(context, config2, 2);
                checkEglError("eglCreateContext");
                this.mEglConfig = new Config(config2);
                this.mContext = new Context(eGLContextCreateContext2);
                this.mGlVersion = 2;
                ...
                if (z2) {
                    ...
                    EGLContext eGLContextCreateContext3 = createContext(context, config3, 2);
                    checkEglError("eglCreateContext");
                    this.mEglConfig = new Config(config3);
                    this.mContext = new Context(eGLContextCreateContext3);
                    this.mGlVersion = 2;
                }
            }
        }
        ...
        if (context3 == null || context3.eglContext == EGL10.EGL_NO_CONTEXT) {
            ...
            EGLContext eGLContextCreateContext4 = createContext(context, config4, 1);
            checkEglError("eglCreateContext");
            this.mEglConfig = new Config(config4);
            this.mContext = new Context(eGLContextCreateContext4);
            this.mGlVersion = 1;
        }
        int[] iArr = new int[1];
    ...
    public final EGLSurface createWindowSurface(Object obj) {
        try {
            EGLSurface eGLSurfaceEglCreateWindowSurface = this.mEgl.eglCreateWindowSurface(this.mEglDisplay, this.mEglConfig.eglConfig, obj, new int[]{12344});
            if (eGLSurfaceEglCreateWindowSurface != null && eGLSurfaceEglCreateWindowSurface != EGL10.EGL_NO_SURFACE) {
                makeCurrent(eGLSurfaceEglCreateWindowSurface);
            ...
            throw new RuntimeException("createWindowSurface failed error=" + iEglGetError);
        } catch (Exception e) {
    ...
    public final EGLSurface createOffscreenSurface(int i, int i2) {
        ...
        try {
            eGLSurfaceEglCreatePbufferSurface = this.mEgl.eglCreatePbufferSurface(this.mEglDisplay, this.mEglConfig.eglConfig, iArr);
    ...
    private final EGLConfig getConfig(int i, boolean z, int i2, boolean z2) {
        ...
        EGLConfig eGLConfigInternalGetConfig = internalGetConfig(iArr);
        if (eGLConfigInternalGetConfig == null && i == 2 && z2) {
            while (true) {
                if (i3 >= 16) {
                    break;
                }
            ...
            eGLConfigInternalGetConfig = internalGetConfig(iArr);
        }
        if (eGLConfigInternalGetConfig != null) {
            return eGLConfigInternalGetConfig;
        }
