    ...
    public void destroy() {
        ...
        if (setKeySet != null) {
            try {
                ...
                while (it.hasNext()) {
                    UsbControlBlock usbControlBlockRemove = this.mCtrlBlocks.remove(it.next());
                    if (usbControlBlockRemove != null) {
                        usbControlBlockRemove.close();
                    }
                }
            } catch (Exception e) {
                Log.e(TAG, "destroy:", e);
    ...
    */
    public synchronized boolean isRegistered() {
        /*
            r1 = this;
            monitor-enter(r1)
            boolean r0 = r1.destroyed     // Catch: java.lang.Throwable -> Le
            if (r0 != 0) goto Lb
            android.app.PendingIntent r0 = r1.mPermissionIntent     // Catch: java.lang.Throwable -> Le
            if (r0 == 0) goto Lb
            r0 = 1
            goto Lc
        Lb:
                ...
                for (UsbDevice usbDevice : deviceList.values()) {
                    for (DeviceFilter deviceFilter : list) {
                        if ((deviceFilter != null && deviceFilter.matches(usbDevice)) || (deviceFilter != null && deviceFilter.mSubclass == usbDevice.getDeviceSubclass())) {
                            ...
                            String strValueOf2 = String.valueOf(usbDevice.getDeviceSubclass());
                            if (printWriter != null) {
                                try {
                                    ...
                                    sb.append(str2);
                                    sb.append(":");
                                    sb.append("class=" + strValueOf + ", subclass=" + strValueOf2);
    ...
    private static String getString(UsbDeviceConnection usbDeviceConnection, int i, int i2, byte[] bArr) {
        ...
        for (int i3 = 1; i3 <= i2; i3++) {
            int iControlTransfer = usbDeviceConnection.controlTransfer(128, 6, i | 768, bArr[i3], bArr2, 256, 0);
        ...
        if (usbDevice != null) {
            ...
            if (usbManager != null && usbManager.hasPermission(usbDevice)) {
                ...
                if (TextUtils.isEmpty(usbDeviceInfo.serial)) {
                    usbDeviceInfo.serial = usbDeviceConnectionOpenDevice.getSerial();
                }
                byte[] bArr = new byte[256];
                try {
                    int iControlTransfer = usbDeviceConnectionOpenDevice.controlTransfer(128, 6, 768, 0, bArr, 256, 0);
                    int i = iControlTransfer > 0 ? (iControlTransfer - 2) / 2 : 0;
                    if (i > 0) {
                        if (TextUtils.isEmpty(usbDeviceInfo.manufacturer)) {
                            usbDeviceInfo.manufacturer = getString(usbDeviceConnectionOpenDevice, rawDescriptors[14], i, bArr);
                        }
                        if (TextUtils.isEmpty(usbDeviceInfo.product)) {
                            usbDeviceInfo.product = getString(usbDeviceConnectionOpenDevice, rawDescriptors[15], i, bArr);
                        }
                        if (TextUtils.isEmpty(usbDeviceInfo.serial)) {
                            usbDeviceInfo.serial = getString(usbDeviceConnectionOpenDevice, rawDescriptors[16], i, bArr);
                        }
                    }
                } finally {
    ...
    public static final class UsbControlBlock implements Cloneable {
        ...
        private UsbControlBlock(USBMonitor uSBMonitor, UsbDevice usbDevice) {
            ...
            String[] strArrSplit = TextUtils.isEmpty(deviceName) ? null : deviceName.split("/");
            if (strArrSplit != null) {
        ...
        private UsbControlBlock(UsbControlBlock usbControlBlock) throws IllegalStateException {
            ...
            if (device != null) {
                UsbDeviceConnection usbDeviceConnectionOpenDevice = uSBMonitor.mUsbManager.openDevice(device);
        ...
        public UsbControlBlock m2348clone() throws CloneNotSupportedException {
            try {
        ...
        public synchronized void close() {
            if (this.mConnection != null) {
                ...
                for (int i = 0; i < size; i++) {
                    SparseArray<UsbInterface> sparseArrayValueAt = this.mInterfaces.valueAt(i);
                    if (sparseArrayValueAt != null) {
                        int size2 = sparseArrayValueAt.size();
                        for (int i2 = 0; i2 < size2; i2++) {
                            this.mConnection.releaseInterface(sparseArrayValueAt.valueAt(i2));
                        }
