...
public class MediaVideoEncoder extends MediaEncoder implements IVideoEncoder {
    ...
    public MediaVideoEncoder(MediaMuxerWrapper mediaMuxerWrapper, int i, int i2, MediaEncoder.MediaEncoderListener mediaEncoderListener) {
    ...
    protected void prepare() throws IOException {
        ...
        MediaCodecInfo mediaCodecInfoSelectVideoCodec = selectVideoCodec("video/avc");
        ...
        mediaFormatCreateVideoFormat.setInteger("color-format", MediaCodecHelper.OMX_COLOR_FormatAndroidOpaque);
