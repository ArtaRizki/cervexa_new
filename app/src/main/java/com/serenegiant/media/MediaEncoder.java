    ...
    private final Runnable mEncodeTask = new Runnable() { // from class: com.serenegiant.media.MediaEncoder.1
        ...
        */
        public void run() {
            /*
                r6 = this;
                com.serenegiant.media.MediaEncoder r0 = com.serenegiant.media.MediaEncoder.this
                java.lang.Object r0 = r0.mSync
                monitor-enter(r0)
                com.serenegiant.media.MediaEncoder r1 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L87
                r2 = 0
                r1.mRequestStop = r2     // Catch: java.lang.Throwable -> L87
                com.serenegiant.media.MediaEncoder r1 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L87
                com.serenegiant.media.MediaEncoder.access$002(r1, r2)     // Catch: java.lang.Throwable -> L87
                com.serenegiant.media.MediaEncoder r1 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L87
                java.lang.Object r1 = r1.mSync     // Catch: java.lang.Throwable -> L87
                r1.notify()     // Catch: java.lang.Throwable -> L87
                com.serenegiant.media.MediaEncoder r1 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.InterruptedException -> L22 java.lang.Throwable -> L87
                java.lang.Object r1 = r1.mSync     // Catch: java.lang.InterruptedException -> L22 java.lang.Throwable -> L87
                r1.wait()     // Catch: java.lang.InterruptedException -> L22 java.lang.Throwable -> L87
                com.serenegiant.media.MediaEncoder r1 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.InterruptedException -> L22 java.lang.Throwable -> L87
                r1.callOnStart()     // Catch: java.lang.InterruptedException -> L22 java.lang.Throwable -> L87
            L22:
            ...
            L23:
                ...
                monitor-enter(r1)
                com.serenegiant.media.MediaEncoder r0 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L84
                boolean r0 = r0.mRequestStop     // Catch: java.lang.Throwable -> L84
                com.serenegiant.media.MediaEncoder r3 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L84
                int r3 = com.serenegiant.media.MediaEncoder.access$000(r3)     // Catch: java.lang.Throwable -> L84
                r4 = 1
                if (r3 <= 0) goto L37
                r3 = 1
                goto L38
            ...
            L38:
                if (r3 == 0) goto L3f
                com.serenegiant.media.MediaEncoder r5 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L84
                com.serenegiant.media.MediaEncoder.access$010(r5)     // Catch: java.lang.Throwable -> L84
            L3f:
                if (r3 != 0) goto L4e
                if (r0 != 0) goto L4e
                com.serenegiant.media.MediaEncoder r0 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.InterruptedException -> L4c java.lang.Throwable -> L84
                java.lang.Object r0 = r0.mSync     // Catch: java.lang.InterruptedException -> L4c java.lang.Throwable -> L84
                r0.wait()     // Catch: java.lang.InterruptedException -> L4c java.lang.Throwable -> L84
            ...
            L65:
                ...
                java.lang.Object r0 = r0.mSync
                monitor-enter(r0)
                com.serenegiant.media.MediaEncoder r1 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L79
                r1.mRequestStop = r4     // Catch: java.lang.Throwable -> L79
                com.serenegiant.media.MediaEncoder r1 = com.serenegiant.media.MediaEncoder.this     // Catch: java.lang.Throwable -> L79
                r1.mIsCapturing = r2     // Catch: java.lang.Throwable -> L79
        ...
        while (this.mIsCapturing) {
            try {
                ...
                if (iDequeueOutputBuffer == -1) {
                    ...
                    if (byteBuffer == null) {
                        RuntimeException runtimeException2 = new RuntimeException("encoderOutputBuffer " + iDequeueOutputBuffer + " was null");
