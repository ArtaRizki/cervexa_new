    ...
    private final class CallbackThread extends Thread {
        ...
        public final void run() {
            ...
            while (IAudioSampler.this.mIsCapturing) {
                try {
                    MediaData mediaDataPollMediaData = IAudioSampler.this.pollMediaData(100L);
                    if (mediaDataPollMediaData != null) {
                        IAudioSampler.this.callOnData(mediaDataPollMediaData);
                        IAudioSampler.this.recycle(mediaDataPollMediaData);
                    }
                } catch (InterruptedException unused) {
                }
            }
