...
public class BluetoothManager {
    ...
    public void connect(String str) throws IllegalStateException, IllegalArgumentException {
        checkReleased();
        ...
        public void run() {
            ...
            while (BluetoothManager.this.mState == 3) {
                try {
                    ...
                    if (i > 0) {
                        BluetoothManager.this.callOnReceive(bArr, i);
                    }
                } catch (IOException e) {
                    if (!this.mIsCanceled) {
        ...
        */
        public void run() {
            /*
                r4 = this;
            L0:
                com.serenegiant.bluetooth.BluetoothManager r0 = com.serenegiant.bluetooth.BluetoothManager.this
                int r0 = com.serenegiant.bluetooth.BluetoothManager.access$300(r0)
                r1 = 3
                if (r0 == r1) goto L4b
                android.bluetooth.BluetoothServerSocket r0 = r4.mmServerSocket     // Catch: java.io.IOException -> L3b
                android.bluetooth.BluetoothSocket r0 = r0.accept()     // Catch: java.io.IOException -> L3b
                if (r0 == 0) goto L0
                com.serenegiant.bluetooth.BluetoothManager r2 = com.serenegiant.bluetooth.BluetoothManager.this
                int r2 = com.serenegiant.bluetooth.BluetoothManager.access$300(r2)
                if (r2 == 0) goto L2c
                r3 = 1
                if (r2 == r3) goto L22
                r3 = 2
                ...
                goto L0
            L22:
                com.serenegiant.bluetooth.BluetoothManager r1 = com.serenegiant.bluetooth.BluetoothManager.this
                android.bluetooth.BluetoothDevice r2 = r0.getRemoteDevice()
                r1.onConnect(r0, r2)
                goto L4b
            L2c:
            ...
            L30:
                r0 = move-exception
                java.lang.String r1 = com.serenegiant.bluetooth.BluetoothManager.access$100()
                java.lang.String r2 = "Could not close unwanted socket"
                android.util.Log.w(r1, r2, r0)
                goto L0
            L3b:
                r0 = move-exception
                boolean r1 = r4.mIsCanceled
                if (r1 != 0) goto L4b
                java.lang.String r1 = com.serenegiant.bluetooth.BluetoothManager.access$100()
