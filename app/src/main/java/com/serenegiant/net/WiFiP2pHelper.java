    ...
    */
    public synchronized boolean isWiFiP2pEnabled() {
        /*
            r1 = this;
            monitor-enter(r1)
            android.net.wifi.p2p.WifiP2pManager$Channel r0 = r1.mChannel     // Catch: java.lang.Throwable -> Le
            if (r0 == 0) goto Lb
            boolean r0 = r1.mIsWifiP2pEnabled     // Catch: java.lang.Throwable -> Le
            if (r0 == 0) goto Lb
            r0 = 1
            goto Lc
        Lb:
    ...
    */
    public synchronized boolean isConnected() {
        /*
            r1 = this;
            monitor-enter(r1)
            android.net.wifi.p2p.WifiP2pDevice r0 = r1.mWifiP2pDevice     // Catch: java.lang.Throwable -> L10
            if (r0 == 0) goto Ld
            android.net.wifi.p2p.WifiP2pDevice r0 = r1.mWifiP2pDevice     // Catch: java.lang.Throwable -> L10
            int r0 = r0.status     // Catch: java.lang.Throwable -> L10
            if (r0 != 0) goto Ld
            r0 = 1
            goto Le
        Ld:
