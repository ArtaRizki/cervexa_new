...
public class RingBounds extends CylinderBounds {
    ...
    public RingBounds(Vector vector, float f, float f2, float f3) {
        this(vector.f2252x, vector.f2253y, vector.f2254z, f, f2, f3);
    }
    ...
    public boolean ptInBounds(float f, float f2, float f3) {
        boolean zPtInBounds = super.ptInBounds(f, f2, f3);
        return zPtInBounds ? !ptInCylinder(f, f2, f3, this.inner_r) : zPtInBounds;
    }
}
