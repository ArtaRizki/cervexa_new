...
public class MessageDialogFragment extends DialogFragment {
    ...
    public static MessageDialogFragment showDialog(Activity activity, int i, int i2, int i3, String[] strArr) {
        MessageDialogFragment messageDialogFragmentNewInstance = newInstance(i, i2, i3, strArr);
        messageDialogFragmentNewInstance.show(activity.getFragmentManager(), TAG);
        return messageDialogFragmentNewInstance;
    }

    public static MessageDialogFragment showDialog(Fragment fragment, int i, int i2, int i3, String[] strArr) {
        MessageDialogFragment messageDialogFragmentNewInstance = newInstance(i, i2, i3, strArr);
        messageDialogFragmentNewInstance.setTargetFragment(fragment, fragment.getId());
        messageDialogFragmentNewInstance.show(fragment.getFragmentManager(), TAG);
        return messageDialogFragmentNewInstance;
    }
