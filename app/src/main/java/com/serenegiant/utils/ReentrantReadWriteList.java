...
public class ReentrantReadWriteList<V> implements List<V> {
    ...
    public boolean add(V v) {
        this.mWriteLock.lock();
        try {
            Boolean boolValueOf = Boolean.valueOf(this.mList.add(v));
            this.mWriteLock.unlock();
    ...
    public boolean remove(Object obj) {
        this.mWriteLock.lock();
        try {
            Boolean boolValueOf = Boolean.valueOf(this.mList.remove(obj));
            this.mWriteLock.unlock();
            return boolValueOf.booleanValue();
        } catch (Throwable th) {
            this.mWriteLock.unlock();
    ...
    public boolean addAll(Collection<? extends V> collection) {
        this.mWriteLock.lock();
        try {
            Boolean boolValueOf = Boolean.valueOf(this.mList.addAll(collection));
            this.mWriteLock.unlock();
            return boolValueOf.booleanValue();
        } catch (Throwable th) {
            this.mWriteLock.unlock();
    ...
    public boolean addAll(int i, Collection<? extends V> collection) {
        this.mWriteLock.lock();
        try {
            Boolean boolValueOf = Boolean.valueOf(this.mList.addAll(i, collection));
            this.mWriteLock.unlock();
            return boolValueOf.booleanValue();
        } catch (Throwable th) {
            this.mWriteLock.unlock();
    ...
    public boolean removeAll(Collection<?> collection) {
        this.mWriteLock.lock();
        try {
            Boolean boolValueOf = Boolean.valueOf(this.mList.removeAll(collection));
            this.mWriteLock.unlock();
            return boolValueOf.booleanValue();
        } catch (Throwable th) {
            this.mWriteLock.unlock();
    ...
    public boolean retainAll(Collection<?> collection) {
        this.mWriteLock.lock();
        try {
            Boolean boolValueOf = Boolean.valueOf(this.mList.retainAll(collection));
            this.mWriteLock.unlock();
            return boolValueOf.booleanValue();
        } catch (Throwable th) {
            this.mWriteLock.unlock();
