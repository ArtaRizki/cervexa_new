...
public class SDUtils {
    ...
    public static boolean hasStorageAccess(Context context, int i) {
        Uri uriLoadUri;
        if (BuildCheck.isLollipop() && (uriLoadUri = loadUri(context, getKey(i))) != null) {
            Iterator<UriPermission> it = context.getContentResolver().getPersistedUriPermissions().iterator();
            while (it.hasNext()) {
                if (it.next().getUri().equals(uriLoadUri)) {
                    return true;
                }
            }
        }
    ...
    public static void releaseStorageAccessPermission(Context context, int i) {
        String key;
        Uri uriLoadUri;
        if (!BuildCheck.isLollipop() || (uriLoadUri = loadUri(context, (key = getKey(i)))) == null) {
            return;
        }
        context.getContentResolver().releasePersistableUriPermission(uriLoadUri, 3);
    ...
    public static DocumentFile getStorage(Context context, int i, String str) throws IOException {
        ...
        DocumentFile documentFileFromTreeUri = DocumentFile.fromTreeUri(context, storageUri);
        if (!TextUtils.isEmpty(str)) {
            for (String str2 : str.split("/")) {
                if (!TextUtils.isEmpty(str2)) {
                    DocumentFile documentFileFindFile = documentFileFromTreeUri.findFile(str2);
                    if (documentFileFindFile != null && documentFileFindFile.isDirectory()) {
                        documentFileFromTreeUri = documentFileFindFile;
                    } else if (documentFileFindFile == null) {
                        if (documentFileFromTreeUri.canWrite()) {
                            documentFileFromTreeUri = documentFileFromTreeUri.createDirectory(str2);
                        } else {
    ...
    public static DocumentFile getStorageFile(Context context, int i, String str, String str2, String str3) throws IOException {
        ...
        DocumentFile documentFileFindFile = storage.findFile(str3);
        if (documentFileFindFile != null) {
            if (documentFileFindFile.isFile()) {
                return documentFileFindFile;
            }
    ...
    public static OutputStream getStorageOutputStream(Context context, int i, String str, String str2, String str3) throws IOException {
        ...
        if (BuildCheck.isLollipop() && (storage = getStorage(context, i, str)) != null) {
            ...
            if (documentFileFindFile != null) {
                if (documentFileFindFile.isFile()) {
                    return context.getContentResolver().openOutputStream(documentFileFindFile.getUri());
                }
                throw new IOException("directory with same name already exists");
            }
    ...
    public static InputStream getStorageInputStream(Context context, int i, String str, String str2, String str3) throws IOException {
        DocumentFile storage;
        DocumentFile documentFileFindFile;
        if (BuildCheck.isLollipop() && (storage = getStorage(context, i, str)) != null && (documentFileFindFile = storage.findFile(str3)) != null) {
            if (documentFileFindFile.isFile()) {
                return context.getContentResolver().openInputStream(documentFileFindFile.getUri());
            }
            throw new IOException("directory with same name already exists");
        }
        throw new FileNotFoundException();
    ...
    public static InputStream getStorageInputStream(Context context, DocumentFile documentFile, String str, String str2, String str3) throws IOException {
        DocumentFile documentFileFindFile;
        DocumentFile storage = getStorage(context, documentFile, str);
        if (storage != null && (documentFileFindFile = storage.findFile(str3)) != null) {
            if (documentFileFindFile.isFile()) {
                return context.getContentResolver().openInputStream(documentFileFindFile.getUri());
            }
            throw new IOException("directory with same name already exists");
    ...
    public static ParcelFileDescriptor getStorageFileFD(Context context, int i, String str, String str2, String str3) throws IOException {
        ...
        if (BuildCheck.isLollipop() && (storage = getStorage(context, i, str)) != null) {
            ...
            if (documentFileFindFile != null) {
                if (documentFileFindFile.isFile()) {
                    return context.getContentResolver().openFileDescriptor(documentFileFindFile.getUri(), "rw");
                }
                throw new IOException("directory with same name already exists");
            }
    ...
    public static int createStorageFileFD(Context context, Uri uri, String str, String str2) {
        ...
        if (BuildCheck.isLollipop() && uri != null && !TextUtils.isEmpty(str2)) {
            try {
                ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = context.getContentResolver().openFileDescriptor(DocumentFile.fromTreeUri(context, uri).createFile(str, str2).getUri(), "rw");
                if (parcelFileDescriptorOpenFileDescriptor != null) {
                    return parcelFileDescriptorOpenFileDescriptor.getFd();
                }
                return 0;
