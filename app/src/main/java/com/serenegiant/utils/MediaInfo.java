...
public final class MediaInfo {
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x00b4 A[Catch: Exception -> 0x00d7, TryCatch #2 {Exception -> 0x00d7, blocks: (B:39:0x00b0, B:41:0x00b4, B:44:0x00b9, B:46:0x00c1, B:47:0x00d3), top: B:66:0x00b0 }] */
    /* JADX WARN: Removed duplicated region for block: B:42:0x00b6  */
    /* JADX WARN: Removed duplicated region for block: B:44:0x00b9 A[Catch: Exception -> 0x00d7, TryCatch #2 {Exception -> 0x00d7, blocks: (B:39:0x00b0, B:41:0x00b4, B:44:0x00b9, B:46:0x00c1, B:47:0x00d3), top: B:66:0x00b0 }] */
    ...
    */
    ...
    public static MediaCodecInfo.CodecCapabilities getCodecCapabilities(MediaCodecInfo mediaCodecInfo, String str) {
        HashMap<MediaCodecInfo, MediaCodecInfo.CodecCapabilities> map = sCapabilities.get(str);
        if (map == null) {
            map = new HashMap<>();
            sCapabilities.put(str, map);
        }
        MediaCodecInfo.CodecCapabilities codecCapabilities = map.get(mediaCodecInfo);
        ...
        try {
            ...
            map.put(mediaCodecInfo, capabilitiesForType);
