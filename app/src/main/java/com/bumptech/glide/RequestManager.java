...
public class RequestManager implements LifecycleListener {
    ...
    protected void setRequestOptions(RequestOptions requestOptions) {
        this.requestOptions = requestOptions.m2341clone().autoClone();
    }
    ...
    public RequestBuilder<Bitmap> asBitmap() {
        return m1290as(Bitmap.class).transition(new GenericTransitionOptions()).apply(DECODE_TYPE_BITMAP);
    }

    public RequestBuilder<GifDrawable> asGif() {
        return m1290as(GifDrawable.class).transition(new DrawableTransitionOptions()).apply(DECODE_TYPE_GIF);
    }

    public RequestBuilder<Drawable> asDrawable() {
        return m1290as(Drawable.class).transition(new DrawableTransitionOptions());
    }
    ...
    public RequestBuilder<File> downloadOnly() {
        return m1290as(File.class).apply(DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public RequestBuilder<File> asFile() {
        return m1290as(File.class).apply(RequestOptions.skipMemoryCacheOf(true));
    }

    /* JADX INFO: renamed from: as */
    public <ResourceType> RequestBuilder<ResourceType> m1290as(Class<ResourceType> cls) {
