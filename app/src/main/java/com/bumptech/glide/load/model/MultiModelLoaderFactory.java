...
public class MultiModelLoaderFactory {
    ...
    synchronized <Model, Data> void append(Class<Model> cls, Class<Data> cls2, ModelLoaderFactory<Model, Data> modelLoaderFactory) {
        add(cls, cls2, modelLoaderFactory, true);
    }

    synchronized <Model, Data> void prepend(Class<Model> cls, Class<Data> cls2, ModelLoaderFactory<Model, Data> modelLoaderFactory) {
    ...
    synchronized <Model, Data> List<ModelLoaderFactory<Model, Data>> replace(Class<Model> cls, Class<Data> cls2, ModelLoaderFactory<Model, Data> modelLoaderFactory) {
        List<ModelLoaderFactory<Model, Data>> listRemove;
        listRemove = remove(cls, cls2);
        append(cls, cls2, modelLoaderFactory);
        return listRemove;
    }

    synchronized <Model, Data> List<ModelLoaderFactory<Model, Data>> remove(Class<Model> cls, Class<Data> cls2) {
        ArrayList arrayList;
    ...
    static class Factory {
        ...
        public <Model, Data> MultiModelLoader<Model, Data> build(List<ModelLoader<Model, Data>> list, Pools.Pool<List<Exception>> pool) {
