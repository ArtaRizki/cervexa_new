...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    public static class LoadStatus {
        ...
        private final ResourceCallback f1913cb;
        private final EngineJob<?> engineJob;

        public LoadStatus(ResourceCallback resourceCallback, EngineJob<?> engineJob) {
            this.f1913cb = resourceCallback;
            this.engineJob = engineJob;
        }

        public void cancel() {
            this.engineJob.removeCallback(this.f1913cb);
        }
    }
    ...
    public <R> LoadStatus load(GlideContext glideContext, Object obj, Key key, int i, int i2, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z, Options options, boolean z2, boolean z3, boolean z4, ResourceCallback resourceCallback) {
        ...
        EngineResource<?> engineResourceLoadFromCache = loadFromCache(engineKeyBuildKey, z2);
        ...
        EngineResource<?> engineResourceLoadFromActiveResources = loadFromActiveResources(engineKeyBuildKey, z2);
        ...
        EngineJob<R> engineJobBuild = this.engineJobFactory.build(engineKeyBuildKey, z2, z3);
        DecodeJob<R> decodeJobBuild = this.decodeJobFactory.build(glideContext, obj, engineKeyBuildKey, key, i, i2, cls, cls2, priority, diskCacheStrategy, map, z, z4, options, engineJobBuild);
    ...
    static class DecodeJobFactory {
        ...
        <R> DecodeJob<R> build(GlideContext glideContext, Object obj, EngineKey engineKey, Key key, int i, int i2, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z, boolean z2, Options options, DecodeJob.Callback<R> callback) {
            DecodeJob<?> decodeJobAcquire = this.pool.acquire();
            int i3 = this.creationOrder;
            this.creationOrder = i3 + 1;
            return (DecodeJob<R>) decodeJobAcquire.init(glideContext, obj, engineKey, key, i, i2, cls, cls2, priority, diskCacheStrategy, map, z, z2, options, callback, i3);
        }
    }
