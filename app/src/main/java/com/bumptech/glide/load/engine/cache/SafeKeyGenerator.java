...
public class SafeKeyGenerator {
    ...
    private String calculateHexStringDigest(Key key) {
        ...
        try {
            key.updateDiskCacheKey(poolableDigestContainerAcquire.messageDigest);
            return Util.sha256BytesToHex(poolableDigestContainerAcquire.messageDigest.digest());
        } finally {
            this.digestPool.release(poolableDigestContainerAcquire);
        }
    }
