...
public final class TransformationUtils {
    ...
    static {
        List<String> listAsList = Arrays.asList("XT1097", "XT1085");
        MODELS_REQUIRING_BITMAP_LOCK = listAsList;
        BITMAP_DRAWABLE_LOCK = (listAsList.contains(Build.MODEL) && Build.VERSION.SDK_INT == 22) ? new ReentrantLock() : new NoLock();
    ...
    public static Bitmap circleCrop(BitmapPool bitmapPool, Bitmap bitmap, int i, int i2) {
        ...
        Bitmap bitmap2 = bitmapPool.get(iMin, iMin, Bitmap.Config.ARGB_8888);
