...
class StrictLineReader implements Closeable {
    ...
    private static final byte f1905CR = 13;

    /* JADX INFO: renamed from: LF */
    private static final byte f1906LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* JADX INFO: renamed from: in */
    private final InputStream f1907in;
    private int pos;
    ...
    */
    public java.lang.String readLine() throws java.io.IOException {
        /*
            r7 = this;
            java.io.InputStream r0 = r7.f1907in
            monitor-enter(r0)
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f1907in;
        byte[] bArr = this.buf;
