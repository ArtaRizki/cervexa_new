...
public class RequestBuilder<TranscodeType> implements Cloneable {
    ...
    protected RequestOptions getMutableOptions() {
        ...
        return requestOptions == requestOptions2 ? requestOptions2.m2341clone() : requestOptions2;
    }
    ...
    public RequestBuilder<TranscodeType> m2339clone() {
        try {
            RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.clone();
            requestBuilder.requestOptions = requestBuilder.requestOptions.m2341clone();
            requestBuilder.transitionOptions = requestBuilder.transitionOptions.m2340clone();
    ...
    public Target<TranscodeType> into(ImageView imageView) {
        ...
        if (!this.requestOptions.isTransformationSet() && this.requestOptions.isTransformationAllowed() && imageView.getScaleType() != null) {
            if (this.requestOptions.isLocked()) {
                this.requestOptions = this.requestOptions.m2341clone();
            }
            switch (C08982.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
        ...
        return into(this.context.buildImageViewTarget(imageView, this.transcodeClass));
    }
    ...
    /* JADX INFO: renamed from: com.bumptech.glide.RequestBuilder$2 */
    static /* synthetic */ class C08982 {
    ...
    private Priority getThumbnailPriority(Priority priority) {
        int i = C08982.$SwitchMap$com$bumptech$glide$Priority[priority.ordinal()];
        if (i == 1) {
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, ThumbnailRequestCoordinator thumbnailRequestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int i, int i2) {
        ...
        if (requestBuilder != null) {
            ...
            Request requestObtainRequest = obtainRequest(target, this.requestOptions, thumbnailRequestCoordinator2, transitionOptions, priority, i, i2);
            this.isThumbnailBuilt = true;
            Request requestBuildRequestRecursive = this.thumbnailBuilder.buildRequestRecursive(target, thumbnailRequestCoordinator2, transitionOptions3, priority2, overrideWidth, overrideHeight);
        ...
        if (this.thumbSizeMultiplier != null) {
            ...
            thumbnailRequestCoordinator3.setRequests(obtainRequest(target, this.requestOptions, thumbnailRequestCoordinator3, transitionOptions, priority, i, i2), obtainRequest(target, this.requestOptions.m2341clone().sizeMultiplier(this.thumbSizeMultiplier.floatValue()), thumbnailRequestCoordinator3, transitionOptions, getThumbnailPriority(priority), i, i2));
