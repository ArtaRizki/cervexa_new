...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1910ix = readShort();
        this.header.currentFrame.f1911iy = readShort();
        this.header.currentFrame.f1909iw = readShort();
        this.header.currentFrame.f1908ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
