...
public class StandardGifDecoder implements GifDecoder {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:59:0x0139 A[PHI: r4
  0x0139: PHI (r4v11 int) = (r4v7 int), (r4v13 int) binds: [B:53:0x0121, B:55:0x012e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private int readBlock() {
        ...
        if (i > 0) {
            try {
                ...
                int i2 = this.workBufferSize - this.workBufferPosition;
                if (i2 >= i) {
                    System.arraycopy(this.workBuffer, this.workBufferPosition, this.block, 0, i);
                    this.workBufferPosition += i;
                } else if (this.rawData.remaining() + i2 >= i) {
                    System.arraycopy(this.workBuffer, this.workBufferPosition, this.block, 0, i2);
                    this.workBufferPosition = this.workBufferSize;
                    readChunkIfNeeded();
                    int i3 = i - i2;
                    System.arraycopy(this.workBuffer, 0, this.block, i2, i3);
                    this.workBufferPosition += i3;
                } else {
                    this.status = 1;
                }
            } catch (Exception e) {
