...
public class Registry {
    ...
    public Registry() {
        Pools.Pool<List<Exception>> poolThreadSafeList = FactoryPools.threadSafeList();
        this.exceptionListPool = poolThreadSafeList;
    ...
    public <Data, TResource> Registry prepend(Class<Data> cls, Class<TResource> cls2, ResourceDecoder<Data, TResource> resourceDecoder) {
        this.decoderRegistry.prepend(resourceDecoder, cls, cls2);
        return this;
    }

    public <TResource> Registry register(Class<TResource> cls, ResourceEncoder<TResource> resourceEncoder) {
        this.resourceEncoderRegistry.add(cls, resourceEncoder);
        return this;
    }
    ...
    public <Model, Data> Registry replace(Class<Model> cls, Class<Data> cls2, ModelLoaderFactory<Model, Data> modelLoaderFactory) {
    ...
    public <Data, TResource, Transcode> LoadPath<Data, TResource, Transcode> getLoadPath(Class<Data> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        ...
        if (loadPath == null && !this.loadPathCache.contains(cls, cls2, cls3)) {
            ...
            loadPath = decodePaths.isEmpty() ? null : new LoadPath<>(cls, cls2, cls3, decodePaths, this.exceptionListPool);
    ...
    public <Model, TResource, Transcode> List<Class<?>> getRegisteredResourceClasses(Class<Model> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        List<Class<?>> arrayList = this.modelToResourceClassCache.get(cls, cls2);
        if (arrayList == null) {
