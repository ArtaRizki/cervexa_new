...
public class PlayerMediaController extends FrameLayout {
    ...
    public PlayerMediaController(Context context, AttributeSet attributeSet) {
        ...
        this.mSeekListener = new SeekBar.OnSeekBarChangeListener() { // from class: com.gizthon.camera.view.PlayerMediaController.4
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                if (z) {
                    long duration = (((long) PlayerMediaController.this.mPlayer.getDuration()) * ((long) i)) / 1000;
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                PlayerMediaController.this.mPlayer.seekTo((int) ((((long) PlayerMediaController.this.mPlayer.getDuration()) * ((long) seekBar.getProgress())) / 1000));
    ...
    public void setAnchorView(ViewGroup viewGroup) {
        ...
        removeAllViews();
        View viewMakeControllerView = makeControllerView();
        addView(viewMakeControllerView, -1, -1);
        this.mAnchor.removeView(this);
        this.mAnchor.addView(this, -1, -1);
        viewMakeControllerView.setVisibility(4);
    }

    protected View makeControllerView() {
        View viewInflate = LayoutInflater.from(this.mContext).inflate(getControllerLayoutId(), (ViewGroup) null);
