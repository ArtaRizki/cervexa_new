...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    static {
        ...
        sparseIntArray.put(com.weioa.KmedHealthIndonesia.R.layout.dialog_share, 1);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.gallery_activity, 2);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.gallery_photo_fragment, 3);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.gallery_photo_item, 4);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.help_activity, 5);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.preview_photo_activity, 6);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.preview_photo_item, 7);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.preview_video_activity, 8);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.splash_activity, 9);
        INTERNAL_LAYOUT_ID_LOOKUP.put(com.weioa.KmedHealthIndonesia.R.layout.usb_preview_activity, 10);
    }
    ...
    private static class InnerLayoutIdLookup {
        ...
        static {
            ...
            sKeys = map;
            map.put("layout/dialog_share_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.dialog_share));
            sKeys.put("layout/gallery_activity_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.gallery_activity));
            sKeys.put("layout/gallery_photo_fragment_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.gallery_photo_fragment));
            sKeys.put("layout/gallery_photo_item_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.gallery_photo_item));
            sKeys.put("layout/help_activity_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.help_activity));
            sKeys.put("layout/preview_photo_activity_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.preview_photo_activity));
            sKeys.put("layout/preview_photo_item_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.preview_photo_item));
            sKeys.put("layout/preview_video_activity_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.preview_video_activity));
            sKeys.put("layout/splash_activity_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.splash_activity));
            sKeys.put("layout/usb_preview_activity_0", Integer.valueOf(com.weioa.KmedHealthIndonesia.R.layout.usb_preview_activity));
        }
    }
}
