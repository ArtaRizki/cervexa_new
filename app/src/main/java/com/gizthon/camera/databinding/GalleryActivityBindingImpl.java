...
public class GalleryActivityBindingImpl extends GalleryActivityBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0 && galleryViewModel != null) {
            editVisible = galleryViewModel.getEditVisible();
        }
        if ((j & 8) != 0) {
        ...
        if (j2 != 0) {
            this.done.setVisibility(editVisible);
            this.mboundView2.setVisibility(editVisible);
            this.tvComplete.setVisibility(editVisible);
        }
    }
