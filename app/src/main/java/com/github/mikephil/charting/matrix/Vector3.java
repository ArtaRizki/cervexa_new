...
public final class Vector3 {
    ...
    public final void add(Vector3 vector3) {
        this.f1960x += vector3.f1960x;
        this.f1961y += vector3.f1961y;
        this.f1962z += vector3.f1962z;
    }
    ...
    public final void subtractMultiple(Vector3 vector3, float f) {
        this.f1960x -= vector3.f1960x * f;
        this.f1961y -= vector3.f1961y * f;
        this.f1962z -= vector3.f1962z * f;
    }
    ...
    public final float dot(Vector3 vector3) {
        return (this.f1960x * vector3.f1960x) + (this.f1961y * vector3.f1961y) + (this.f1962z * vector3.f1962z);
    }

    public final Vector3 cross(Vector3 vector3) {
        float f = this.f1961y;
        float f2 = vector3.f1962z;
        float f3 = this.f1962z;
        float f4 = vector3.f1961y;
        float f5 = (f * f2) - (f3 * f4);
        float f6 = vector3.f1960x;
        float f7 = this.f1960x;
    ...
    public final float length2() {
        float f = this.f1960x;
        float f2 = this.f1961y;
        float f3 = (f * f) + (f2 * f2);
        float f4 = this.f1962z;
        return f3 + (f4 * f4);
    }

    public final float distance2(Vector3 vector3) {
        float f = this.f1960x - vector3.f1960x;
        float f2 = this.f1961y - vector3.f1961y;
        float f3 = this.f1962z - vector3.f1962z;
