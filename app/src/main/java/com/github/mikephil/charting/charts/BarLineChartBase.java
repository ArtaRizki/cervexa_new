...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    protected void calculateLegendOffsets(RectF rectF) {
        ...
        int i = C10642.f1943x9c9dbef[this.mLegend.getOrientation().ordinal()];
        if (i == 1) {
            int i2 = C10642.f1942x2787f53e[this.mLegend.getHorizontalAlignment().ordinal()];
            if (i2 == 1) {
            ...
            int i3 = C10642.f1944xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
            if (i3 == 1) {
        ...
        int i4 = C10642.f1944xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
        if (i4 == 1) {
            rectF.top += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
    ...
    static /* synthetic */ class C10642 {
        ...
        static {
            ...
            try {
                f1943x9c9dbef[Legend.LegendOrientation.HORIZONTAL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            int[] iArr2 = new int[Legend.LegendHorizontalAlignment.values().length];
            f1942x2787f53e = iArr2;
            try {
                iArr2[Legend.LegendHorizontalAlignment.LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1942x2787f53e[Legend.LegendHorizontalAlignment.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1942x2787f53e[Legend.LegendHorizontalAlignment.CENTER.ordinal()] = 3;
            } catch (NoSuchFieldError unused5) {
            }
            int[] iArr3 = new int[Legend.LegendVerticalAlignment.values().length];
            f1944xc926f1ec = iArr3;
            try {
                iArr3[Legend.LegendVerticalAlignment.TOP.ordinal()] = 1;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1944xc926f1ec[Legend.LegendVerticalAlignment.BOTTOM.ordinal()] = 2;
    ...
    public void zoomIn() {
        ...
        this.mViewPortHandler.zoomIn(contentCenter.f1970x, -contentCenter.f1971y, this.mZoomMatrixBuffer);
    ...
    public void zoomOut() {
        MPPointF contentCenter = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(contentCenter.f1970x, -contentCenter.f1971y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
        MPPointF.recycleInstance(contentCenter);
        calculateOffsets();
        postInvalidate();
    ...
    public void zoomToCenter(float f, float f2) {
        ...
        this.mViewPortHandler.zoom(f, f2, centerOffsets.f1970x, -centerOffsets.f1971y, matrix);
    ...
    public void zoomAndCenterAnimated(float f, float f2, float f3, float f4, YAxis.AxisDependency axisDependency, long j) {
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axisDependency), getAxis(axisDependency), this.mXAxis.mAxisRange, f, f2, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), f3, f4, (float) valuesByTouchPoint.f1968x, (float) valuesByTouchPoint.f1969y, j));
    ...
    public void moveViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        if (Build.VERSION.SDK_INT >= 11) {
            MPPointD valuesByTouchPoint = getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), axisDependency);
            addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, f2 + ((getAxisRange(axisDependency) / this.mViewPortHandler.getScaleY()) / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f1968x, (float) valuesByTouchPoint.f1969y, j));
            MPPointD.recycleInstance(valuesByTouchPoint);
            return;
        }
    ...
    public void centerViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        if (Build.VERSION.SDK_INT >= 11) {
            MPPointD valuesByTouchPoint = getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), axisDependency);
            float axisRange = getAxisRange(axisDependency) / this.mViewPortHandler.getScaleY();
            addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f - ((getXAxis().mAxisRange / this.mViewPortHandler.getScaleX()) / 2.0f), f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f1968x, (float) valuesByTouchPoint.f1969y, j));
            MPPointD.recycleInstance(valuesByTouchPoint);
            return;
        }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max(this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f1968x);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min(this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f1968x);
    }
