                ...
                if (shouldDrawValues(iBarDataSet)) {
                    ...
                    if (iBarDataSet.isStacked()) {
                        ...
                        while (i6 < iBarDataSet.getEntryCount() * this.mAnimator.getPhaseX()) {
                            ...
                            float f7 = (barBuffer2.buffer[length] + barBuffer2.buffer[length + 2]) / 2.0f;
                            ...
                            if (yVals == null) {
                                ...
                                int i7 = length + 1;
                                if (this.mViewPortHandler.isInBoundsY(barBuffer2.buffer[i7]) && this.mViewPortHandler.isInBoundsLeft(f7)) {
                                    list = dataSets;
                                    fArr = yVals;
                                    i = i6;
                                    f = fConvertDpToPixel;
                                    transformer = transformer2;
                                    drawValue(canvas, iBarDataSet.getValueFormatter(), barEntry.getY(), barEntry, i5, f7, barBuffer2.buffer[i7] + (barEntry.getY() >= 0.0f ? f5 : f6), valueTextColor);
                                } else {
                                ...
                                while (i10 < length2) {
                                    int i11 = i10 / 2;
                                    float f13 = fArr[i11];
                                    float f14 = fArr3[i10 + 1] + (((f13 > 0.0f ? 1 : (f13 == 0.0f ? 0 : -1)) == 0 && (f9 > 0.0f ? 1 : (f9 == 0.0f ? 0 : -1)) == 0 && (f10 > 0.0f ? 1 : (f10 == 0.0f ? 0 : -1)) > 0) || (f13 > 0.0f ? 1 : (f13 == 0.0f ? 0 : -1)) < 0 ? f6 : f5);
                                    float f15 = f8;
                                    ...
                                    if (this.mViewPortHandler.isInBoundsY(f14) && this.mViewPortHandler.isInBoundsLeft(f15)) {
                                        ...
                                        fArr2 = fArr3;
                                        i3 = length2;
                                        drawValue(canvas, iBarDataSet.getValueFormatter(), fArr[i11], barEntry, i5, f8, f14, valueTextColor);
                                    } else {
                                        f8 = f15;
                                        i2 = i10;
                                        fArr2 = fArr3;
                        ...
                        while (i12 < barBuffer2.buffer.length * this.mAnimator.getPhaseX()) {
                            float f16 = (barBuffer2.buffer[i12] + barBuffer2.buffer[i12 + 2]) / 2.0f;
                            if (!this.mViewPortHandler.isInBoundsRight(f16)) {
                                break;
                            }
                            int i13 = i12 + 1;
                            if (this.mViewPortHandler.isInBoundsY(barBuffer2.buffer[i13]) && this.mViewPortHandler.isInBoundsLeft(f16)) {
                                int i14 = i12 / 4;
                                Entry entry = (BarEntry) iBarDataSet.getEntryForIndex(i14);
                                float y = entry.getY();
                                i4 = i12;
                                barBuffer = barBuffer2;
                                drawValue(canvas, iBarDataSet.getValueFormatter(), y, entry, i5, f16, y >= 0.0f ? barBuffer2.buffer[i13] + f5 : barBuffer2.buffer[i12 + 3] + f6, iBarDataSet.getValueTextColor(i14));
                            } else {
                                i4 = i12;
                                barBuffer = barBuffer2;
                            }
