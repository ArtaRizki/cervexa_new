...
public class HorizontalBarChart extends BarChart {
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max(this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f1969y);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min(this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f1969y);
    }
