...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    protected void drawDataSet(Canvas canvas, ILineDataSet iLineDataSet) {
        ...
        int i = C10741.$SwitchMap$com$github$mikephil$charting$data$LineDataSet$Mode[iLineDataSet.getMode().ordinal()];
        if (i == 3) {
    ...
    /* JADX INFO: renamed from: com.github.mikephil.charting.renderer.LineChartRenderer$1 */
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iLineDataSet != null && iLineDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(entryForXValue, iLineDataSet)) {
                    ...
                    drawHighlightLines(canvas, (float) pixelForValues.f1968x, (float) pixelForValues.f1969y, iLineDataSet);
                }
            }
        }
    }
    ...
    private class DataSetImageCache {
        ...
        /* synthetic */ DataSetImageCache(LineChartRenderer lineChartRenderer, C10741 c10741) {
            this();
        }
