...
public class ScatterDataSet extends LineScatterCandleRadarDataSet<Entry> implements IScatterDataSet {
    ...
    /* JADX INFO: renamed from: com.github.mikephil.charting.data.ScatterDataSet$1 */
    static /* synthetic */ class C10711 {

        /* JADX INFO: renamed from: $SwitchMap$com$github$mikephil$charting$charts$ScatterChart$ScatterShape */
        static final /* synthetic */ int[] f1954x9beb7303;
        ...
        static {
            ...
            try {
                f1954x9beb7303[ScatterChart.ScatterShape.CIRCLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1954x9beb7303[ScatterChart.ScatterShape.TRIANGLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1954x9beb7303[ScatterChart.ScatterShape.CROSS.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1954x9beb7303[ScatterChart.ScatterShape.X.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1954x9beb7303[ScatterChart.ScatterShape.CHEVRON_UP.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1954x9beb7303[ScatterChart.ScatterShape.CHEVRON_DOWN.ordinal()] = 7;
    ...
    public static IShapeRenderer getRendererForShape(ScatterChart.ScatterShape scatterShape) {
        switch (C10711.f1954x9beb7303[scatterShape.ordinal()]) {
            case 1:
