...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void computeAxis(float f, float f2, boolean z) {
        ...
        if (this.mViewPortHandler.contentWidth() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutX()) {
            ...
            if (z) {
                f3 = (float) valuesByTouchPoint2.f1968x;
                d = valuesByTouchPoint.f1968x;
            } else {
                f3 = (float) valuesByTouchPoint.f1968x;
                d = valuesByTouchPoint2.f1968x;
            }
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
                mPPointF.f1970x = 0.5f;
                mPPointF.f1971y = 1.0f;
            ...
            } else if (this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_BOTTOM_LABEL) {
                mPPointF.f1970x = 0.5f;
                mPPointF.f1971y = 0.0f;
                drawLabels(canvas, this.mViewPortHandler.contentBottom() + yOffset, mPPointF);
            } else {
    ...
    public void renderAxisLine(Canvas canvas) {
        if (this.mXAxis.isDrawAxisLineEnabled() && this.mXAxis.isEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP || this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP_INSIDE || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_SIDED || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_BOTTOM_LABEL) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM_INSIDE || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_SIDED || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_BOTTOM_LABEL) {
