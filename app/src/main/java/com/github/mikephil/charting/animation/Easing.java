    ...
    private static class EasingFunctions {
        ...
        public static final EasingFunction EaseInOutExpo = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.16
            ...
            public float getInterpolation(float f) {
                ...
                if (f / 0.5f < 1.0f) {
                    fPow = (float) Math.pow(2.0d, (r7 - 1.0f) * 10.0f);
                } else {
                    fPow = (-((float) Math.pow(2.0d, (r7 - 1.0f) * (-10.0f)))) + 2.0f;
                }
                return fPow * 0.5f;
            }
        };
        ...
        public static final EasingFunction EaseInElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.20
            ...
            public float getInterpolation(float f) {
                ...
                return -(((float) Math.pow(2.0d, 10.0f * r8)) * ((float) Math.sin((((double) ((f - 1.0f) - (0.047746483f * ((float) Math.asin(1.0d))))) * 6.283185307179586d) / ((double) 0.3f))));
            }
        };
        public static final EasingFunction EaseOutElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.21
            ...
            public float getInterpolation(float f) {
                ...
                return (((float) Math.pow(2.0d, (-10.0f) * f)) * ((float) Math.sin((((double) (f - (0.047746483f * ((float) Math.asin(1.0d))))) * 6.283185307179586d) / ((double) 0.3f)))) + 1.0f;
            }
        };
        public static final EasingFunction EaseInOutElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.22
            ...
            public float getInterpolation(float f) {
                ...
                if (f2 < 1.0f) {
                    return ((float) Math.pow(2.0d, 10.0f * r11)) * ((float) Math.sin((((double) (((f2 - 1.0f) * 1.0f) - fAsin)) * 6.283185307179586d) / ((double) 0.45000002f))) * (-0.5f);
                }
                return (((float) Math.pow(2.0d, (-10.0f) * r11)) * ((float) Math.sin((((double) (((f2 - 1.0f) * 1.0f) - fAsin)) * 6.283185307179586d) / ((double) 0.45000002f))) * 0.5f) + 1.0f;
            }
        };
