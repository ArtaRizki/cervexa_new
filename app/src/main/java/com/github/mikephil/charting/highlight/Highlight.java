...
public class Highlight {
    ...
    private float f1957mX;
    private float mXPx;

    /* JADX INFO: renamed from: mY */
    private float f1958mY;
    private float mYPx;

    public Highlight(float f, float f2, int i) {
        this.f1957mX = Float.NaN;
        this.f1958mY = Float.NaN;
        this.mDataIndex = -1;
        this.mStackIndex = -1;
        this.f1957mX = f;
        this.f1958mY = f2;
    ...
    public boolean equalTo(Highlight highlight) {
        return highlight != null && this.mDataSetIndex == highlight.mDataSetIndex && this.f1957mX == highlight.f1957mX && this.mStackIndex == highlight.mStackIndex && this.mDataIndex == highlight.mDataIndex;
    }

    public String toString() {
        return "Highlight, x: " + this.f1957mX + ", y: " + this.f1958mY + ", dataSetIndex: " + this.mDataSetIndex + ", stackIndex (only stacked barentry): " + this.mStackIndex;
    }
}
