...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    protected void init() {
        ...
        paint.setColor(Color.rgb(TelnetCommand.f3467EC, 189, 51));
    ...
    protected void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                canvas.drawText(this.mNoDataText, center.f1970x, center.f1971y, this.mInfoPaint);
                return;
            }
            return;
        }
    ...
    protected void drawDescription(Canvas canvas) {
        ...
        if (position == null) {
            ...
            float f = position.f1970x;
            height = position.f1971y;
            width = f;
        }
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        int i2 = C10662.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()];
        ...
        if (i2 != 1) {
            if (i2 == 2) {
                ...
                if (!str.endsWith(UVCCameraHelper.SUFFIX_JPEG) && !str.endsWith(".jpeg")) {
                    str = str + UVCCameraHelper.SUFFIX_JPEG;
                }
                str4 = "image/jpeg";
            }
    ...
    /* JADX INFO: renamed from: com.github.mikephil.charting.charts.Chart$2 */
    static /* synthetic */ class C10662 {
