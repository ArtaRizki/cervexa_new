    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            for (int i2 = !this.mYAxis.isDrawBottomYLabelEntryEnabled() ? 1 : 0; i2 < i; i2++) {
                ...
                canvas.drawText(this.mYAxis.getFormattedLabel(i2), mPPointF.f1970x + 10.0f, mPPointF.f1971y, this.mAxisLabelPaint);
            }
        ...
        for (int i = 0; i < limitLines.size(); i++) {
            ...
            if (limitLine.isEnabled()) {
                ...
                for (int i2 = 0; i2 < ((RadarData) this.mChart.getData()).getMaxEntryCountSet().getEntryCount(); i2++) {
                    ...
                    if (i2 == 0) {
                        path.moveTo(mPPointF.f1970x, mPPointF.f1971y);
                    } else {
                        path.lineTo(mPPointF.f1970x, mPPointF.f1971y);
                    }
                }
                path.close();
