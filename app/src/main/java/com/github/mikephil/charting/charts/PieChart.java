...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public void calculateOffsets() {
        ...
        this.mCircleBox.set((centerOffsets.f1970x - diameter) + selectionShift, (centerOffsets.f1971y - diameter) + selectionShift, (centerOffsets.f1970x + diameter) - selectionShift, (centerOffsets.f1971y + diameter) - selectionShift);
    ...
    protected float[] getMarkerPosition(Highlight highlight) {
        ...
        double d = f;
        float fCos = (float) ((Math.cos(Math.toRadians(((this.mAbsoluteAngles[r11] + rotationAngle) - f2) * this.mAnimator.getPhaseY())) * d) + ((double) centerCircleBox.f1970x));
        float fSin = (float) ((d * Math.sin(Math.toRadians(((rotationAngle + this.mAbsoluteAngles[r11]) - f2) * this.mAnimator.getPhaseY()))) + ((double) centerCircleBox.f1971y));
    ...
    public void setCenterTextOffset(float f, float f2) {
        this.mCenterTextOffset.f1970x = Utils.convertDpToPixel(f);
        this.mCenterTextOffset.f1971y = Utils.convertDpToPixel(f2);
    }

    public MPPointF getCenterTextOffset() {
        return MPPointF.getInstance(this.mCenterTextOffset.f1970x, this.mCenterTextOffset.f1971y);
    }
