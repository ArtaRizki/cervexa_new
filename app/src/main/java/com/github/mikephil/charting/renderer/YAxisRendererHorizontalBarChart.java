...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    protected void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f1968x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f1968x) - 1.0f, this.mViewPortHandler.contentBottom());
