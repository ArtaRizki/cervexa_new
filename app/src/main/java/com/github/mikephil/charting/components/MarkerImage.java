...
public class MarkerImage implements IMarker {
    ...
    public MPPointF getOffsetForDrawingAtPoint(float f, float f2) {
        ...
        } else if (chartView != null && f + intrinsicWidth + this.mOffset2.f1970x > chartView.getWidth()) {
            this.mOffset2.f1970x = (chartView.getWidth() - f) - intrinsicWidth;
        }
        if (this.mOffset2.f1971y + f2 < 0.0f) {
            this.mOffset2.f1971y = -f2;
        } else if (chartView != null && f2 + intrinsicHeight + this.mOffset2.f1971y > chartView.getHeight()) {
            this.mOffset2.f1971y = (chartView.getHeight() - f2) - intrinsicHeight;
        }
