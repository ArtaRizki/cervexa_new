...
public class CombinedChartRenderer extends DataRenderer {
    ...
    public void createRenderers() {
        ...
        for (CombinedChart.DrawOrder drawOrder : combinedChart.getDrawOrder()) {
            int i = C10721.f1963x2dab6d3b[drawOrder.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
    ...
    /* JADX INFO: renamed from: com.github.mikephil.charting.renderer.CombinedChartRenderer$1 */
    static /* synthetic */ class C10721 {

        /* JADX INFO: renamed from: $SwitchMap$com$github$mikephil$charting$charts$CombinedChart$DrawOrder */
        static final /* synthetic */ int[] f1963x2dab6d3b;
        ...
        static {
            ...
            try {
                f1963x2dab6d3b[CombinedChart.DrawOrder.BUBBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1963x2dab6d3b[CombinedChart.DrawOrder.LINE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1963x2dab6d3b[CombinedChart.DrawOrder.CANDLE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1963x2dab6d3b[CombinedChart.DrawOrder.SCATTER.ordinal()] = 5;
