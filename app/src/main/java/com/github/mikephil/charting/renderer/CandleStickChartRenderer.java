            ...
            for (int i2 = 0; i2 < dataSets.size(); i2++) {
                ...
                if (shouldDrawValues(iCandleDataSet)) {
                    ...
                    while (i3 < fArrGenerateTransformedValuesCandle.length) {
                        float f = fArrGenerateTransformedValuesCandle[i3];
                        float f2 = fArrGenerateTransformedValuesCandle[i3 + 1];
                        ...
                        if (this.mViewPortHandler.isInBoundsLeft(f) && this.mViewPortHandler.isInBoundsY(f2)) {
                            ...
                            i = i3;
                            drawValue(canvas, iCandleDataSet.getValueFormatter(), candleEntry.getHigh(), candleEntry, i2, f, f2 - fConvertDpToPixel, iCandleDataSet.getValueTextColor(i4));
                        } else {
                            i = i3;
                        }
                        i3 = i + 2;
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iLineScatterCandleRadarDataSet != null && iLineScatterCandleRadarDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(candleEntry, iLineScatterCandleRadarDataSet)) {
                    ...
                    drawHighlightLines(canvas, (float) pixelForValues.f1968x, (float) pixelForValues.f1969y, iLineScatterCandleRadarDataSet);
                }
            }
        }
    }
