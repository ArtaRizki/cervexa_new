...
public abstract class Utils {
    ...
    public static String formatNumber(float f, int i, boolean z, char c) {
        ...
        long jRound = Math.round(f2 * POW_10[length]);
        int i3 = 34;
        long j = jRound;
        boolean z4 = false;
        while (true) {
    ...
    public static void drawXAxisValue(Canvas canvas, String str, float f, float f2, Paint paint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (mPPointF.f1970x != 0.5f || mPPointF.f1971y != 0.5f) {
                FSize sizeOfRotatedRectangleByDegrees = getSizeOfRotatedRectangleByDegrees(mDrawTextRectBuffer.width(), fontMetrics, f3);
                f -= sizeOfRotatedRectangleByDegrees.width * (mPPointF.f1970x - 0.5f);
                f2 -= sizeOfRotatedRectangleByDegrees.height * (mPPointF.f1971y - 0.5f);
            ...
            if (mPPointF.f1970x != 0.0f || mPPointF.f1971y != 0.0f) {
                fWidth -= mDrawTextRectBuffer.width() * mPPointF.f1970x;
                f4 -= fontMetrics * mPPointF.f1971y;
            }
    ...
    public static void drawMultilineText(Canvas canvas, StaticLayout staticLayout, float f, float f2, TextPaint textPaint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (mPPointF.f1970x != 0.0f || mPPointF.f1971y != 0.0f) {
                f4 -= width * mPPointF.f1970x;
                f5 -= lineCount * mPPointF.f1971y;
            }
            canvas.save();
