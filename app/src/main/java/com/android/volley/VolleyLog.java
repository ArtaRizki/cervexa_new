...
public class VolleyLog {
    ...
    public static void setTag(String str) {
        m17d("Changing log tag to %s", str);
        TAG = str;
    ...
    public static void m17d(String str, Object... objArr) {
    ...
    /* JADX INFO: renamed from: e */
    public static void m19e(Throwable th, String str, Object... objArr) {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String str) {
            ...
            VolleyLog.m17d("(%-4d ms) %s", Long.valueOf(totalDuration), str);
            for (Marker marker : this.mMarkers) {
                long j2 = marker.time;
                VolleyLog.m17d("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(marker.thread), marker.name);
                j = j2;
            }
        }
        ...
        protected void finalize() throws Throwable {
            ...
            VolleyLog.m18e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
        }
