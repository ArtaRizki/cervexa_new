...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSuffix = "%";
        this.mPrefix = "";
        this.default_text_color = Color.rgb(66, 145, TelnetCommand.NOP);
        this.default_reached_color = Color.rgb(66, 145, TelnetCommand.NOP);
        ...
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0942R.styleable.NumberProgressBar, i, 0);
        this.mReachedBarColor = typedArrayObtainStyledAttributes.getColor(C0942R.styleable.NumberProgressBar_progress_reached_color, this.default_reached_color);
        this.mUnreachedBarColor = typedArrayObtainStyledAttributes.getColor(C0942R.styleable.NumberProgressBar_progress_unreached_color, this.default_unreached_color);
        this.mTextColor = typedArrayObtainStyledAttributes.getColor(C0942R.styleable.NumberProgressBar_progress_text_color, this.default_text_color);
        this.mTextSize = typedArrayObtainStyledAttributes.getDimension(C0942R.styleable.NumberProgressBar_progress_text_size, this.default_text_size);
        this.mReachedBarHeight = typedArrayObtainStyledAttributes.getDimension(C0942R.styleable.NumberProgressBar_progress_reached_bar_height, this.default_reached_bar_height);
        this.mUnreachedBarHeight = typedArrayObtainStyledAttributes.getDimension(C0942R.styleable.NumberProgressBar_progress_unreached_bar_height, this.default_unreached_bar_height);
        this.mOffset = typedArrayObtainStyledAttributes.getDimension(C0942R.styleable.NumberProgressBar_progress_text_offset, this.default_progress_text_offset);
        if (typedArrayObtainStyledAttributes.getInt(C0942R.styleable.NumberProgressBar_progress_text_visibility, 0) != 0) {
            this.mIfDrawText = false;
        }
        setProgress(typedArrayObtainStyledAttributes.getInt(C0942R.styleable.NumberProgressBar_progress_current, 0));
        setMax(typedArrayObtainStyledAttributes.getInt(C0942R.styleable.NumberProgressBar_progress_max, 100));
