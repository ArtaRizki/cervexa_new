package com.tencent.p023mm.opensdk.channel;
...
public class MMessageActV2 {
    ...
    public static boolean send(Context context, Args args) {
        ...
        if (context == null || args == null) {
        ...
        } else if (C2052d.m2059a(args.targetPkgName)) {
            str = "send fail, invalid targetPkgName, targetPkgName = " + args.targetPkgName;
        } else {
            if (C2052d.m2059a(args.targetClassName)) {
                args.targetClassName = args.targetPkgName + DEFAULT_ENTRY_CLASS_NAME;
            }
            Log.m2050d(TAG, "send, targetPkgName = " + args.targetPkgName + ", targetClassName = " + args.targetClassName);
            ...
            intent.putExtra(ConstantsAPI.CHECK_SUM, C2041b.m2037a(args.content, 620823552, packageName));
            if (args.flags == -1) {
            ...
            try {
                ...
                Log.m2050d(TAG, "send mm message, intent=" + intent);
                return true;
            } catch (Exception e) {
