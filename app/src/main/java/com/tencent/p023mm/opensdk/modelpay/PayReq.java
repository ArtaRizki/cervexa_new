package com.tencent.p023mm.opensdk.modelpay;
...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C2049a.m2056b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C2049a.m2055a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C2049a.m2056b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C2049a.m2056b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C2049a.m2056b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C2049a.m2056b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C2049a.m2056b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C2049a.m2056b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C2049a.m2056b(bundle, "_wxapi_payreq_sign");
        this.extData = C2049a.m2056b(bundle, "_wxapi_payreq_extdata");
        this.signType = C2049a.m2056b(bundle, "_wxapi_payreq_sign_type");
