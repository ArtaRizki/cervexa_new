...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (strPathOldToNew != null && strPathOldToNew.length() > 0) {
                try {
                    ...
                    Log.m2051e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + strPathOldToNew + ", ex = " + e.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            Log.m2051e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        private static String pathOldToNew(String str) {
            Log.m2052i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m2051e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            ...
            Log.m2051e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = " + str);
            return str;
        }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m2051e(TAG, "setThumbImage exception:" + e.getMessage());
        }
    }
}
