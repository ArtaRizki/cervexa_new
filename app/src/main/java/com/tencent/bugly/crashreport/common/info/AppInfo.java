...
public class AppInfo {
    ...
    private static ActivityManager f2352a;
    ...
    /* JADX INFO: renamed from: a */
    public static String m1463a(Context context) {
        if (context == null) {
            return null;
        }
        try {
    ...
    public static PackageInfo m1466b(Context context) {
        try {
            return context.getPackageManager().getPackageInfo(m1463a(context), 0);
        } catch (Throwable th) {
            if (C2021x.m1867a(th)) {
                return null;
            }
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m1465a(Context context, String str) {
    ...
    /* JADX INFO: renamed from: a */
    public static String m1462a(int i) {
    ...
    public static String m1467c(Context context) {
    ...
    public static Map<String, String> m1468d(Context context) {
        if (context == null) {
            return null;
        }
        try {
    ...
    /* JADX INFO: renamed from: a */
    public static List<String> m1464a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
        try {
    ...
    public static boolean m1469e(Context context) {
        if (context == null) {
            return false;
        }
        if (f2352a == null) {
            f2352a = (ActivityManager) context.getSystemService("activity");
        }
        try {
            ActivityManager.MemoryInfo memoryInfo = new ActivityManager.MemoryInfo();
            f2352a.getMemoryInfo(memoryInfo);
            if (!memoryInfo.lowMemory) {
                return false;
            }
            C2021x.m1871c("Memory is low.", new Object[0]);
            return true;
        } catch (Throwable th) {
            if (!C2021x.m1867a(th)) {
                th.printStackTrace();
