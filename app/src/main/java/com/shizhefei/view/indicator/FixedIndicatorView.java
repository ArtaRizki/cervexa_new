...
public class FixedIndicatorView extends LinearLayout implements Indicator {
    ...
    public void setScrollBar(ScrollBar scrollBar) {
        ...
        if (this.scrollBar != null) {
            int i = C19323.f2265x2bb83862[this.scrollBar.getGravity().ordinal()];
            if (i == 1) {
        ...
        int i2 = C19323.f2265x2bb83862[this.scrollBar.getGravity().ordinal()];
        if (i2 == 1) {
            paddingBottom += scrollBar.getHeight(getHeight());
        } else if (i2 == 2) {
            paddingTop += scrollBar.getHeight(getHeight());
    ...
    /* JADX INFO: renamed from: com.shizhefei.view.indicator.FixedIndicatorView$3 */
    static /* synthetic */ class C19323 {

        /* JADX INFO: renamed from: $SwitchMap$com$shizhefei$view$indicator$slidebar$ScrollBar$Gravity */
        static final /* synthetic */ int[] f2265x2bb83862;
        ...
        static {
            ...
            try {
                f2265x2bb83862[ScrollBar.Gravity.TOP_FLOAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2265x2bb83862[ScrollBar.Gravity.CENTENT_BACKGROUND.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2265x2bb83862[ScrollBar.Gravity.CENTENT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f2265x2bb83862[ScrollBar.Gravity.TOP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f2265x2bb83862[ScrollBar.Gravity.BOTTOM.ordinal()] = 6;
