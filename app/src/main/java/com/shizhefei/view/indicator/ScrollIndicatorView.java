...
public class ScrollIndicatorView extends HorizontalScrollView implements Indicator {
    ...
    private void drawScrollBar(Canvas canvas) {
        ...
        int iSave = canvas.save();
        int i = C19463.f2267x2bb83862[scrollBar.getGravity().ordinal()];
        if (i == 1 || i == 2) {
    ...
    /* JADX INFO: renamed from: com.shizhefei.view.indicator.ScrollIndicatorView$3 */
    static /* synthetic */ class C19463 {

        /* JADX INFO: renamed from: $SwitchMap$com$shizhefei$view$indicator$slidebar$ScrollBar$Gravity */
        static final /* synthetic */ int[] f2267x2bb83862;
        ...
        static {
            ...
            try {
                f2267x2bb83862[ScrollBar.Gravity.CENTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2267x2bb83862[ScrollBar.Gravity.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2267x2bb83862[ScrollBar.Gravity.TOP_FLOAT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f2267x2bb83862[ScrollBar.Gravity.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f2267x2bb83862[ScrollBar.Gravity.BOTTOM_FLOAT.ordinal()] = 6;
