...
public final class HttpUrl {
    ...
    public String encodedQuery() {
        ...
        String str = this.url;
        return this.url.substring(iIndexOf, Util.delimiterOffset(str, iIndexOf + 1, str.length(), '#'));
    }
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C25611.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parseResult.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i == 2) {
    ...
    /* JADX INFO: renamed from: okhttp3.HttpUrl$1 */
    static /* synthetic */ class C25611 {
    ...
    public static final class Builder {
        ...
        ParseResult parse(@Nullable HttpUrl httpUrl, String str) {
                ...
                while (true) {
                    ...
                    if (bCharAt == 64) {
                        if (!z) {
                            ...
                            i = iDelimiterOffset;
                            String strCanonicalize = HttpUrl.canonicalize(str, i2, iDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                            if (z2) {
                                strCanonicalize = this.encodedUsername + "%40" + strCanonicalize;
                            }
                            this.encodedUsername = strCanonicalize;
                            if (iDelimiterOffset2 != i) {
                                this.encodedPassword = HttpUrl.canonicalize(str, iDelimiterOffset2 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                                z = true;
                            }
                            z2 = true;
                        } else {
            ...
            if (iDelimiterOffset3 < iSkipTrailingAsciiWhitespace && str.charAt(iDelimiterOffset3) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, 1 + iDelimiterOffset3, iSkipTrailingAsciiWhitespace, "", true, false, false, false);
            }
        ...
        private void push(String str, int i, int i2, boolean z, boolean z2) {
            ...
            if (this.encodedPathSegments.get(r10.size() - 1).isEmpty()) {
                this.encodedPathSegments.set(r10.size() - 1, strCanonicalize);
            } else {
        ...
        private static String canonicalizeHost(String str, int i, int i2) {
            ...
            return Util.domainToAscii(strPercentDecode);
        }
        ...
        */
        ...
        private static int parsePort(String str, int i, int i2) {
            int i3;
            try {
                i3 = Integer.parseInt(HttpUrl.canonicalize(str, i, i2, "", false, false, false, true));
        ...
        while (iCharCount < i2) {
            ...
            if (iCodePointAt >= 32 && iCodePointAt != 127 && (iCodePointAt < 128 || !z4)) {
                if (str2.indexOf(iCodePointAt) == -1 && ((iCodePointAt != 37 || (z && (!z2 || percentEncoded(str, iCharCount, i2)))) && (iCodePointAt != 43 || !z3))) {
                    ...
                    canonicalize(buffer, str, iCharCount, i2, str2, z, z2, z3, z4);
                    return buffer.readUtf8();
                }
            } else {
                Buffer buffer2 = new Buffer();
                buffer2.writeUtf8(str, i, iCharCount);
                canonicalize(buffer2, str, iCharCount, i2, str2, z, z2, z3, z4);
