...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        int i4 = this.pos;
        if (i4 >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f3449dn);
        }
        this.end = i4;
        if (this.chars[i4] == ' ') {
            while (true) {
    ...
    */
    private java.lang.String hexAV() {
        ...
        L90:
            ...
            r1.<init>()
            r1.append(r3)
            java.lang.String r2 = r6.f3449dn
            r1.append(r2)
    ...
    */
    ...
    private int getByte(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f3449dn);
        }
        char c = this.chars[i];
        if (c >= '0' && c <= '9') {
            i2 = c - '0';
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f3449dn.toCharArray();
