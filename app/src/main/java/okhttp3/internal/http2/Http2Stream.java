...
public final class Http2Stream {
    ...
    public boolean isLocallyInitiated() {
        return this.connection.client == ((this.f3448id & 1) == 1);
    }
    ...
    public void sendResponseHeaders(List<Header> list, boolean z) throws IOException {
        ...
        this.connection.writeSynReply(this.f3448id, z2, list);
        if (z2) {
    ...
    public void close(ErrorCode errorCode) throws IOException {
        if (closeInternal(errorCode)) {
            this.connection.writeSynReset(this.f3448id, errorCode);
        }
    }

    public void closeLater(ErrorCode errorCode) {
        if (closeInternal(errorCode)) {
            this.connection.writeSynResetLater(this.f3448id, errorCode);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f3448id);
            return true;
        }
    }
        ...
        public long read(Buffer buffer, long j) throws IOException {
            ...
            synchronized (Http2Stream.this) {
                ...
                if (Http2Stream.this.unacknowledgedBytesRead >= Http2Stream.this.connection.okHttpSettings.getInitialWindowSize() / 2) {
                    Http2Stream.this.connection.writeWindowUpdateLater(Http2Stream.this.f3448id, Http2Stream.this.unacknowledgedBytesRead);
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f3448id, z && jMin == this.sendBuffer.size(), this.sendBuffer, jMin);
            } finally {
            }
        }
            ...
            synchronized (Http2Stream.this) {
                ...
                if (!Http2Stream.this.sink.finished) {
                    if (this.sendBuffer.size() > 0) {
                        ...
                        Http2Stream.this.connection.writeData(Http2Stream.this.f3448id, true, null, 0L);
                    }
                }
                synchronized (Http2Stream.this) {
                    this.closed = true;
