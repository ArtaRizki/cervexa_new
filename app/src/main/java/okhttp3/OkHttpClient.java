...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder connectTimeout(long j, TimeUnit timeUnit) {
            this.connectTimeout = checkDuration(TopicKey.TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder readTimeout(long j, TimeUnit timeUnit) {
            this.readTimeout = checkDuration(TopicKey.TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder writeTimeout(long j, TimeUnit timeUnit) {
            this.writeTimeout = checkDuration(TopicKey.TIMEOUT, j, timeUnit);
            return this;
        }
        ...
        public Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory) {
            ...
            X509TrustManager x509TrustManagerTrustManager = Platform.get().trustManager(sSLSocketFactory);
            if (x509TrustManagerTrustManager == null) {
                throw new IllegalStateException("Unable to extract the trust manager on " + Platform.get() + ", sslSocketFactory is " + sSLSocketFactory.getClass());
            }
            this.sslSocketFactory = sSLSocketFactory;
            this.certificateChainCleaner = CertificateChainCleaner.get(x509TrustManagerTrustManager);
            return this;
        }
