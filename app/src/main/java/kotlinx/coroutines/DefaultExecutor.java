...
public final class DefaultExecutor extends EventLoopImplBase implements Runnable {
    ...
    static {
        ...
        try {
            lValueOf = Long.getLong("kotlinx.coroutines.DefaultExecutor.keepAlive", DEFAULT_KEEP_ALIVE);
        } catch (SecurityException unused) {
            lValueOf = Long.valueOf(DEFAULT_KEEP_ALIVE);
        }
