...
public final class TestCoroutineContext implements CoroutineContext {
    ...
    public TestCoroutineContext(String str) {
        ...
        this.ctxHandler = new C2548x96bc1e17(CoroutineExceptionHandler.INSTANCE, this);
        ...
        while (true) {
            ...
            synchronized (threadSafeHeap) {
                ...
                if (threadSafeHeapNodeFirstImpl != null) {
                    threadSafeHeapNodeRemoveAtImpl = (((TimedRunnable) threadSafeHeapNodeFirstImpl).time > targetTime ? 1 : (((TimedRunnable) threadSafeHeapNodeFirstImpl).time == targetTime ? 0 : -1)) <= 0 ? threadSafeHeap.removeAtImpl(0) : null;
                }
            }
    ...
    /* JADX INFO: compiled from: TestCoroutineContext.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u00012\u00020\u0002B\u0005¢\u0006\u0002\u0010\u0003J\u001c\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\n\u0010\b\u001a\u00060\tj\u0002`\nH\u0016J\u001c\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\n\u0010\b\u001a\u00060\tj\u0002`\nH\u0016J\b\u0010\u000f\u001a\u00020\u000eH\u0016J\u001e\u0010\u0010\u001a\u00020\u00052\u0006\u0010\r\u001a\u00020\u000e2\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00050\u0012H\u0016J\b\u0010\u0013\u001a\u00020\u0014H\u0016J\b\u0010\u0015\u001a\u00020\u0016H\u0016¨\u0006\u0017"}, m2290d2 = {"Lkotlinx/coroutines/test/TestCoroutineContext$Dispatcher;", "Lkotlinx/coroutines/EventLoop;", "Lkotlinx/coroutines/Delay;", "(Lkotlinx/coroutines/test/TestCoroutineContext;)V", "dispatch", "", "context", "Lkotlin/coroutines/CoroutineContext;", "block", "Ljava/lang/Runnable;", "Lkotlinx/coroutines/Runnable;", "invokeOnTimeout", "Lkotlinx/coroutines/DisposableHandle;", "timeMillis", "", "processNextEvent", "scheduleResumeAfterDelay", "continuation", "Lkotlinx/coroutines/CancellableContinuation;", "shouldBeProcessedFromContext", "", "toString", "", "kotlinx-coroutines-core"}, m2291k = 1, m2292mv = {1, 4, 0})
    private final class Dispatcher extends EventLoop implements Delay {
        ...
        public void mo3708dispatch(CoroutineContext context, Runnable block) {
            TestCoroutineContext.this.enqueue(block);
        }

        @Override // kotlinx.coroutines.Delay
        /* JADX INFO: renamed from: scheduleResumeAfterDelay */
        public void mo3709scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
            TestCoroutineContext.this.postDelayed(new Runnable() { // from class: kotlinx.coroutines.test.TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$$inlined$Runnable$1
                ...
                public final void run() {
                    continuation.resumeUndispatched(this.this$0, Unit.INSTANCE);
                }
            }, timeMillis);
        }
        ...
        public DisposableHandle invokeOnTimeout(long timeMillis, Runnable block) {
            ...
            return new DisposableHandle() { // from class: kotlinx.coroutines.test.TestCoroutineContext$Dispatcher$invokeOnTimeout$1
                ...
                public void dispose() {
                    TestCoroutineContext.this.queue.remove(timedRunnablePostDelayed);
                }
            };
        }
