...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo3708dispatch(CoroutineContext context, Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo3708dispatch(context, block);
        }
    }
