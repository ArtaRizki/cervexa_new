...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final /* synthetic */ Job m3671Job(Job job) {
        return JobKt.Job(job);
    }

    /* JADX INFO: renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m3672Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = (Job) null;
        }
        return m3671Job(job);
