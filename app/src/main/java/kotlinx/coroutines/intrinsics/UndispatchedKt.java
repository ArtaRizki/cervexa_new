        ...
        try {
            if (function1 != null) {
                ...
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    continuationProbeCoroutineCreated.resumeWith(Result.m2353constructorimpl(objInvoke));
                    return;
                }
                return;
            }
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m2353constructorimpl(ResultKt.createFailure(th)));
        }
    }
