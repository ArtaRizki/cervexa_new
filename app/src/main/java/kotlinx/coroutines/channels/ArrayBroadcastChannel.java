...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
        ...
        while (true) {
            ...
            while (j2 < jCoerceAtMost) {
                ...
                if (z) {
                    ...
                    objArr[i2] = sendTakeFirstSendOrPeekClosed.getPollResult();
                    setSize(i + 1);
                    setTail(j + 1);
                    Unit unit = Unit.INSTANCE;
                    reentrantLock.unlock();
    ...
    private final long computeMinHead() {
        Iterator<Subscriber<E>> it = this.subscribers.iterator();
        long jCoerceAtMost = LongCompanionObject.MAX_VALUE;
        while (it.hasNext()) {
    ...
    private static final class Subscriber<E> extends AbstractChannel<E> implements ReceiveChannel<E> {
        ...
        protected Object pollInternal() {
            ...
            try {
                ...
                reentrantLock.unlock();
                Closed closed = (Closed) (!(objPeekUnderLock instanceof Closed) ? null : objPeekUnderLock);
                if (closed != null) {
                    close(closed.closeCause);
                }
