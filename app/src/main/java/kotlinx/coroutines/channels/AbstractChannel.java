...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final Object receiveOrNull(Continuation<? super E> continuation) {
        Object objPollInternal = pollInternal();
        return (objPollInternal == AbstractChannelKt.POLL_FAILED || (objPollInternal instanceof Closed)) ? receiveSuspend(1, continuation) : objPollInternal;
    }
    ...
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: receiveOrClosed-ZYPwvRU, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object mo3677receiveOrClosedZYPwvRU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ValueOrClosed<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L38:
            ...
            r0.<init>(r5)
            java.lang.Object r5 = kotlinx.coroutines.channels.ValueOrClosed.m3680constructorimpl(r0)
            goto L5d
        L57:
            kotlinx.coroutines.channels.ValueOrClosed$Companion r0 = kotlinx.coroutines.channels.ValueOrClosed.INSTANCE
            java.lang.Object r5 = kotlinx.coroutines.channels.ValueOrClosed.m3680constructorimpl(r5)
        L5d:
            return r5
        L5e:
            r2 = 2
        ...
        L6c:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo3677receiveOrClosedZYPwvRU(kotlin.coroutines.Continuation):java.lang.Object");
    }
        ...
        while (true) {
            ...
            if (prevNode instanceof LockFreeLinkedListHead) {
                ...
                if (!(objM3700constructorimpl$default instanceof ArrayList)) {
                    ((Send) objM3700constructorimpl$default).resumeSendClosed(closedForSend);
                    return;
                }
                if (objM3700constructorimpl$default != null) {
            ...
            if (!prevNode.remove()) {
                ...
                objM3700constructorimpl$default = InlineList.m3705plusUZ7vuAc(objM3700constructorimpl$default, (Send) prevNode);
            }
        }
    }
    ...
    /* JADX INFO: compiled from: AbstractChannel.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u00004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0001\u0010\u00012\u0012\u0012\u0004\u0012\u00020\u00030\u0002j\b\u0012\u0004\u0012\u00020\u0003`\u0004B\r\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0012\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0014J\u0016\u0010\f\u001a\u0004\u0018\u00010\t2\n\u0010\r\u001a\u00060\u000ej\u0002`\u000fH\u0016¨\u0006\u0010"}, m2290d2 = {"Lkotlinx/coroutines/channels/AbstractChannel$TryPollDesc;", "E", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$RemoveFirstDesc;", "Lkotlinx/coroutines/channels/Send;", "Lkotlinx/coroutines/internal/RemoveFirstDesc;", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "(Lkotlinx/coroutines/internal/LockFreeLinkedListHead;)V", "failure", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "onPrepare", "prepareOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "Lkotlinx/coroutines/internal/PrepareOp;", "kotlinx-coroutines-core"}, m2291k = 1, m2292mv = {1, 4, 0})
    protected static final class TryPollDesc<E> extends LockFreeLinkedListNode.RemoveFirstDesc<Send> {
        ...
        public Object onPrepare(LockFreeLinkedListNode.PrepareOp prepareOp) {
            ...
            Symbol symbolTryResumeSend = ((Send) lockFreeLinkedListNode).tryResumeSend(prepareOp);
    ...
    public final SelectClause1<ValueOrClosed<E>> getOnReceiveOrClosed() {
        return new SelectClause1<ValueOrClosed<? extends E>>() { // from class: kotlinx.coroutines.channels.AbstractChannel$onReceiveOrClosed$1
            @Override // kotlinx.coroutines.selects.SelectClause1
            public <R> void registerSelectClause1(SelectInstance<? super R> select, Function2<? super ValueOrClosed<? extends E>, ? super Continuation<? super R>, ? extends Object> block) throws Throwable {
                AbstractChannel abstractChannel = this.this$0;
                if (block == null) {
                    throw new NullPointerException("null cannot be cast to non-null type suspend (kotlin.Any?) -> R");
                }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) throws Throwable {
        Object objM3680constructorimpl;
        ...
        if (!z) {
            ...
            if (z) {
                objM3680constructorimpl = ValueOrClosed.m3680constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause));
            } else {
                objM3680constructorimpl = ValueOrClosed.m3680constructorimpl(obj);
            }
            UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m3679boximpl(objM3680constructorimpl), selectInstance.getCompletion());
            return;
        }
        if (i == 0) {
        ...
        if (i != 1) {
            if (i == 2 && selectInstance.trySelect()) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m3679boximpl(ValueOrClosed.m3680constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause))), selectInstance.getCompletion());
                return;
            }
            return;
        }
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m2353constructorimpl(boolBoxBoolean));
                    } else {
                        Throwable receiveException = closed.getReceiveException();
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m2353constructorimpl(ResultKt.createFailure(receiveException)));
                    }
                } else if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boolBoxBoolean2 = Boxing.boxBoolean(true);
                    Result.Companion companion3 = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m2353constructorimpl(boolBoxBoolean2));
                    break;
                }
            }
    ...
    private static final class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
            return ValueOrClosed.m3679boximpl(ValueOrClosed.m3680constructorimpl(value));
        }

        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public Symbol tryResumeReceive(E value, LockFreeLinkedListNode.PrepareOp otherOp) {
            Object objTryResume = this.cont.tryResume(resumeValue(value), otherOp != null ? otherOp.desc : null);
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1 && closed.closeCause == null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m2353constructorimpl(null));
            } else {
                if (this.receiveMode != 2) {
                    CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                    Throwable receiveException = closed.getReceiveException();
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m2353constructorimpl(ResultKt.createFailure(receiveException)));
                    return;
                }
                ...
                ValueOrClosed valueOrClosedM3679boximpl = ValueOrClosed.m3679boximpl(ValueOrClosed.m3680constructorimpl(new ValueOrClosed.Closed(closed.closeCause)));
                Result.Companion companion4 = Result.INSTANCE;
                cancellableContinuation3.resumeWith(Result.m2353constructorimpl(valueOrClosedM3679boximpl));
            }
        }
    ...
    private static final class ReceiveHasNext<E> extends Receive<E> {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public Symbol tryResumeReceive(E value, LockFreeLinkedListNode.PrepareOp otherOp) {
            Object objTryResume = this.cont.tryResume(true, otherOp != null ? otherOp.desc : null);
            if (objTryResume == null) {
                return null;
            }
            if (DebugKt.getASSERTIONS_ENABLED()) {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            if (closed.closeCause == null) {
                ...
                objTryResumeWithException = cancellableContinuation.tryResumeWithException(receiveException);
            }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) {
            ...
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
                value = (E) ValueOrClosed.m3679boximpl(ValueOrClosed.m3680constructorimpl(value));
            }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
                ContinuationKt.startCoroutine(function2, ValueOrClosed.m3679boximpl(ValueOrClosed.m3680constructorimpl(new ValueOrClosed.Closed(closed.closeCause))), this.select.getCompletion());
            }
        }
        ...
        if (cancellableContinuationImpl != null) {
            ...
            while (true) {
                ...
                if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m2353constructorimpl(objResumeValue));
                    break;
                }
            }
            Object result = orCreateCancellableContinuation.getResult();
