...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    /* JADX INFO: renamed from: receiveOrClosed-ZYPwvRU$suspendImpl, reason: not valid java name */
    static /* synthetic */ Object m3678receiveOrClosedZYPwvRU$suspendImpl(ChannelCoroutine channelCoroutine, Continuation continuation) {
        return channelCoroutine._channel.mo3677receiveOrClosedZYPwvRU(continuation);
    }
    ...
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: receiveOrClosed-ZYPwvRU */
    public Object mo3677receiveOrClosedZYPwvRU(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        return m3678receiveOrClosedZYPwvRU$suspendImpl(this, continuation);
    }
    ...
    public final Object sendFair(E e, Continuation<? super Unit> continuation) {
        ...
        Object objSendFair$kotlinx_coroutines_core = ((AbstractSendChannel) channel).sendFair$kotlinx_coroutines_core(e, continuation);
        return objSendFair$kotlinx_coroutines_core == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objSendFair$kotlinx_coroutines_core : Unit.INSTANCE;
    }
}
