...
class DeferredCoroutine<T> extends AbstractCoroutine<T> implements Deferred<T>, SelectClause1<T> {
    ...
    @DebugMetadata(m2298c = "kotlinx.coroutines.DeferredCoroutine", m2299f = "Builders.common.kt", m2300i = {0}, m2301l = {101}, m2302m = "await$suspendImpl", m2303n = {"this"}, m2304s = {"L$0"})
    static final class C22391 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C22391(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    static /* synthetic */ java.lang.Object await$suspendImpl(kotlinx.coroutines.DeferredCoroutine r4, kotlin.coroutines.Continuation r5) {
        /*
            boolean r0 = r5 instanceof kotlinx.coroutines.DeferredCoroutine.C22391
            if (r0 == 0) goto L14
            r0 = r5
            kotlinx.coroutines.DeferredCoroutine$await$1 r0 = (kotlinx.coroutines.DeferredCoroutine.C22391) r0
            int r1 = r0.label
