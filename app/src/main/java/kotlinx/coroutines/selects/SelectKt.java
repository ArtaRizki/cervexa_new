...
public final class SelectKt {
    ...
    /* JADX INFO: renamed from: onTimeout-0lHKgQg, reason: not valid java name */
    public static final <R> void m3720onTimeout0lHKgQg(SelectBuilder<? super R> selectBuilder, double d, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        selectBuilder.onTimeout(DelayKt.m3668toDelayMillisLRDsOJo(d), function1);
    }
