...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$2<T> implements Flow<T> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Object objCollect = this.$this_distinctUntilChangedBy$inlined.collect(new C2383x4e1b3e0c(flowCollector, objectRef, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C2383x4e1b3e0c c2383x4e1b3e0c = new C2383x4e1b3e0c(flowCollector, objectRef, this);
        InlineMarker.mark(0);
        flow.collect(c2383x4e1b3e0c, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
