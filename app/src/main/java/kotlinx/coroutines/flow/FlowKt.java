...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m3692catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m3697catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m3693debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m3695debounce8GFy2Ro(flow, d);
    }
    ...
    public static final <T> Flow<T> m3694sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m3696sample8GFy2Ro(flow, d);
    }
