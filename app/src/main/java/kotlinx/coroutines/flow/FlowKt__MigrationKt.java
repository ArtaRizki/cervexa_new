...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$onErrorReturn$2", m2299f = "Migration.kt", m2300i = {0, 0}, m2301l = {StatusLine.HTTP_PERM_REDIRECT}, m2302m = "invokeSuspend", m2303n = {"$this$catch", "e"}, m2304s = {"L$0", "L$1"})
    static final class C24472<T> extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
        ...
        private FlowCollector f3403p$;
        private Throwable p$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24472(Function1 function1, Object obj, Continuation continuation) {
        ...
        public final Continuation<Unit> create(FlowCollector<? super T> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
            C24472 c24472 = new C24472(this.$predicate, this.$fallback, continuation);
            c24472.f3403p$ = flowCollector;
            c24472.p$0 = th;
            return c24472;
        }
        ...
        public final Object invoke(Object obj, Throwable th, Continuation<? super Unit> continuation) {
            return ((C24472) create((FlowCollector) obj, th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = this.f3403p$;
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m3692catch(flow, new C24472(function1, t, null));
    }
    ...
    /* JADX INFO: compiled from: Migration.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, m2290d2 = {"<anonymous>", "", NDEFRecord.TEXT_WELL_KNOWN_TYPE, "Lkotlinx/coroutines/flow/FlowCollector;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m2291k = 3, m2292mv = {1, 4, 0})
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayFlow$1", m2299f = "Migration.kt", m2300i = {0}, m2301l = {413}, m2302m = "invokeSuspend", m2303n = {"$this$onStart"}, m2304s = {"L$0"})
    static final class C24451<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        Object L$0;
        int label;

        /* JADX INFO: renamed from: p$ */
        private FlowCollector f3402p$;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24451(long j, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C24451 c24451 = new C24451(this.$timeMillis, continuation);
            c24451.f3402p$ = (FlowCollector) obj;
            return c24451;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C24451) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                FlowCollector flowCollector = this.f3402p$;
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long j) {
        return FlowKt.onStart(flow, new C24451(j, null));
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1 */
    /* JADX INFO: compiled from: Migration.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, m2290d2 = {"<anonymous>", "", NDEFRecord.TEXT_WELL_KNOWN_TYPE, "it", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m2291k = 3, m2292mv = {1, 4, 0})
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1", m2299f = "Migration.kt", m2300i = {0}, m2301l = {FTPReply.CANNOT_OPEN_DATA_CONNECTION}, m2302m = "invokeSuspend", m2303n = {"it"}, m2304s = {"L$0"})
    static final class C24441<T> extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        Object L$0;
        int label;
        private Object p$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24441(long j, Continuation continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C24441 c24441 = new C24441(this.$timeMillis, continuation);
            c24441.p$0 = obj;
            return c24441;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C24441) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayEach(Flow<? extends T> flow, long j) {
        return FlowKt.onEach(flow, new C24441(j, null));
    }
