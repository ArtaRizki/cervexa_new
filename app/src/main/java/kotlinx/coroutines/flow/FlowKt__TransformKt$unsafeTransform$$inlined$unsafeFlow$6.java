...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C2488x9ec262b9(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C2488x9ec262b9 c2488x9ec262b9 = new C2488x9ec262b9(flowCollector, this);
        InlineMarker.mark(0);
        flow.collect(c2488x9ec262b9, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
