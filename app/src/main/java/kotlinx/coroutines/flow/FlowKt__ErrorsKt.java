...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C23961 extends ContinuationImpl {
        ...
        C23961(Continuation continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$onErrorCollect$2 */
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u008a@¢\u0006\u0004\b\u0006\u0010\u0007"}, m2290d2 = {"<anonymous>", "", NDEFRecord.TEXT_WELL_KNOWN_TYPE, "Lkotlinx/coroutines/flow/FlowCollector;", "e", "", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m2291k = 3, m2292mv = {1, 4, 0})
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$onErrorCollect$2", m2299f = "Errors.kt", m2300i = {0, 0, 0, 0}, m2301l = {227}, m2302m = "invokeSuspend", m2303n = {"$this$catch", "e", "$this$emitAll$iv", "flow$iv"}, m2304s = {"L$0", "L$1", "L$2", "L$3"})
    static final class C23982<T> extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
        ...
        private FlowCollector f3387p$;
        private Throwable p$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23982(Function1 function1, Flow flow, Continuation continuation) {
        ...
        public final Continuation<Unit> create(FlowCollector<? super T> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
            C23982 c23982 = new C23982(this.$predicate, this.$fallback, continuation);
            c23982.f3387p$ = flowCollector;
            c23982.p$0 = th;
            return c23982;
        }
        ...
        public final Object invoke(Object obj, Throwable th, Continuation<? super Unit> continuation) {
            return ((C23982) create((FlowCollector) obj, th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                FlowCollector<? super T> flowCollector = this.f3387p$;
    ...
    public static final <T> Flow<T> onErrorCollect(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m3692catch(flow, new C23982(function1, flow2, null));
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1 */
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m2290d2 = {"<anonymous>", "", NDEFRecord.TEXT_WELL_KNOWN_TYPE, "it", "", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m2291k = 3, m2292mv = {1, 4, 0})
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1", m2299f = "Errors.kt", m2300i = {}, m2301l = {}, m2302m = "invokeSuspend", m2303n = {}, m2304s = {})
    static final class C23991 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        private Throwable p$0;

        C23991(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C23991 c23991 = new C23991(continuation);
            c23991.p$0 = (Throwable) obj;
            return c23991;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C23991) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u008a@¢\u0006\u0004\b\b\u0010\t"}, m2290d2 = {"<anonymous>", "", NDEFRecord.TEXT_WELL_KNOWN_TYPE, "Lkotlinx/coroutines/flow/FlowCollector;", "cause", "", "attempt", "", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m2291k = 3, m2292mv = {1, 4, 0})
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", m2299f = "Errors.kt", m2300i = {0, 0, 0}, m2301l = {124}, m2302m = "invokeSuspend", m2303n = {"$this$retryWhen", "cause", "attempt"}, m2304s = {"L$0", "L$1", "J$0"})
    static final class C24003<T> extends SuspendLambda implements Function4<FlowCollector<? super T>, Throwable, Long, Continuation<? super Boolean>, Object> {
        ...
        /* JADX INFO: renamed from: p$ */
        private FlowCollector f3388p$;
        private Throwable p$0;
        private long p$1;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24003(long j, Function2 function2, Continuation continuation) {
        ...
        public final Continuation<Unit> create(FlowCollector<? super T> flowCollector, Throwable th, long j, Continuation<? super Boolean> continuation) {
            C24003 c24003 = new C24003(this.$retries, this.$predicate, continuation);
            c24003.f3388p$ = flowCollector;
            c24003.p$0 = th;
            c24003.p$1 = j;
            return c24003;
        }
        ...
        public final Object invoke(Object obj, Throwable th, Long l, Continuation<? super Boolean> continuation) {
            return ((C24003) create((FlowCollector) obj, th, l.longValue(), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                FlowCollector flowCollector = this.f3388p$;
                Throwable th = this.p$0;
                long j = this.p$1;
                if (j < this.$retries) {
    ...
    public static final <T> Flow<T> retry(Flow<? extends T> flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        ...
        return FlowKt.retryWhen(flow, new C24003(j, function2, null));
    }
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$6 */
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m2288bv = {1, 0, 3}, m2289d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u008a@¢\u0006\u0004\b\b\u0010\t"}, m2290d2 = {"<anonymous>", "", NDEFRecord.TEXT_WELL_KNOWN_TYPE, "Lkotlinx/coroutines/flow/FlowCollector;", "cause", "", "attempt", "", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m2291k = 3, m2292mv = {1, 4, 0})
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$6", m2299f = "Errors.kt", m2300i = {}, m2301l = {}, m2302m = "invokeSuspend", m2303n = {}, m2304s = {})
    static final class C24026<T> extends SuspendLambda implements Function4<FlowCollector<? super T>, Throwable, Long, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Function1 $predicate;
        final /* synthetic */ int $retries;
        int label;

        /* JADX INFO: renamed from: p$ */
        private FlowCollector f3389p$;
        private Throwable p$0;
        private long p$1;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24026(int i, Function1 function1, Continuation continuation) {
            super(4, continuation);
            this.$retries = i;
            this.$predicate = function1;
        }
        ...
        public final Continuation<Unit> create(FlowCollector<? super T> flowCollector, Throwable th, long j, Continuation<? super Boolean> continuation) {
            C24026 c24026 = new C24026(this.$retries, this.$predicate, continuation);
            c24026.f3389p$ = flowCollector;
            c24026.p$0 = th;
            c24026.p$1 = j;
            return c24026;
        }
        ...
        @Override // kotlin.jvm.functions.Function4
        public final Object invoke(Object obj, Throwable th, Long l, Continuation<? super Boolean> continuation) {
            return ((C24026) create((FlowCollector) obj, th, l.longValue(), continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final /* synthetic */ <T> Flow<T> retry(Flow<? extends T> flow, int i, Function1<? super Throwable, Boolean> function1) {
        ...
        return FlowKt.retryWhen(flow, new C24026(i, function1, null));
    }
    ...
    */
    public static final <T> java.lang.Object catchImpl(kotlinx.coroutines.flow.Flow<? extends T> r5, kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super java.lang.Throwable> r7) throws java.lang.Throwable {
        /*
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.FlowKt__ErrorsKt.C23961
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$1 r0 = (kotlinx.coroutines.flow.FlowKt__ErrorsKt.C23961) r0
            int r1 = r0.label
    ...
    public static final <T> Flow<T> m3697catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
