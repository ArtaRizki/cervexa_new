...
@DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3", m2299f = "Zip.kt", m2300i = {0}, m2301l = {TelnetCommand.f3466DO}, m2302m = "invokeSuspend", m2303n = {"$this$flow"}, m2304s = {"L$0"})
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$$inlined$combineTransform$3.f3418p$ = (FlowCollector) obj;
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3$2 */
    /* JADX INFO: compiled from: Zip.kt */
    ...
    @DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3$2", m2299f = "Zip.kt", m2300i = {0, 0, 0, 0, 0}, m2301l = {StatusLine.HTTP_PERM_REDIRECT}, m2302m = "invokeSuspend", m2303n = {"$this$combineInternal", "it", "continuation", "args", "$receiver"}, m2304s = {"L$0", "L$1", "L$2", "L$3", "L$4"})
    public static final class C25102 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        /* JADX INFO: renamed from: p$ */
        private FlowCollector f3419p$;
        private Object[] p$0;

        public C25102(Continuation continuation) {
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
            C25102 c25102 = new C25102(continuation);
            c25102.f3419p$ = flowCollector;
            c25102.p$0 = objArr;
            return c25102;
        }
        ...
        public final Object invoke(Object obj, Object[] objArr, Continuation<? super Unit> continuation) {
            return ((C25102) create((FlowCollector) obj, objArr, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = this.f3419p$;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f3418p$;
            Flow[] flowArr = this.$flows;
            C25091 c25091 = new C25091();
            C25102 c25102 = new C25102(null);
            this.L$0 = flowCollector;
            this.label = 1;
            if (CombineKt.combineInternal(flowCollector, flowArr, c25091, c25102, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3$1 */
    /* JADX INFO: compiled from: Zip.kt */
    ...
    public static final class C25091 extends Lambda implements Function0<Object[]> {
        public C25091() {
            super(0);
        }
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        C25102 c25102 = new C25102(null);
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, c25091, c25102, this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
