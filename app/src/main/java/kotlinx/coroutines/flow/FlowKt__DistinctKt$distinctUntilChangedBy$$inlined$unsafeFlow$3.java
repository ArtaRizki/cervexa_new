...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$3<T> implements Flow<T> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Object objCollect = this.$this_distinctUntilChangedBy$inlined.collect(new C2385x4264af2b(flowCollector, objectRef, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C2385x4264af2b c2385x4264af2b = new C2385x4264af2b(flowCollector, objectRef, this);
        InlineMarker.mark(0);
        flow.collect(c2385x4264af2b, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
