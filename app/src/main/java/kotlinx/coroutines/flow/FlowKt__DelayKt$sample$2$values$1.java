...
@DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m2299f = "Delay.kt", m2300i = {0, 0}, m2301l = {185}, m2302m = "invokeSuspend", m2303n = {"$this$produce", "$this$collect$iv"}, m2304s = {"L$0", "L$1"})
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    private ProducerScope f3384p$;
    final /* synthetic */ FlowKt__DelayKt.C23752 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FlowKt__DelayKt$sample$2$values$1(FlowKt__DelayKt.C23752 c23752, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__DelayKt$sample$2$values$1.f3384p$ = (ProducerScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ProducerScope producerScope = this.f3384p$;
