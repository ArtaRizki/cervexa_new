...
@DebugMetadata(m2298c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$4$lambda$2", m2299f = "Zip.kt", m2300i = {0, 0, 1, 1}, m2301l = {240, 240}, m2302m = "invokeSuspend", m2303n = {"$this$combineInternal", "it", "$this$combineInternal", "it"}, m2304s = {"L$0", "L$1", "L$0", "L$1"})
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$4$lambda$2<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
        ...
        flowKt__ZipKt$combine$$inlined$unsafeFlow$4$lambda$2.f3411p$ = flowCollector;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector3 = this.f3411p$;
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        FlowCollector flowCollector = this.f3411p$;
