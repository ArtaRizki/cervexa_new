...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Object objCollect = this.$this_distinctUntilChangedBy$inlined.collect(new C2381x59d1cced(flowCollector, objectRef, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C2381x59d1cced c2381x59d1cced = new C2381x59d1cced(flowCollector, objectRef, this);
        InlineMarker.mark(0);
        flow.collect(c2381x59d1cced, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
