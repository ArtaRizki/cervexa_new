...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        Object objM2353constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (exceptionalResult$kotlinx_coroutines_core == null && job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m2353constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m2353constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    ...
                    continuation.resumeWith(Result.m2353constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    objM2353constructorimpl2 = Result.m2353constructorimpl(Unit.INSTANCE);
                } catch (Throwable th2) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM2353constructorimpl2 = Result.m2353constructorimpl(ResultKt.createFailure(th2));
                }
                handleFatalException$kotlinx_coroutines_core(th, Result.m2356exceptionOrNullimpl(objM2353constructorimpl2));
            } finally {
            ...
            try {
                ...
                taskContext.afterTask();
                objM2353constructorimpl = Result.m2353constructorimpl(Unit.INSTANCE);
            } catch (Throwable th4) {
                Result.Companion companion7 = Result.INSTANCE;
                objM2353constructorimpl = Result.m2353constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException$kotlinx_coroutines_core(th3, Result.m2356exceptionOrNullimpl(objM2353constructorimpl));
        }
    }
