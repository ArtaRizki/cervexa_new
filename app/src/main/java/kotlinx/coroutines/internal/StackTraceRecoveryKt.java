...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM2353constructorimpl = Result.m2353constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM2353constructorimpl = Result.m2353constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m2356exceptionOrNullimpl(objM2353constructorimpl) == null) {
            obj2 = objM2353constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM2353constructorimpl2 = Result.m2353constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM2353constructorimpl2 = Result.m2353constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m2356exceptionOrNullimpl(objM2353constructorimpl2) == null) {
            obj = objM2353constructorimpl2;
        }
    ...
    private static final <E extends Throwable> Pair<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            if (z) {
                return TuplesKt.m2297to(cause, stackTrace);
            }
            return TuplesKt.m2297to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m2297to(e, new StackTraceElement[0]);
    }
