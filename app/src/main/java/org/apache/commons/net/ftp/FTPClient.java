...
import org.apache.commons.net.p033io.CRLFLineReader;
import org.apache.commons.net.p033io.CopyStreamAdapter;
import org.apache.commons.net.p033io.CopyStreamEvent;
import org.apache.commons.net.p033io.CopyStreamListener;
import org.apache.commons.net.p033io.FromNetASCIIInputStream;
import org.apache.commons.net.p033io.SocketInputStream;
import org.apache.commons.net.p033io.SocketOutputStream;
import org.apache.commons.net.p033io.ToNetASCIIOutputStream;
...
public class FTPClient extends FTP implements Configurable {
    ...
    protected boolean _storeFile(String str, String str2, InputStream inputStream) throws IOException {
        ...
        if (this.__fileType == 0) {
            bufferedOutputStream = new ToNetASCIIOutputStream(getBufferedOutputStream(socket_openDataConnection_.getOutputStream()));
        } else {
            bufferedOutputStream = getBufferedOutputStream(socket_openDataConnection_.getOutputStream());
        }
    ...
    protected OutputStream _storeFileStream(String str, String str2) throws IOException {
        ...
        if (this.__fileType == 0) {
            outputStream = new ToNetASCIIOutputStream(getBufferedOutputStream(socket_openDataConnection_.getOutputStream()));
        } else {
            outputStream = socket_openDataConnection_.getOutputStream();
        }
    ...
    protected boolean _retrieveFile(String str, String str2, OutputStream outputStream) throws IOException {
        ...
        if (this.__fileType == 0) {
            bufferedInputStream = new FromNetASCIIInputStream(getBufferedInputStream(socket_openDataConnection_.getInputStream()));
        } else {
            bufferedInputStream = getBufferedInputStream(socket_openDataConnection_.getInputStream());
        }
        long j = this.__controlKeepAliveTimeout;
        CSL csl = j > 0 ? new CSL(this, j, this.__controlKeepAliveReplyTimeout) : null;
        try {
    ...
    protected InputStream _retrieveFileStream(String str, String str2) throws IOException {
        ...
        if (this.__fileType == 0) {
            inputStream = new FromNetASCIIInputStream(getBufferedInputStream(socket_openDataConnection_.getInputStream()));
        } else {
            inputStream = socket_openDataConnection_.getInputStream();
        }
    ...
    private boolean initFeatureMap() throws IOException {
        ...
        if (this.__featuresMap == null) {
            ...
            boolean zIsPositiveCompletion = FTPReply.isPositiveCompletion(iFeat);
    ...
    public FTPFile mdtmFile(String str) throws IOException {
        ...
        String strSubstring = getReplyStrings()[0].substring(4);
        FTPFile fTPFile = new FTPFile();
        fTPFile.setName(str);
        fTPFile.setRawListing(strSubstring);
        fTPFile.setTimestamp(MLSxEntryParser.parseGMTdateTime(strSubstring));
        return fTPFile;
    }
    ...
    private static class CSL implements CopyStreamListener {
        ...
        @Override // org.apache.commons.net.p033io.CopyStreamListener
