...
public class TelnetClient extends Telnet {
    ...
    public boolean sendAYT(long j) throws InterruptedException, IOException, IllegalArgumentException {
        return _sendAYT(j);
    }
    ...
    public void addOptionHandler(TelnetOptionHandler telnetOptionHandler) throws IOException, InvalidTelnetOptionException {
        super.addOptionHandler(telnetOptionHandler);
    }

    @Override // org.apache.commons.net.telnet.Telnet
    public void deleteOptionHandler(int i) throws IOException, InvalidTelnetOptionException {
