...
public class NNTP extends SocketClient {
    ...
    private void __getReply() throws IOException {
        String line = this._reader_.readLine();
        this._replyString = line;
        if (line == null) {
        ...
        try {
            int i = Integer.parseInt(this._replyString.substring(0, 3));
            this._replyCode = i;
            fireReplyReceived(i, this._replyString + SocketClient.NETASCII_EOL);
