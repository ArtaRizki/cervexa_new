...
public final class KeyManagerUtils {
    ...
    public static KeyManager createClientKeyManager(String str, File file, String str2, String str3, String str4) throws GeneralSecurityException, IOException {
        return createClientKeyManager(loadStore(str, file, str2), str3, str4);
    }

    public static KeyManager createClientKeyManager(File file, String str, String str2) throws GeneralSecurityException, IOException {
        return createClientKeyManager(DEFAULT_STORE_TYPE, file, str, str2, str);
    }

    public static KeyManager createClientKeyManager(File file, String str) throws GeneralSecurityException, IOException {
        return createClientKeyManager(DEFAULT_STORE_TYPE, file, str, null, str);
    }

    private static KeyStore loadStore(String str, File file, String str2) throws Throwable {
