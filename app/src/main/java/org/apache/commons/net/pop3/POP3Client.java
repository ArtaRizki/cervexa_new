...
public class POP3Client extends POP3 {
    ...
    public boolean login(String str, String str2, String str3) throws NoSuchAlgorithmException, IOException {
        if (getState() != 0) {
            return false;
        }
        byte[] bArrDigest = MessageDigest.getInstance("MD5").digest((str2 + str3).getBytes(getCharset()));
