...
public class ExtendedPOP3Client extends POP3SClient {
    public boolean auth(AUTH_METHOD auth_method, String str, String str2) throws InvalidKeySpecException, NoSuchAlgorithmException, InvalidKeyException, IOException {
        ...
        int i = C26091.f3462x62a82643[auth_method.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: org.apache.commons.net.pop3.ExtendedPOP3Client$1 */
    static /* synthetic */ class C26091 {

        /* JADX INFO: renamed from: $SwitchMap$org$apache$commons$net$pop3$ExtendedPOP3Client$AUTH_METHOD */
        static final /* synthetic */ int[] f3462x62a82643;
        ...
        static {
            ...
            try {
                f3462x62a82643[AUTH_METHOD.CRAM_MD5.ordinal()] = 2;
