...
public class FTP extends SocketClient {
    ...
    private void __getReply(boolean z) throws IOException {
        ...
        try {
            ...
            this._replyCode = Integer.parseInt(strSubstring);
            ...
            if (length > 3 && line.charAt(3) == '-') {
                while (true) {
                    ...
                    if (isStrictMultilineParsing()) {
                        if (!__strictCheck(line2, strSubstring)) {
                            break;
                        }
    ...
    public int sendCommand(String str, String str2) throws IOException {
        ...
        String str__buildMessage = __buildMessage(str, str2);
        __send(str__buildMessage);
        fireCommandSent(str, str__buildMessage);
        __getReply();
    ...
    private void __send(String str) throws IOException {
        try {
    ...
    public int allo(int i, int i2) throws IOException {
        return sendCommand(FTPCmd.ALLO, Integer.toString(i) + " R " + Integer.toString(i2));
    }
