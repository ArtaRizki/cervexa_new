...
public final class TimeUDPClient extends DatagramSocketClient {
    ...
    public long getTime(InetAddress inetAddress, int i) throws IOException {
        ...
        return (((long) (bArr3[3] & UByte.MAX_VALUE)) & 4294967295L) | (((long) ((bArr3[0] & UByte.MAX_VALUE) << 24)) & 4294967295L) | 0 | (((long) ((bArr3[1] & UByte.MAX_VALUE) << 16)) & 4294967295L) | (((long) ((bArr3[2] & UByte.MAX_VALUE) << 8)) & 4294967295L);
    }
